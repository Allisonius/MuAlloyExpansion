...
Tutors = Person0->Person1 + Person0->Person2 + Person1->Person2 + Person2->Person1
...
Person = Person0 + Person1 + Person2
Tutors = Person0->Person0 + Person0->Person1 + Person1->Person0 + Person1->Person1 + Person1->Person2 + Person2->Person0 + Person2->Person1 + Person2->Person2
...
Person = Person0 + Person1 + Person2
Tutors = Person1->Person1 + Person1->Person2 + Person2->Person1 + Person2->Person2
no Teaches
Group = Group0 + Group1 + Group2
no Class
no Groups
