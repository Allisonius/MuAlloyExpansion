...
Group = Group0 + Group1 + Group2
Class = Class0
Groups = Class0->Person1->Group1 + Class0->Person1->Group2 + Class0->Person2->Group0
Teacher = Person1
Student = Person2
inv14[]
}}}
...
Person = Person0 + Person1 + Person2
Tutors = Person0->Person2 + Person1->Person0 + Person1->Person1 + Person1->Person2 + Person2->Person0 + Person2->Person1 + Person2->Person2
no Teaches
no Group
no Group' --loop state
Class = Class0
