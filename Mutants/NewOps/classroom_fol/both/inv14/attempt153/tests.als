...
Group = Group0 + Group1 + Group2
Class = Class0 + Class1 + Class2
Groups = Class0->Person0->Group0 + Class0->Person0->Group1 + Class0->Person0->Group2 + Class1->Person0->Group2 + Class1->Person1->Group0 + Class1->Person1->Group1 + Class2->Person0->Group1 + Class2->Person0->Group2 + Class2->Person1->Group0
Teacher = Person1
...
Tutors = Person0->Person0 + Person0->Person2 + Person1->Person0 + Person2->Person1
Teaches = Person2->Class1 + Person2->Class2
Group = Group0
Class = Class0 + Class1 + Class2
Groups = Class0->Person1->Group0 + Class1->Person2->Group0 + Class2->Person0->Group0 + Class2->Person1->Group0
