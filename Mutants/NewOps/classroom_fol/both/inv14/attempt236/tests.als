...
Group = Group0 + Group1 + Group2
Class = Class0 + Class1 + Class2
Groups = Class0->Person0->Group2 + Class0->Person1->Group0 + Class0->Person1->Group1 + Class0->Person1->Group2 + Class1->Person1->Group0 + Class1->Person1->Group1 + Class1->Person1->Group2 + Class2->Person0->Group2 + Class2->Person1->Group0 + Class2->Person1->Group1 + Class2->Person1->Group2
...
some disj Person0, Person1, Person2: Person {some disj Class0, Class1: Class {
Person = Person0 + Person1 + Person2
Tutors = Person0->Person0 + Person0->Person2 + Person1->Person0 + Person1->Person1 + Person1->Person2 + Person2->Person0 + Person2->Person1 + Person2->Person2
...
pred test27 {
some disj Person0, Person1, Person2: Person {some disj Group1, Group0: Group {
Person = Person0 + Person1 + Person2
Tutors = Person0->Person2 + Person1->Person0 + Person1->Person1 + Person1->Person2 + Person2->Person2
no Teaches
Group = Group0 + Group1
no Class
no Groups
