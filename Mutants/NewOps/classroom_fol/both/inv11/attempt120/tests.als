...
Group = Group0 + Group1 + Group2
Class = Class0 + Class1
Groups = Class0->Person0->Group0 + Class0->Person0->Group1 + Class0->Person0->Group2 + Class1->Person0->Group1 + Class1->Person0->Group2 + Class1->Person1->Group0 + Class1->Person1->Group2
no Teacher
no Teacher' --loop state
Student = Person1
inv11[]
