...
Person = Person0 + Person1 + Person2
Tutors = Person1->Person2 + Person2->Person2
Teaches = Person2->Class0 + Person2->Class1
no Group
no Group' --loop state
Class = Class0 + Class1
no Groups
...
Group = Group0 + Group1
Class = Class0 + Class1
Groups = Class0->Person0->Group1 + Class0->Person1->Group0 + Class1->Person1->Group1
Teacher = Person0
Student = Person1
inv11[]
}}}
...
Group = Group0 + Group1
Class = Class0 + Class1 + Class2
Groups = Class0->Person1->Group1 + Class0->Person2->Group0
...
Group = Group0 + Group1 + Group2
Class = Class0 + Class1
Groups = Class0->Person2->Group2 + Class1->Person2->Group2
Teacher = Person0 + Person2
Student = Person1 + Person2
inv11[]
}}}
