...
Group = Group0 + Group1 + Group2
Class = Class0 + Class1 + Class2
Groups = Class0->Person0->Group2 + Class0->Person1->Group1 + Class1->Person1->Group0 + Class1->Person1->Group1 + Class1->Person1->Group2 + Class2->Person0->Group1 + Class2->Person1->Group0
Teacher = Person1
no Student
no Student' --loop state
inv11[]
