...
Group = Group0 + Group1 + Group2
Class = Class0 + Class1 + Class2
Groups = Class0->Person0->Group2 + Class0->Person1->Group1 + Class1->Person0->Group1 + Class1->Person1->Group0 + Class1->Person1->Group2 + Class2->Person0->Group0 + Class2->Person0->Group2 + Class2->Person1->Group1
Teacher = Person1
Student = Person1
inv8[]
}}}
...
pred test16 {
some disj Group1, Group2, Group0: Group {
no Person
no Tutors
no Teaches
no Person' --loop state
