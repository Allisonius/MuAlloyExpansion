...
Workstation = Workstation0 + Workstation1 + Workstation2
no workers
succ = Workstation0->Workstation0 + Workstation0->Workstation1 + Workstation0->Workstation2 + Workstation1->Workstation0 + Workstation1->Workstation2 + Workstation2->Workstation1
Human = Human0
Robot = Robot0
Worker = Robot0 + Human0
no Material
...
pred test20 {
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Worker0, Human0: Worker {some disj Material0: Product {
Workstation = Workstation0 + Workstation1 + Workstation2
no workers
succ = Workstation0->Workstation0 + Workstation0->Workstation1 + Workstation0->Workstation2 + Workstation2->Workstation0 + Workstation2->Workstation1
Human = Human0
no Robot
no Robot' --loop state
...
Workstation = Workstation0 + Workstation1 + Workstation2
no workers
succ = Workstation0->Workstation1 + Workstation1->Workstation0 + Workstation2->Workstation0 + Workstation2->Workstation1
Human = Human0
Robot = Robot0
Worker = Worker0 + Robot0 + Human0
Material = Material0 + Material1
...
pred test41 {
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Human0, Human1: Worker {some disj Material2, Material1, Material0: Product {
Workstation = Workstation0 + Workstation1 + Workstation2
no workers
succ = Workstation0->Workstation1 + Workstation2->Workstation0
Human = Human0 + Human1
