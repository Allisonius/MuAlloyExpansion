...
succ = Workstation0->Workstation0 + Workstation0->Workstation1 + Workstation2->Workstation0 + Workstation2->Workstation1
Human = Human0
Robot = Robot0
Worker = Worker0 + Robot0 + Human0
Material = Material0
...
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Robot0, Worker0, Human0: Worker {some disj Component1, Component2, Component0: Product {
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation1->Worker0 + Workstation1->Robot0 + Workstation1->Human0 + Workstation2->Worker0
succ = Workstation0->Workstation1 + Workstation2->Workstation0
Human = Human0
Robot = Robot0
Worker = Worker0 + Robot0 + Human0
...
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Robot0, Worker0, Human0: Worker {some disj Component1, Component2, Component0: Product {
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation1->Robot0 + Workstation1->Human0 + Workstation2->Worker0
succ = Workstation0->Workstation1 + Workstation2->Workstation0
Human = Human0
Robot = Robot0
Worker = Worker0 + Robot0 + Human0
