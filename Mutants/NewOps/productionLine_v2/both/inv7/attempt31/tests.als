...
parts = Material0->Material1 + Material0->Component0 + Material1->Material1 + Component0->Material0
begin = Workstation1
end = Workstation1
...
no workstation
Product = Material0 + Component0 + Component1
parts = Material0->Material0 + Component1->Material0 + Component1->Component1
begin = Workstation1
end = Workstation1
Dangerous = Material0
inv7[]
