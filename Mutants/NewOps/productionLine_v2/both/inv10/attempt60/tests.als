...
Workstation = Workstation0 + Workstation1 + Workstation2
no workers
succ = Workstation0->Workstation0 + Workstation0->Workstation2 + Workstation1->Workstation2
Human = Human0
Robot = Robot0
...
no Material' --loop state
Component = Component0 + Component1 + Component2
workstation = Component0->Workstation2 + Component1->Workstation0 + Component2->Workstation0 + Component2->Workstation1 + Component2->Workstation2
Product = Component0 + Component1 + Component2
parts = Component1->Component0
begin = Workstation2
end = Workstation1
