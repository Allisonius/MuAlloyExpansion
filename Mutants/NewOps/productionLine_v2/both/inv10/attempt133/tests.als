...
Product = Component0 + Component1 + Component2
parts = Component0->Component0 + Component0->Component1 + Component2->Component1
begin = Workstation1
end = Workstation1
Dangerous = Component2
inv10[]
...
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation1->Worker0 + Workstation1->Robot0
succ = Workstation0->Workstation0 + Workstation0->Workstation1 + Workstation1->Workstation1 + Workstation1->Workstation2
Human = Human0
Robot = Robot0
Worker = Worker0 + Robot0 + Human0
no Material
...
no Material' --loop state
Component = Component0 + Component1 + Component2
workstation = Component0->Workstation2 + Component1->Workstation1 + Component1->Workstation2
Product = Component0 + Component1 + Component2
parts = Component0->Component2 + Component1->Component1 + Component1->Component2
begin = Workstation2
end = Workstation1
Dangerous = Component2
inv10[]
