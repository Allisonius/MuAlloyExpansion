...
pred test32 {
some disj Workstation0: Workstation {some disj Robot0: Worker {some disj Component1, Component0: Product {
...
no Material' --loop state
Component = Component0 + Component1 + Component2
workstation = Component0->Workstation0 + Component0->Workstation1 + Component0->Workstation2 + Component2->Workstation2
Product = Component0 + Component1 + Component2
parts = Component1->Component0
begin = Workstation2
end = Workstation1
