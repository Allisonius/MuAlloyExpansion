...
workstation = Component0->Workstation0 + Component0->Workstation2 + Component1->Workstation1 + Component1->Workstation2
...
Workstation = Workstation0 + Workstation1 + Workstation2
no workers
succ = Workstation1->Workstation0 + Workstation2->Workstation2
Human = Human0
no Robot
no Robot' --loop state
Worker = Worker0 + Human0
