...
workers = Workstation0->Human1 + Workstation1->Robot0 + Workstation2->Human0
no succ
Human = Human0 + Human1
Robot = Robot0
Worker = Robot0 + Human0 + Human1
...
pred test38 {
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Robot1, Robot0, Worker0: Worker {some disj Component1, Component0: Product {
Workstation = Workstation0 + Workstation1 + Workstation2
...
Workstation = Workstation0 + Workstation1
workers = Workstation1->Worker0 + Workstation1->Robot0 + Workstation1->Robot1
no succ
no Human
no Human' --loop state
Robot = Robot0 + Robot1
