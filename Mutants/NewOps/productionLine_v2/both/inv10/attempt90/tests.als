...
no Material' --loop state
Component = Component0 + Component1 + Component2
workstation = Component0->Workstation0 + Component1->Workstation1 + Component2->Workstation1 + Component2->Workstation2
Product = Component0 + Component1 + Component2
...
Product = Material0 + Component0 + Component1
parts = Material0->Component0 + Material0->Component1 + Component0->Component1 + Component1->Material0
begin = Workstation1
end = Workstation1
Dangerous = Material0
inv10[]
