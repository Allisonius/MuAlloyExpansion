...
Workstation = Workstation0 + Workstation1
workers = Workstation0->Human0 + Workstation1->Worker0 + Workstation1->Worker1
succ = Workstation0->Workstation1 + Workstation1->Workstation1
Human = Human0
no Robot
no Robot' --loop state
...
Workstation = Workstation0 + Workstation1
workers = Workstation0->Human0 + Workstation1->Worker0 + Workstation1->Human1
succ = Workstation0->Workstation1 + Workstation1->Workstation1
Human = Human0 + Human1
no Robot
no Robot' --loop state
...
some disj Workstation1, Workstation0: Workstation {some disj Worker0, Worker1, Human0: Worker {some disj Material1, Material0, Component0: Product {
Workstation = Workstation0 + Workstation1
workers = Workstation0->Human0 + Workstation1->Worker0 + Workstation1->Worker1 + Workstation1->Human0
succ = Workstation0->Workstation1 + Workstation1->Workstation1
Human = Human0
no Robot
no Robot' --loop state
...
pred test21 {
some disj Workstation0: Workstation {some disj Worker0, Worker1, Human0: Worker {some disj Material1, Material0, Component0: Product {
Workstation = Workstation0
workers = Workstation0->Human0
succ = Workstation0->Workstation0
Human = Human0
...
Workstation = Workstation0
workers = Workstation0->Worker1 + Workstation0->Human0
no succ
Human = Human0
no Robot
no Robot' --loop state
...
some disj Workstation1, Workstation0: Workstation {some disj Worker0, Human0, Human1: Worker {some disj Component1, Component2, Component0: Product {
Workstation = Workstation0 + Workstation1
workers = Workstation0->Worker0 + Workstation0->Human0 + Workstation1->Human0 + Workstation1->Human1
succ = Workstation0->Workstation1 + Workstation1->Workstation1
Human = Human0 + Human1
no Robot
no Robot' --loop state
