...
workers = Workstation0->Human0 + Workstation0->Human1 + Workstation2->Human1
...
pred test13 {
some disj Workstation1, Workstation0: Workstation {some disj Human0, Human1, Human2: Worker {some disj Material0, Component0: Product {
Workstation = Workstation0 + Workstation1
...
some disj Workstation1, Workstation0: Workstation {some disj Human0, Human1, Human2: Worker {some disj Material0, Component1, Component0: Product {
Workstation = Workstation0 + Workstation1
workers = Workstation0->Human0 + Workstation0->Human1 + Workstation1->Human2
succ = Workstation0->Workstation1 + Workstation1->Workstation1
Human = Human0 + Human1 + Human2
no Robot
no Robot' --loop state
...
some disj Workstation1, Workstation0: Workstation {some disj Robot0, Worker0, Worker1: Worker {some disj Component1, Component2, Component0: Product {
Workstation = Workstation0 + Workstation1
workers = Workstation0->Robot0 + Workstation1->Worker0 + Workstation1->Worker1 + Workstation1->Robot0
succ = Workstation0->Workstation1 + Workstation1->Workstation1
no Human
no Human' --loop state
Robot = Robot0
...
Workstation = Workstation0 + Workstation1
workers = Workstation0->Human0 + Workstation0->Human1 + Workstation1->Human0
no succ
Human = Human0 + Human1
no Robot
no Robot' --loop state
...
some disj Workstation1, Workstation0: Workstation {some disj Human0, Human1, Human2: Worker {some disj Component1, Component2, Component0: Product {
Workstation = Workstation0 + Workstation1
workers = Workstation0->Human0 + Workstation0->Human1 + Workstation0->Human2 + Workstation1->Human2
succ = Workstation0->Workstation1 + Workstation1->Workstation1
Human = Human0 + Human1 + Human2
no Robot
no Robot' --loop state
