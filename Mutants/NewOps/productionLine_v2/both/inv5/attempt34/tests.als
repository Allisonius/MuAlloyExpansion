...
workers = Workstation0->Human1 + Workstation1->Human0 + Workstation2->Worker0
...
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation2->Worker0 + Workstation2->Worker1 + Workstation2->Human0
succ = Workstation1->Workstation2 + Workstation2->Workstation2
Human = Human0
no Robot
no Robot' --loop state
...
Workstation = Workstation0 + Workstation1
workers = Workstation0->Worker1 + Workstation0->Worker2 + Workstation1->Worker0 + Workstation1->Worker2
succ = Workstation0->Workstation1 + Workstation1->Workstation1
no Human
no Human' --loop state
no Robot
