...
pred test7 {
some disj Workstation0: Workstation {some disj Robot1, Robot0, Human0: Worker {some disj Component0: Product {
Workstation = Workstation0
workers = Workstation0->Human0
no succ
Human = Human0
...
pred test17 {
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Human0, Human1, Human2: Worker {some disj Material0: Product {
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation1->Human1 + Workstation2->Human0
...
pred test22 {
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Robot0, Worker0, Worker1: Worker {some disj Material0: Product {
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation1->Worker1 + Workstation1->Robot0 + Workstation2->Worker0 + Workstation2->Worker1
succ = Workstation1->Workstation2 + Workstation2->Workstation2
no Human
no Human' --loop state
Robot = Robot0
...
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation0->Worker1 + Workstation0->Human0 + Workstation1->Worker0 + Workstation1->Worker1
succ = Workstation1->Workstation2 + Workstation2->Workstation2
Human = Human0
no Robot
no Robot' --loop state
