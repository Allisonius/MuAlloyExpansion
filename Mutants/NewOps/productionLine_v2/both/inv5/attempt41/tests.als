...
pred test6 {
some disj Workstation0: Workstation {
Workstation = Workstation0
no workers
succ = Workstation0->Workstation0
no Human
...
pred test7 {
some disj Workstation0: Workstation {some disj Material2, Material1, Material0: Product {
Workstation = Workstation0
no workers
succ = Workstation0->Workstation0
no Human
...
some disj Workstation1, Workstation0: Workstation {some disj Robot1, Robot0, Robot2: Worker {some disj Material0, Component1, Component0: Product {
Workstation = Workstation0 + Workstation1
workers = Workstation0->Robot1 + Workstation0->Robot2 + Workstation1->Robot0 + Workstation1->Robot1 + Workstation1->Robot2
succ = Workstation0->Workstation1 + Workstation1->Workstation1
no Human
no Human' --loop state
Robot = Robot0 + Robot1 + Robot2
...
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation0->Human0 + Workstation0->Human1 + Workstation0->Human2 + Workstation1->Human0 + Workstation1->Human1
succ = Workstation1->Workstation2 + Workstation2->Workstation2
Human = Human0 + Human1 + Human2
no Robot
no Robot' --loop state
