...
Workstation = Workstation0 + Workstation1
workers = Workstation0->Robot1 + Workstation0->Human0 + Workstation1->Robot1 + Workstation1->Human0
succ = Workstation0->Workstation1 + Workstation1->Workstation1
Human = Human0
Robot = Robot0 + Robot1
Worker = Robot0 + Robot1 + Human0
...
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Robot1, Robot0, Human0: Worker {some disj Component1, Component2, Component0: Product {
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation0->Robot1 + Workstation0->Human0 + Workstation1->Robot0 + Workstation1->Human0 + Workstation2->Robot0 + Workstation2->Human0
succ = Workstation1->Workstation2 + Workstation2->Workstation2
Human = Human0
Robot = Robot0 + Robot1
Worker = Robot0 + Robot1 + Human0
...
pred test30 {
some disj Workstation0: Workstation {some disj Robot0, Human0, Human1: Worker {
Workstation = Workstation0
workers = Workstation0->Robot0 + Workstation0->Human0
no succ
Human = Human0 + Human1
