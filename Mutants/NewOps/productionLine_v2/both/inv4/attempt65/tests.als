...
pred test2 {
some disj Workstation1, Workstation0: Workstation {some disj Robot1, Robot0, Human0: Worker {some disj Material0, Component0: Product {
Workstation = Workstation0 + Workstation1
...
parts = Material0->Material1 + Material1->Material0 + Material1->Material2 + Material2->Material2
begin = Workstation1
end = Workstation1
Dangerous = Material2
inv4[]
...
pred test16 {
some disj Workstation1, Workstation0: Workstation {some disj Robot1, Robot0, Human0: Worker {some disj Material0: Product {
Workstation = Workstation0 + Workstation1
...
no Component' --loop state
Product = Material0 + Material1 + Material2
parts = Material0->Material0 + Material0->Material1 + Material0->Material2 + Material1->Material0 + Material1->Material1 + Material1->Material2 + Material2->Material0 + Material2->Material1 + Material2->Material2
begin = Workstation1
end = Workstation1
no Dangerous
no Dangerous' --loop state
...
no workstation
Product = Material0 + Component0
parts = Material0->Material0 + Component0->Component0
begin = Workstation1
end = Workstation0
no Dangerous
no Dangerous' --loop state
...
workers = Workstation0->Robot1 + Workstation1->Robot0 + Workstation2->Worker0
...
pred test38 {
some disj Workstation0: Workstation {some disj Human0, Human1: Worker {some disj Material1, Material0, Component0: Product {
Workstation = Workstation0
no workers
no succ
Human = Human0 + Human1
...
pred test42 {
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Robot0, Worker0, Worker1: Worker {some disj Material0, Component0: Product {
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation0->Worker1 + Workstation2->Worker0
succ = Workstation1->Workstation2 + Workstation2->Workstation2
no Human
no Human' --loop state
Robot = Robot0
