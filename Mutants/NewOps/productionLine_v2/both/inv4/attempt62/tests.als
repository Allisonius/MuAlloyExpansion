...
pred test38 {
some disj Workstation1, Workstation0: Workstation {some disj Material2, Material1, Material0: Product {
Workstation = Workstation0 + Workstation1
no workers
succ = Workstation0->Workstation1 + Workstation1->Workstation1
no Human
...
pred test49 {
some disj Workstation1, Workstation0: Workstation {some disj Worker0, Human0, Human1: Worker {some disj Material1, Material0: Product {
Workstation = Workstation0 + Workstation1
workers = Workstation1->Worker0
succ = Workstation0->Workstation1 + Workstation1->Workstation1
Human = Human0 + Human1
...
pred test51 {
some disj Workstation1, Workstation0: Workstation {some disj Robot0, Human0, Human1: Worker {some disj Material1, Material0: Product {
Workstation = Workstation0 + Workstation1
workers = Workstation1->Robot0
succ = Workstation0->Workstation1 + Workstation1->Workstation1
Human = Human0 + Human1
...
Product = Material0 + Component0 + Component1
parts = Material0->Component0 + Component0->Component0 + Component1->Component1
begin = Workstation2
end = Workstation1
Dangerous = Component0 + Component1
inv4[]
