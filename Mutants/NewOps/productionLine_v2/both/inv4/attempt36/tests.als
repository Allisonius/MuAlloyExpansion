...
Product = Component0 + Component1 + Component2
parts = Component0->Component0 + Component0->Component2 + Component1->Component1 + Component2->Component0 + Component2->Component2
begin = Workstation1
end = Workstation1
Dangerous = Component2
inv4[]
...
no workstation
Product = Material0 + Material1 + Component0
parts = Material0->Material1 + Material0->Component0 + Material1->Material0 + Material1->Material1 + Material1->Component0 + Component0->Material0 + Component0->Material1 + Component0->Component0
begin = Workstation1
end = Workstation1
...
no Component' --loop state
Product = Material0 + Material1 + Material2
parts = Material0->Material0 + Material0->Material2 + Material1->Material0 + Material1->Material1 + Material1->Material2 + Material2->Material0 + Material2->Material1 + Material2->Material2
begin = Workstation1
end = Workstation1
no Dangerous
no Dangerous' --loop state
...
no workstation
Product = Material0 + Material1 + Component0
parts = Material0->Material0 + Material0->Material1 + Material0->Component0 + Material1->Material0 + Material1->Material1 + Material1->Component0 + Component0->Material1 + Component0->Component0
begin = Workstation1
end = Workstation1
Dangerous = Component0
inv4[]
...
pred test50 {
some disj Workstation1, Workstation0: Workstation {some disj Robot1, Robot0, Human0: Worker {some disj Material1, Material0: Product {
Workstation = Workstation0 + Workstation1
workers = Workstation0->Robot0
succ = Workstation0->Workstation1 + Workstation1->Workstation1
Human = Human0
