...
pred test13 {
some disj Workstation1, Workstation0: Workstation {some disj Robot0, Worker0, Worker1: Worker {some disj Material1, Material0: Product {
Workstation = Workstation0 + Workstation1
...
parts = Material0->Material2 + Material1->Material0 + Material1->Material1 + Material1->Material2 + Material2->Material1 + Material2->Material2
begin = Workstation1
end = Workstation1
Dangerous = Material2
inv4[]
