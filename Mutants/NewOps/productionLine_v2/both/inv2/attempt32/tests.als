...
pred test27 {
some disj Workstation0: Workstation {some disj Worker0, Worker1, Worker2: Worker {some disj Material0, Component0: Product {
Workstation = Workstation0
...
pred test30 {
some disj Workstation0: Workstation {some disj Human0, Human1, Human2: Worker {some disj Material1, Material0, Component0: Product {
Workstation = Workstation0
...
pred test31 {
some disj Workstation0: Workstation {some disj Robot1, Robot0, Robot2: Worker {some disj Material1, Material0, Component0: Product {
Workstation = Workstation0
