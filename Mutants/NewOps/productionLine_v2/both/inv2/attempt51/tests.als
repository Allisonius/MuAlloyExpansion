...
pred test8 {
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Worker0, Worker1: Worker {some disj Material2, Material1, Material0: Product {
...
pred test26 {
some disj Workstation0: Workstation {some disj Robot0, Worker0: Worker {
Workstation = Workstation0
workers = Workstation0->Worker0 + Workstation0->Robot0
succ = Workstation0->Workstation0
no Human
...
pred test28 {
some disj Workstation0: Workstation {some disj Robot0, Worker0: Worker {some disj Material2, Material1, Material0: Product {
Workstation = Workstation0
workers = Workstation0->Worker0 + Workstation0->Robot0
succ = Workstation0->Workstation0
no Human
