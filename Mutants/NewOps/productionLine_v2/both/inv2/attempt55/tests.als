...
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation0->Human0 + Workstation0->Human1 + Workstation1->Human0 + Workstation1->Human1 + Workstation2->Human0 + Workstation2->Human1
succ = Workstation1->Workstation2 + Workstation2->Workstation2
Human = Human0 + Human1
no Robot
no Robot' --loop state
...
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation0->Worker1 + Workstation1->Worker0 + Workstation1->Worker1 + Workstation2->Worker0 + Workstation2->Worker1
succ = Workstation1->Workstation2 + Workstation2->Workstation2
no Human
no Human' --loop state
no Robot
