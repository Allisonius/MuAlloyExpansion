...
Workstation = Workstation0 + Workstation1
workers = Workstation0->Worker2 + Workstation1->Worker0 + Workstation1->Worker1 + Workstation1->Worker2
succ = Workstation0->Workstation1 + Workstation1->Workstation1
no Human
no Human' --loop state
no Robot
...
pred test27 {
some disj Workstation0: Workstation {some disj Component0: Product {
Workstation = Workstation0
no workers
succ = Workstation0->Workstation0
no Human
...
pred test28 {
some disj Workstation0: Workstation {some disj Material0: Product {
Workstation = Workstation0
no workers
succ = Workstation0->Workstation0
no Human
...
pred test32 {
some disj Workstation0: Workstation {some disj Robot0: Worker {some disj Material1, Material0, Component0: Product {
Workstation = Workstation0
workers = Workstation0->Robot0
succ = Workstation0->Workstation0
no Human
...
pred test43 {
some disj Workstation0: Workstation {some disj Worker0: Worker {some disj Material2, Material1, Material0: Product {
Workstation = Workstation0
workers = Workstation0->Worker0
succ = Workstation0->Workstation0
no Human
...
workstation = Component0->Workstation0
Product = Material0 + Material1 + Component0
parts = Material0->Material0 + Material0->Material1 + Component0->Material0 + Component0->Component0
begin = Workstation0
end = Workstation0
Dangerous = Material1
inv2[]
