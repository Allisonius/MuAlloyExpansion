...
pred test6 {
some disj Workstation1, Workstation0: Workstation {some disj Worker0, Worker1, Human0: Worker {some disj Component1, Component0: Product {
Workstation = Workstation0 + Workstation1
...
pred test18 {
some disj Workstation0: Workstation {some disj Worker0, Worker1, Human0: Worker {some disj Component1, Component0: Product {
Workstation = Workstation0
workers = Workstation0->Worker0 + Workstation0->Worker1
no succ
Human = Human0
...
parts = Material0->Material2 + Material1->Material0
begin = Workstation0
end = Workstation0
Dangerous = Material2
inv5[]
