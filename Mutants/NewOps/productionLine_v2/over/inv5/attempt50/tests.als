...
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation0->Human0 + Workstation1->Robot1 + Workstation2->Human0
succ = Workstation1->Workstation2 + Workstation2->Workstation2
Human = Human0
Robot = Robot0 + Robot1
...
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Robot0, Human0, Human1: Worker {some disj Component1, Component2, Component0: Product {
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation0->Robot0 + Workstation1->Robot0 + Workstation1->Human0 + Workstation2->Robot0
succ = Workstation1->Workstation2 + Workstation2->Workstation2
Human = Human0 + Human1
Robot = Robot0
Worker = Robot0 + Human0 + Human1
...
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation0->Human0 + Workstation1->Robot0 + Workstation2->Robot0
succ = Workstation1->Workstation2 + Workstation2->Workstation2
Human = Human0
Robot = Robot0 + Robot1
Worker = Robot0 + Robot1 + Human0
...
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Robot0, Human0, Human1: Worker {some disj Component1, Component2, Component0: Product {
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation0->Robot0 + Workstation1->Robot0 + Workstation2->Robot0 + Workstation2->Human1
succ = Workstation1->Workstation2 + Workstation2->Workstation2
Human = Human0 + Human1
Robot = Robot0
Worker = Robot0 + Human0 + Human1
