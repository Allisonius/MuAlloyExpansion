...
pred test4 {
some disj Workstation1, Workstation0: Workstation {some disj Worker0: Worker {some disj Material0: Product {
Workstation = Workstation0 + Workstation1
no workers
...
pred test15 {
some disj Workstation0: Workstation {some disj Worker0, Worker1, Worker2: Worker {
Workstation = Workstation0
