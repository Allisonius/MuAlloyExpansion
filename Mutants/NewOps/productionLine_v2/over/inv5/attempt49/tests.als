...
some disj Workstation1, Workstation0: Workstation {some disj Worker0, Human0, Human1: Worker {some disj Material1, Material0, Component0: Product {
Workstation = Workstation0 + Workstation1
workers = Workstation0->Human0 + Workstation0->Human1 + Workstation1->Worker0
succ = Workstation0->Workstation1 + Workstation1->Workstation1
Human = Human0 + Human1
no Robot
no Robot' --loop state
...
workers = Workstation0->Human0 + Workstation0->Human1 + Workstation1->Human1 + Workstation2->Human0
