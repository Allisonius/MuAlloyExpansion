...
workers = Workstation0->Robot0 + Workstation0->Human0 + Workstation1->Robot0 + Workstation1->Human1
...
Workstation = Workstation0 + Workstation1
workers = Workstation0->Human1 + Workstation1->Robot0 + Workstation1->Human1
succ = Workstation0->Workstation1 + Workstation1->Workstation1
Human = Human0 + Human1
Robot = Robot0
Worker = Robot0 + Human0 + Human1
...
Workstation = Workstation0 + Workstation1
workers = Workstation0->Worker0 + Workstation0->Human1 + Workstation1->Human1
succ = Workstation0->Workstation1 + Workstation1->Workstation1
Human = Human0 + Human1
no Robot
no Robot' --loop state
