...
Workstation = Workstation0 + Workstation1
workers = Workstation0->Robot0 + Workstation0->Robot1 + Workstation1->Worker0 + Workstation1->Robot1
succ = Workstation0->Workstation1 + Workstation1->Workstation1
no Human
no Human' --loop state
Robot = Robot0 + Robot1
...
workers = Workstation0->Worker0 + Workstation0->Robot0 + Workstation1->Robot0 + Workstation2->Robot0
