...
workers = Workstation0->Human0 + Workstation0->Human1 + Workstation1->Human0 + Workstation1->Human1 + Workstation2->Robot0 + Workstation2->Human0
...
Workstation = Workstation0 + Workstation1
workers = Workstation0->Robot0 + Workstation0->Robot1 + Workstation0->Robot2 + Workstation1->Robot1 + Workstation1->Robot2
succ = Workstation0->Workstation1 + Workstation1->Workstation1
no Human
no Human' --loop state
...
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Robot0, Human0, Human1: Worker {some disj Material1, Material0, Component0: Product {
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation0->Human1 + Workstation1->Robot0 + Workstation2->Robot0
succ = Workstation1->Workstation2 + Workstation2->Workstation2
Human = Human0 + Human1
Robot = Robot0
Worker = Robot0 + Human0 + Human1
