...
Workstation = Workstation0 + Workstation1
workers = Workstation0->Worker0 + Workstation0->Worker1 + Workstation0->Worker2 + Workstation1->Worker1 + Workstation1->Worker2
succ = Workstation0->Workstation1 + Workstation1->Workstation1
no Human
no Human' --loop state
no Robot
...
workers = Workstation0->Worker1 + Workstation1->Human0 + Workstation2->Human0
...
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation0->Worker1 + Workstation1->Robot0 + Workstation2->Robot0
succ = Workstation1->Workstation2 + Workstation2->Workstation2
no Human
no Human' --loop state
Robot = Robot0
