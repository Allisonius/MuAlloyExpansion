...
workers = Workstation0->Worker1 + Workstation0->Worker2 + Workstation2->Worker0
...
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation1->Worker0 + Workstation2->Human0 + Workstation2->Human1
succ = Workstation1->Workstation2 + Workstation2->Workstation2
Human = Human0 + Human1
no Robot
no Robot' --loop state
...
pred test14 {
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Worker0: Worker {some disj Material0: Product {
Workstation = Workstation0 + Workstation1 + Workstation2
...
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Worker0, Human0, Human1: Worker {some disj Component1, Component2, Component0: Product {
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation0->Human0 + Workstation1->Human1 + Workstation2->Worker0 + Workstation2->Human1
succ = Workstation1->Workstation2 + Workstation2->Workstation2
Human = Human0 + Human1
no Robot
no Robot' --loop state
...
Workstation = Workstation0 + Workstation1
workers = Workstation0->Robot1 + Workstation1->Robot1
succ = Workstation0->Workstation1 + Workstation1->Workstation1
no Human
no Human' --loop state
...
Workstation = Workstation0 + Workstation1
workers = Workstation0->Worker2 + Workstation1->Worker1
succ = Workstation0->Workstation1 + Workstation1->Workstation1
no Human
no Human' --loop state
no Robot
