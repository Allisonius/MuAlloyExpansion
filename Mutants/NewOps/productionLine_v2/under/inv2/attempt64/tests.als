...
workers = Workstation0->Worker0 + Workstation0->Robot0 + Workstation1->Worker0 + Workstation2->Robot0
...
Workstation = Workstation0 + Workstation1
workers = Workstation0->Worker0 + Workstation0->Human1 + Workstation1->Worker0
no succ
Human = Human0 + Human1
no Robot
no Robot' --loop state
