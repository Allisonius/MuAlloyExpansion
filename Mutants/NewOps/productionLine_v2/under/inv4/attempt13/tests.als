...
no workstation
Product = Material0 + Material1 + Component0
parts = Material0->Material1 + Component0->Material1 + Component0->Component0
begin = Workstation1
end = Workstation1
Dangerous = Material1
inv4[]
...
workstation = Component1->Workstation0
Product = Material0 + Component0 + Component1
parts = Component0->Material0 + Component0->Component0 + Component1->Material0 + Component1->Component1
begin = Workstation1
end = Workstation1
Dangerous = Component0 + Component1
inv4[]
