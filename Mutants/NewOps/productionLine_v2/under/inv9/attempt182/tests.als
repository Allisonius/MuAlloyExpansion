...
Product = Component0 + Component1 + Component2
parts = Component0->Component0 + Component0->Component2 + Component2->Component2
begin = Workstation2
end = Workstation1
Dangerous = Component2
inv9[]
...
pred test10 {
some disj Workstation2, Workstation1, Workstation0: Workstation {
Workstation = Workstation0 + Workstation1 + Workstation2
no workers
succ = Workstation0->Workstation1 + Workstation2->Workstation0
no Human
...
pred test11 {
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Robot0, Worker0: Worker {
Workstation = Workstation0 + Workstation1 + Workstation2
no workers
succ = Workstation0->Workstation1 + Workstation2->Workstation0
no Human
...
no Material' --loop state
Component = Component0 + Component1 + Component2
workstation = Component0->Workstation1 + Component1->Workstation1 + Component1->Workstation2 + Component2->Workstation0
Product = Component0 + Component1 + Component2
...
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation0->Human1 + Workstation1->Human0 + Workstation1->Human1
succ = Workstation0->Workstation1 + Workstation2->Workstation0
...
pred test63 {
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Worker0, Worker1, Worker2: Worker {some disj Component0: Product {
Workstation = Workstation0 + Workstation1 + Workstation2
no workers
succ = Workstation0->Workstation1 + Workstation2->Workstation1
no Human
