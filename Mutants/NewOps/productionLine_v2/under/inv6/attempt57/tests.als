...
pred test11 {
some disj Workstation1, Workstation0: Workstation {some disj Robot1, Robot0: Worker {some disj Material0: Product {
Workstation = Workstation0 + Workstation1
no workers
succ = Workstation0->Workstation1 + Workstation1->Workstation1
no Human
...
no workstation
Product = Material0 + Material1 + Component0
parts = Material0->Material0 + Material0->Material1 + Material1->Material1 + Material1->Component0
begin = Workstation1
end = Workstation1
