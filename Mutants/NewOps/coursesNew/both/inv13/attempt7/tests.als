...
enrolled = Person0->Course0 + Person1->Course0 + Person1->Course1 + Person2->Course0
...
grades = Course0->Person0->Grade2 + Course0->Person1->Grade2 + Course0->Person2->Grade0 + Course0->Person2->Grade1 + Course1->Person2->Grade0 + Course1->Person2->Grade1
Project = Project0 + Project1 + Project2
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
ordering/next = Grade0->Grade1 + Grade1->Grade2
