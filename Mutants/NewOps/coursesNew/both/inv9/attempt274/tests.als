...
teaches = Person0->Course0 + Person1->Course0 + Person1->Course2 + Person2->Course1 + Person2->Course2
...
Course = Course0 + Course1 + Course2
projects = Course2->Project1
grades = Course0->Person1->Grade0 + Course0->Person1->Grade1 + Course0->Person1->Grade2 + Course2->Person0->Grade0
Project = Project0 + Project1
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
ordering/next = Grade0->Grade1 + Grade1->Grade2
