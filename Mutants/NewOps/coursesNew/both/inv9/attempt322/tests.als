...
Person = Person0 + Person1 + Person2
teaches = Person0->Course1 + Person0->Course2 + Person1->Course0 + Person1->Course1 + Person1->Course2 + Person2->Course0 + Person2->Course2
enrolled = Person0->Course0 + Person0->Course1 + Person0->Course2 + Person1->Course0 + Person1->Course1 + Person2->Course0 + Person2->Course1
no projects
Course = Course0 + Course1 + Course2
