...
grades = Course0->Person0->Grade1 + Course0->Person0->Grade2 + Course1->Person0->Grade0 + Course1->Person0->Grade2 + Course2->Person0->Grade0 + Course2->Person0->Grade1
Project = Project0
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
ordering/next = Grade0->Grade1 + Grade1->Grade2
...
enrolled = Person0->Course1 + Person0->Course2 + Person2->Course0
projects = Person0->Project2 + Person1->Project2 + Person2->Project2
Course = Course0 + Course1 + Course2
