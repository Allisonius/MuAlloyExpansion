...
teaches = Person1->Course0 + Person1->Course1 + Person2->Course2
enrolled = Person1->Course1 + Person2->Course2
projects = Person0->Project0 + Person0->Project1 + Person0->Project2 + Person1->Project0 + Person1->Project2 + Person2->Project1
Course = Course0 + Course1 + Course2
projects = Course0->Project1 + Course0->Project2 + Course1->Project1 + Course1->Project2 + Course2->Project0
grades = Course2->Person2->Grade0 + Course2->Person2->Grade1 + Course2->Person2->Grade2
Project = Project0 + Project1 + Project2
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
ordering/next = Grade0->Grade1 + Grade1->Grade2
...
Course = Course0 + Course1 + Course2
projects = Course0->Project2 + Course1->Project2 + Course2->Project0 + Course2->Project1
grades = Course0->Person0->Grade1 + Course0->Person0->Grade2 + Course1->Person0->Grade0 + Course2->Person1->Grade0 + Course2->Person1->Grade1 + Course2->Person1->Grade2
Project = Project0 + Project1 + Project2
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
ordering/next = Grade0->Grade1 + Grade1->Grade2
