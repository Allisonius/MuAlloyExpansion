...
enrolled = Person0->Course1 + Person0->Course2 + Person1->Course0 + Person1->Course2 + Person2->Course0 + Person2->Course1
projects = Person0->Project0 + Person1->Project1 + Person1->Project2 + Person2->Project0 + Person2->Project2
Course = Course0 + Course1 + Course2
projects = Course0->Project2 + Course1->Project1 + Course2->Project0 + Course2->Project2
