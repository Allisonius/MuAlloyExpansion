...
grades = Course0->Person2->Grade2 + Course1->Person1->Grade0
Project = Project0
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
ordering/next = Grade0->Grade1 + Grade1->Grade2
...
grades = Course1->Person1->Grade1 + Course1->Person1->Grade2 + Course1->Person2->Grade0 + Course2->Person1->Grade0
Project = Project0
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
ordering/next = Grade0->Grade1 + Grade1->Grade2
