...
Course = Course0 + Course1 + Course2
no projects
grades = Course0->Person1->Grade0 + Course0->Person1->Grade1 + Course0->Person1->Grade2 + Course1->Person1->Grade1 + Course2->Person0->Grade1
no Project
no Project' --loop state
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
...
pred test13 {
some disj Course0, Course1: Course {some disj Grade0, Grade1, Grade2: Grade {
no Person
no teaches
no enrolled
no projects
