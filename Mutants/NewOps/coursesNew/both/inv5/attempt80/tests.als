...
projects = Person0->Project0 + Person0->Project1 + Person0->Project2 + Person1->Project1 + Person2->Project0 + Person2->Project1
Course = Course0 + Course1 + Course2
...
projects = Person0->Project0 + Person0->Project1 + Person0->Project2 + Person2->Project1 + Person2->Project2
Course = Course0 + Course1 + Course2
projects = Course1->Project1 + Course1->Project2 + Course2->Project0
