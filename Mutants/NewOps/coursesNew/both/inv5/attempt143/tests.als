...
Course = Course0 + Course1 + Course2
no projects
grades = Course0->Person0->Grade2 + Course1->Person0->Grade1 + Course1->Person0->Grade2 + Course2->Person0->Grade0 + Course2->Person0->Grade1
no Project
no Project' --loop state
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
...
projects = Person0->Project0 + Person0->Project1 + Person1->Project2 + Person2->Project0
Course = Course0 + Course1 + Course2
