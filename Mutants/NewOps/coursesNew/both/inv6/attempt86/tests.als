...
projects = Person0->Project0 + Person0->Project2 + Person1->Project0 + Person2->Project0 + Person2->Project1
Course = Course0 + Course1 + Course2
projects = Course0->Project1 + Course0->Project2 + Course1->Project0 + Course1->Project1 + Course1->Project2 + Course2->Project0 + Course2->Project1 + Course2->Project2
...
no enrolled
projects = Person0->Project1 + Person0->Project2 + Person1->Project2 + Person2->Project1
Course = Course0
