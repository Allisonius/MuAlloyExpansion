...
projects = Person0->Project1 + Person0->Project2 + Person1->Project0 + Person1->Project2 + Person2->Project1 + Person2->Project2
Course = Course0 + Course1 + Course2
...
projects = Person0->Project2 + Person1->Project1 + Person1->Project2 + Person2->Project1 + Person2->Project2
