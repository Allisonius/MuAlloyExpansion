...
projects = Person0->Project0 + Person0->Project1 + Person1->Project0 + Person1->Project1 + Person2->Project0 + Person2->Project1 + Person2->Project2
Course = Course0 + Course1 + Course2
...
Course = Course0 + Course1 + Course2
projects = Course0->Project0 + Course0->Project1 + Course0->Project2 + Course1->Project0 + Course1->Project1 + Course1->Project2 + Course2->Project0 + Course2->Project1 + Course2->Project2
grades = Course1->Person2->Grade0 + Course2->Person2->Grade0
Project = Project0 + Project1 + Project2
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
ordering/next = Grade0->Grade1 + Grade1->Grade2
