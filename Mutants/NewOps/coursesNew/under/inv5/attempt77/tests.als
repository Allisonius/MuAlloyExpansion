...
projects = Person0->Project0 + Person0->Project2 + Person1->Project1 + Person1->Project2 + Person2->Project1 + Person2->Project2
Course = Course0 + Course1
projects = Course0->Project1 + Course0->Project2 + Course1->Project0
grades = Course0->Person2->Grade0 + Course0->Person2->Grade1 + Course0->Person2->Grade2 + Course1->Person2->Grade0 + Course1->Person2->Grade1
Project = Project0 + Project1 + Project2
...
teaches = Person2->Course0 + Person2->Course1
enrolled = Person2->Course0 + Person2->Course1
projects = Person1->Project1 + Person2->Project2
Course = Course0 + Course1
projects = Course0->Project2 + Course1->Project0 + Course1->Project1
grades = Course0->Person2->Grade0 + Course0->Person2->Grade1 + Course0->Person2->Grade2 + Course1->Person2->Grade0 + Course1->Person2->Grade1
Project = Project0 + Project1 + Project2
