...
grades = Course1->Person2->Grade0 + Course1->Person2->Grade1 + Course1->Person2->Grade2 + Course2->Person2->Grade1
Project = Project0 + Project1
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
ordering/next = Grade0->Grade1 + Grade1->Grade2
...
Course = Course0 + Course1 + Course2
projects = Course1->Project1 + Course2->Project0
grades = Course1->Person2->Grade2 + Course2->Person1->Grade1
Project = Project0 + Project1
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
ordering/next = Grade0->Grade1 + Grade1->Grade2
...
teaches = Person2->Course0
enrolled = Person2->Course0
projects = Person0->Project0 + Person0->Project1 + Person2->Project1
Course = Course0
