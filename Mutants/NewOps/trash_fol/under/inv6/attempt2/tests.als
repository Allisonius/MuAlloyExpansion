...
some disj File2, File1, File0: File {
File = File0 + File1 + File2
link = File1->File0 + File1->File1 + File1->File2 + File2->File1 + File2->File2
Trash = File2
...
some disj File2, File1, File0: File {
File = File0 + File1 + File2
link = File0->File0 + File0->File1 + File1->File0 + File1->File1 + File2->File2
Trash = File2
Protected = File2
inv6[]
}
...
some disj File2, File1, File0: File {
File = File0 + File1 + File2
link = File0->File0 + File0->File1 + File1->File0 + File1->File1 + File2->File0
Trash = File2
Protected = File1 + File2
inv6[]
}
...
some disj File2, File1, File0: File {
File = File0 + File1 + File2
link = File0->File2 + File1->File1 + File2->File0 + File2->File1
Trash = File2
no Protected
no Protected' --loop state
inv6[]
...
some disj File2, File1, File0: File {
File = File0 + File1 + File2
link = File0->File0 + File0->File2 + File1->File0 + File1->File1
Trash = File1
Protected = File2
inv6[]
}
