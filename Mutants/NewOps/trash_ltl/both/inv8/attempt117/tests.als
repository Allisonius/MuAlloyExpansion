...
link' = File2->File1 + File0->File1
File'' = File2 + File0 + File1 --loop state
link'' = File2->File1 + File0->File1 --loop state
Trash = File1
Trash' = File0
Trash'' = File0 --loop state
...
link' = File2->File1 + File0->File2 + File1->File1
File'' = File2 + File0 + File1 --loop state
link'' = File2->File1 + File0->File2 + File1->File1 --loop state
Trash = File0
Trash' = File0 + File1
Trash'' = File0 + File1 --loop state
Protected = File1
