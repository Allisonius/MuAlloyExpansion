...
File'' = File0 + File1 + File2 --loop state
link'' = File0->File1 + File2->File1 --loop state
Trash = File1
no Trash'
Trash'' = File1 --loop state
Protected = File2
...
File = File0 + File1 + File2
File' = File0 + File1 + File2
link = File0->File0 + File1->File2 + File2->File1
link' = File1->File2 + File2->File0
File'' = File0 + File1 + File2 --loop state
link'' = File0->File0 + File1->File2 + File2->File1 --loop state
Trash = File2
Trash' = File0
Trash'' = File2 --loop state
Protected = File1 + File2
...
File = File0 + File1 + File2
File' = File1 + File2
link = File0->File0 + File1->File0 + File2->File0
link' = File2->File2
File'' = File0 + File1 + File2 --loop state
link'' = File0->File0 + File1->File0 + File2->File0 --loop state
no Trash
Trash' = File1 + File2
no Trash'' --loop state
Protected = File1 + File2
