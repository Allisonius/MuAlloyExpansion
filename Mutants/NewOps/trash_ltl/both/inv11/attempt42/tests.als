...
link' = File0->File2 + File1->File1 + File2->File0
File'' = File0 + File1 + File2 --loop state
link'' = File0->File1 + File1->File1 + File2->File0 --loop state
Trash = File2
Trash' = File1 + File2
...
link'' = File0->File2 + File1->File1 + File2->File0
File''' = File0 + File1 + File2 --loop state
link''' = File0->File2 + File1->File2 + File2->File2 --loop state
Trash = File1 + File2
no Trash'
Trash'' = File0 + File2
Trash''' = File1 + File2 --loop state
...
Protected' = File2
Protected'' = File2 + File0 + File1
Protected''' = File2 + File0 + File1 --loop state
inv11[]
}
}
