...
no link
no link'
link'' = File2->File0 + File1->File1 + File0->File2
File''' = File2 + File1 + File0 --loop state
link''' = File2->File0 + File1->File1 + File0->File2 --loop state
no Trash
Trash' = File1
Trash'' = File2 + File1 + File0
Trash''' = File2 + File1 + File0 --loop state
Protected = File0
Protected' = File1
Protected'' = File0
Protected''' = File0 --loop state
