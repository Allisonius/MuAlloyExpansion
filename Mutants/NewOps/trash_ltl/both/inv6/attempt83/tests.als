...
link' = File2->File1 + File1->File2
link'' = File2->File1 + File0->File0 + File1->File2
File''' = File2 + File1 --loop state
link''' = File2->File1 + File1->File2 --loop state
Trash = File1
Trash' = File2 + File1
Trash'' = File2
...
link''' = File2->File0 + File0->File2 --loop state
Trash = File0 + File1
Trash' = File1
Trash'' = File2 + File0
Trash''' = File1 --loop state
