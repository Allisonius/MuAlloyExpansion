...
File'' = File0 + File1 + File2 --loop state
link'' = File1->File2 + File2->File2 --loop state
no Trash
Trash' = File2
...
no link
no link'
link'' = File2->File1 + File1->File1
File''' = File2 + File0 + File1 --loop state
no link''' --loop state
Trash = File1
Trash' = File2 + File0 + File1
Trash'' = File2 + File1
Trash''' = File2 + File0 + File1 --loop state
no Protected
Protected' = File1
Protected'' = File1
Protected''' = File1 --loop state
