...
link'' = File2->File1 + File0->File0 --loop state
Trash = File1
no Trash'
no Trash'' --loop state
no Protected
...
File'' = File0 + File1 + File2 --loop state
link'' = File0->File2 + File2->File2 --loop state
Trash = File1
Trash' = File0 + File2
Trash'' = File0 + File2 --loop state
Protected = File2
...
link = File0->File0
link' = File1->File0 + File0->File2
File'' = File1 + File2 + File0 --loop state
link'' = File1->File0 + File0->File2 --loop state
no Trash
...
link' = File0->File2 + File1->File1
File'' = File0 + File1 + File2 --loop state
link'' = File0->File2 + File1->File2 + File2->File0 --loop state
Trash = File0 + File1 + File2
Trash' = File0 + File1
Trash'' = File0 + File1 + File2 --loop state
Protected = File1 + File2
...
File'' = File0 + File1 + File2 --loop state
link'' = File1->File0 + File2->File2 --loop state
Trash = File0 + File2
Trash' = File1 + File2
Trash'' = File1 + File2 --loop state
Protected = File1 + File2
