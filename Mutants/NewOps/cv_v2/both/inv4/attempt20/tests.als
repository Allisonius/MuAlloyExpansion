...
visible = User0->Work0 + User0->Work2 + User1->Work0 + User1->Work2 + User2->Work0
no Institution
no Institution' --loop state
Source = User0 + User1 + User2
Id = Id0 + Id1 + Id2
Work = Work0 + Work1 + Work2
ids = Work0->Id2 + Work1->Id0 + Work1->Id1 + Work1->Id2 + Work2->Id1
...
visible = User0->Work0 + User0->Work1 + User1->Work0
no Institution
no Institution' --loop state
Source = User0 + User1
Id = Id0 + Id1 + Id2
