...
signals = Track0->Signal0 + Track0->Speed0 + Track0->Semaphore0 + Track1->Semaphore0
Semaphore = Semaphore0
Speed = Speed0
Signal = Signal0 + Speed0 + Semaphore0
Junction = Track1
...
Track = Track0 + Track1
succs = Track0->Track0 + Track1->Track0
signals = Track0->Signal1 + Track0->Speed0 + Track1->Signal0
no Semaphore
no Semaphore' --loop state
Speed = Speed0
...
Track = Track0 + Track1 + Track2
succs = Track0->Track0 + Track0->Track1 + Track1->Track0 + Track1->Track1 + Track1->Track2 + Track2->Track0
