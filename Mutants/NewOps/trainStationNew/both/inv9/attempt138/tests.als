...
succs = Track2->Track2
signals = Track0->Speed0 + Track0->Signal0 + Track0->Semaphore0 + Track2->Speed0 + Track2->Signal0 + Track2->Semaphore0
Semaphore = Semaphore0
Speed = Speed0
...
Track = Track0 + Track1
succs = Track0->Track0
signals = Track0->Semaphore0 + Track0->Semaphore1 + Track0->Semaphore2 + Track1->Semaphore2
Semaphore = Semaphore0 + Semaphore1 + Semaphore2
no Speed
no Speed' --loop state
Signal = Semaphore0 + Semaphore1 + Semaphore2
...
Track = Track0 + Track1
succs = Track1->Track1
signals = Track0->Speed0 + Track1->Speed1 + Track1->Speed2
no Semaphore
