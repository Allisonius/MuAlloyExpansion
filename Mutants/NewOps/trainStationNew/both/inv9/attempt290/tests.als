...
Track = Track0 + Track1
succs = Track1->Track1
signals = Track0->Semaphore0 + Track1->Semaphore0 + Track1->Semaphore2
Semaphore = Semaphore0 + Semaphore1 + Semaphore2
no Speed
no Speed' --loop state
Signal = Semaphore0 + Semaphore1 + Semaphore2
...
signals = Track0->Semaphore2 + Track1->Semaphore0 + Track2->Semaphore0 + Track2->Semaphore1 + Track2->Semaphore2
Semaphore = Semaphore0 + Semaphore1 + Semaphore2
no Speed
no Speed' --loop state
Signal = Semaphore0 + Semaphore1 + Semaphore2
