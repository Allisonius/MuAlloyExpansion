...
signals = Track0->Semaphore0 + Track0->Semaphore1 + Track1->Semaphore0 + Track1->Semaphore1 + Track2->Semaphore0 + Track2->Semaphore1
...
Track = Track0 + Track1
succs = Track0->Track0 + Track0->Track1
signals = Track0->Speed1 + Track0->Semaphore0 + Track1->Speed1 + Track1->Semaphore0
Semaphore = Semaphore0
Speed = Speed0 + Speed1
