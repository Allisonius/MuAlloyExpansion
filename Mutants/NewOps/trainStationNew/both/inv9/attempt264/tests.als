...
signals = Track0->Speed0 + Track0->Speed1 + Track0->Signal0 + Track1->Speed1 + Track1->Signal0
no Semaphore
...
Track = Track0 + Track1
succs = Track1->Track1
signals = Track0->Speed1 + Track1->Speed0 + Track1->Speed2
no Semaphore
no Semaphore' --loop state
...
signals = Track0->Speed0 + Track1->Signal0 + Track1->Speed1
no Semaphore
no Semaphore' --loop state
Speed = Speed0 + Speed1
Signal = Speed0 + Signal0 + Speed1
