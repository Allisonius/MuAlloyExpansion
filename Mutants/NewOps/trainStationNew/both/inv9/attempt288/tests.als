...
Track = Track0 + Track1
succs = Track0->Track0 + Track0->Track1
signals = Track0->Speed0 + Track0->Signal0 + Track1->Speed0 + Track1->Signal0 + Track1->Semaphore0
Semaphore = Semaphore0
Speed = Speed0
Signal = Speed0 + Signal0 + Semaphore0
Junction = Track0
...
signals = Track0->Speed0 + Track0->Semaphore1 + Track1->Speed0 + Track1->Semaphore0 + Track2->Speed0 + Track2->Semaphore1
...
signals = Track0->Semaphore0 + Track1->Semaphore0 + Track2->Semaphore0 + Track2->Semaphore1 + Track2->Semaphore2
Semaphore = Semaphore0 + Semaphore1 + Semaphore2
no Speed
no Speed' --loop state
Signal = Semaphore0 + Semaphore1 + Semaphore2
