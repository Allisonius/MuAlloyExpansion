...
Track = Track0 + Track1
succs = Track0->Track0 + Track1->Track1
signals = Track0->Speed0 + Track1->Semaphore1
...
signals = Track0->Speed1 + Track1->Speed1 + Track1->Semaphore0 + Track2->Speed0
Semaphore = Semaphore0
Speed = Speed0 + Speed1
...
Track = Track0 + Track1
succs = Track0->Track1
signals = Track0->Signal0 + Track1->Signal0 + Track1->Semaphore0
Semaphore = Semaphore0 + Semaphore1
no Speed
no Speed' --loop state
Signal = Signal0 + Semaphore0 + Semaphore1
