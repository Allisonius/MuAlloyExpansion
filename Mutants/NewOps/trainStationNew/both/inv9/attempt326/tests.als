...
signals = Track0->Semaphore0 + Track0->Semaphore1 + Track1->Speed0 + Track1->Semaphore1 + Track2->Speed0 + Track2->Semaphore0 + Track2->Semaphore1
...
Track = Track0 + Track1 + Track2
succs = Track1->Track0
signals = Track0->Semaphore1 + Track1->Semaphore0 + Track1->Semaphore1 + Track2->Signal0 + Track2->Semaphore0
Semaphore = Semaphore0 + Semaphore1
no Speed
no Speed' --loop state
Signal = Signal0 + Semaphore0 + Semaphore1
...
Track = Track0 + Track1 + Track2
succs = Track2->Track2
signals = Track0->Semaphore0 + Track0->Semaphore1 + Track0->Semaphore2 + Track1->Semaphore0 + Track1->Semaphore1 + Track1->Semaphore2 + Track2->Semaphore0 + Track2->Semaphore1 + Track2->Semaphore2
Semaphore = Semaphore0 + Semaphore1 + Semaphore2
no Speed
no Speed' --loop state
Signal = Semaphore0 + Semaphore1 + Semaphore2
