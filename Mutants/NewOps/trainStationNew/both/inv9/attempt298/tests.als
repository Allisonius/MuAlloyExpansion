...
Track = Track0 + Track1
succs = Track0->Track0 + Track0->Track1
signals = Track0->Semaphore0 + Track0->Semaphore1 + Track1->Signal0 + Track1->Semaphore1
Semaphore = Semaphore0 + Semaphore1
no Speed
no Speed' --loop state
...
signals = Track0->Signal0 + Track0->Semaphore0 + Track2->Speed0
Semaphore = Semaphore0
Speed = Speed0
...
Track = Track0 + Track1
succs = Track0->Track1 + Track1->Track1
signals = Track0->Speed0 + Track0->Semaphore1 + Track1->Speed0 + Track1->Semaphore1
Semaphore = Semaphore0 + Semaphore1
Speed = Speed0
Signal = Speed0 + Semaphore0 + Semaphore1
Junction = Track0
