...
succs = Track1->Track1 + Track2->Track0 + Track2->Track2
...
Track = Track0 + Track1 + Track2
succs = Track1->Track1 + Track2->Track0 + Track2->Track2
signals = Track0->Speed1 + Track1->Speed1 + Track2->Speed0 + Track2->Speed1 + Track2->Signal0
no Semaphore
no Semaphore' --loop state
Speed = Speed0 + Speed1
...
Track = Track0 + Track1 + Track2
succs = Track1->Track1 + Track2->Track0 + Track2->Track2
signals = Track0->Signal1 + Track1->Signal0 + Track1->Signal1 + Track2->Signal1 + Track2->Semaphore0
Semaphore = Semaphore0
no Speed
no Speed' --loop state
