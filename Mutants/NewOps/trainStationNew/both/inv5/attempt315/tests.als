...
signals = Track1->Signal0 + Track2->Speed0 + Track2->Signal0
Semaphore = Semaphore0
Speed = Speed0
Signal = Speed0 + Signal0 + Semaphore0
Junction = Track0 + Track1 + Track2
...
Track = Track0 + Track1
succs = Track0->Track0 + Track0->Track1
signals = Track0->Speed0 + Track0->Semaphore1
Semaphore = Semaphore0 + Semaphore1
Speed = Speed0
Signal = Speed0 + Semaphore0 + Semaphore1
Junction = Track0 + Track1
...
some disj Track2, Track1, Track0: Track {some disj Speed0, Semaphore0: Signal {
Track = Track0 + Track1 + Track2
succs = Track0->Track0 + Track0->Track2 + Track1->Track1 + Track1->Track2 + Track2->Track2
signals = Track2->Speed0 + Track2->Semaphore0
Semaphore = Semaphore0
Speed = Speed0
Signal = Speed0 + Semaphore0
...
signals = Track0->Semaphore1 + Track1->Semaphore0 + Track2->Speed0 + Track2->Semaphore1
Semaphore = Semaphore0 + Semaphore1
Speed = Speed0
Signal = Speed0 + Semaphore0 + Semaphore1
Junction = Track0 + Track1 + Track2
...
Track = Track0 + Track1 + Track2
succs = Track0->Track0 + Track0->Track2 + Track1->Track1 + Track2->Track2
no signals
no Semaphore
