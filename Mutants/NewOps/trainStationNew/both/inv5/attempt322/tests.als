...
succs = Track0->Track0 + Track0->Track1 + Track1->Track1 + Track2->Track1
...
Track = Track0 + Track1
succs = Track0->Track0
signals = Track0->Speed0 + Track1->Speed0 + Track1->Signal0
Semaphore = Semaphore0
Speed = Speed0
Signal = Speed0 + Signal0 + Semaphore0
no Junction
...
Track = Track0 + Track1 + Track2
succs = Track1->Track1 + Track2->Track2
...
signals = Track1->Speed0 + Track1->Speed1 + Track2->Speed0 + Track2->Speed1 + Track2->Signal0
no Semaphore
no Semaphore' --loop state
Speed = Speed0 + Speed1
...
signals = Track1->Semaphore1 + Track2->Signal0 + Track2->Semaphore0
Semaphore = Semaphore0 + Semaphore1
no Speed
no Speed' --loop state
Signal = Signal0 + Semaphore0 + Semaphore1
