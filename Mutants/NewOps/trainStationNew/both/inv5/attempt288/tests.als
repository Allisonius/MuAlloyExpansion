...
some disj Track2, Track1, Track0: Track {some disj Speed1, Speed0, Semaphore0: Signal {
Track = Track0 + Track1 + Track2
succs = Track0->Track0 + Track0->Track2 + Track2->Track0 + Track2->Track2
signals = Track0->Speed1 + Track1->Speed0 + Track1->Semaphore0 + Track2->Speed1
Semaphore = Semaphore0
Speed = Speed0 + Speed1
Signal = Speed0 + Speed1 + Semaphore0
...
Track = Track0 + Track1 + Track2
succs = Track0->Track2 + Track1->Track2 + Track2->Track0
...
some disj Track2, Track1, Track0: Track {some disj Speed1, Speed0, Semaphore0: Signal {
Track = Track0 + Track1 + Track2
succs = Track0->Track0 + Track0->Track1 + Track0->Track2 + Track1->Track0 + Track2->Track0
...
some disj Track2, Track1, Track0: Track {some disj Speed0, Semaphore0, Signal0: Signal {
Track = Track0 + Track1 + Track2
succs = Track0->Track1 + Track1->Track0 + Track2->Track1
signals = Track1->Signal0 + Track2->Signal0 + Track2->Speed0
Semaphore = Semaphore0
Speed = Speed0
Signal = Signal0 + Speed0 + Semaphore0
Junction = Track0
...
Track = Track0 + Track1 + Track2
succs = Track0->Track1 + Track1->Track1 + Track1->Track2 + Track2->Track1
signals = Track1->Semaphore1 + Track2->Signal0
...
pred test27 {
some disj Track2, Track1, Track0: Track {
Track = Track0 + Track1 + Track2
succs = Track0->Track2 + Track1->Track2 + Track2->Track1
no signals
no Semaphore
...
some disj Track2, Track1, Track0: Track {some disj Semaphore0, Semaphore1, Signal0: Signal {
Track = Track0 + Track1 + Track2
succs = Track0->Track1 + Track1->Track0 + Track1->Track1 + Track1->Track2 + Track2->Track1
signals = Track0->Semaphore0 + Track1->Signal0 + Track1->Semaphore1 + Track2->Semaphore0
Semaphore = Semaphore0 + Semaphore1
no Speed
no Speed' --loop state
Signal = Signal0 + Semaphore0 + Semaphore1
...
Track = Track0 + Track1 + Track2
succs = Track0->Track0 + Track0->Track2 + Track1->Track0 + Track2->Track0
signals = Track1->Speed0 + Track2->Speed0 + Track2->Semaphore0
Semaphore = Semaphore0
Speed = Speed0
Signal = Speed0 + Semaphore0
Junction = Track0 + Track1
...
signals = Track1->Semaphore0 + Track1->Semaphore2 + Track2->Semaphore1
...
Track = Track0 + Track1 + Track2
succs = Track0->Track0 + Track0->Track1 + Track0->Track2 + Track1->Track0 + Track2->Track0
signals = Track0->Semaphore1 + Track1->Semaphore0 + Track1->Semaphore2 + Track2->Semaphore1
Semaphore = Semaphore0 + Semaphore1 + Semaphore2
no Speed
no Speed' --loop state
Signal = Semaphore0 + Semaphore1 + Semaphore2
