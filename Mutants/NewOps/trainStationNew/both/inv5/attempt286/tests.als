...
Track = Track0 + Track1 + Track2
succs = Track1->Track2 + Track2->Track2
...
some disj Track2, Track1, Track0: Track {some disj Speed0, Semaphore0, Signal0: Signal {
Track = Track0 + Track1 + Track2
succs = Track0->Track0 + Track0->Track2 + Track1->Track1 + Track1->Track2 + Track2->Track0 + Track2->Track1
...
Track = Track0 + Track1 + Track2
succs = Track1->Track2 + Track2->Track2
signals = Track2->Speed0 + Track2->Speed1 + Track2->Speed2
no Semaphore
no Semaphore' --loop state
...
Track = Track0 + Track1 + Track2
succs = Track0->Track2 + Track2->Track1 + Track2->Track2
signals = Track2->Speed0
no Semaphore
no Semaphore' --loop state
Speed = Speed0
