...
some disj Track2, Track1, Track0: Track {some disj Speed0, Semaphore0: Signal {
Track = Track0 + Track1 + Track2
succs = Track0->Track2 + Track1->Track0 + Track2->Track0 + Track2->Track1
...
Track = Track0 + Track1 + Track2
succs = Track0->Track1 + Track1->Track1 + Track1->Track2 + Track2->Track1
signals = Track0->Speed0 + Track0->Speed1 + Track0->Semaphore0 + Track1->Speed1 + Track2->Speed1
Semaphore = Semaphore0
Speed = Speed0 + Speed1
Signal = Speed0 + Speed1 + Semaphore0
no Junction
...
some disj Track2, Track1, Track0: Track {some disj Speed0, Semaphore0, Signal0: Signal {
Track = Track0 + Track1 + Track2
succs = Track0->Track0 + Track0->Track2 + Track1->Track0 + Track2->Track1
signals = Track0->Speed0 + Track1->Signal0 + Track1->Semaphore0 + Track2->Speed0
Semaphore = Semaphore0
Speed = Speed0
Signal = Signal0 + Speed0 + Semaphore0
...
Track = Track0 + Track1 + Track2
succs = Track1->Track0 + Track2->Track1
