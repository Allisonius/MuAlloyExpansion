...
Track = Track0 + Track1
succs = Track0->Track0
signals = Track0->Semaphore1 + Track1->Signal0 + Track1->Semaphore0
...
signals = Track0->Semaphore0 + Track1->Signal0 + Track1->Speed0 + Track2->Signal0 + Track2->Speed0
Semaphore = Semaphore0
Speed = Speed0
Signal = Signal0 + Speed0 + Semaphore0
no Junction
...
some disj Track2, Track1, Track0: Track {some disj Speed0, Semaphore0, Signal0: Signal {
Track = Track0 + Track1 + Track2
succs = Track0->Track2 + Track1->Track0 + Track1->Track2 + Track2->Track0
signals = Track0->Speed0 + Track1->Signal0 + Track1->Semaphore0 + Track2->Signal0 + Track2->Speed0
Semaphore = Semaphore0
Speed = Speed0
Signal = Signal0 + Speed0 + Semaphore0
