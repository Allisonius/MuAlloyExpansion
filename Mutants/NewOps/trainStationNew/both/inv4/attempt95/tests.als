...
Track = Track0 + Track1 + Track2
succs = Track0->Track1 + Track1->Track2 + Track2->Track0
signals = Track0->Speed0 + Track0->Semaphore0 + Track2->Speed0
Semaphore = Semaphore0
Speed = Speed0
Signal = Speed0 + Semaphore0
Junction = Track1 + Track2
...
Track = Track0 + Track1 + Track2
succs = Track0->Track1 + Track1->Track2 + Track2->Track0
signals = Track0->Speed1 + Track1->Speed0 + Track2->Speed0 + Track2->Speed1
Semaphore = Semaphore0
Speed = Speed0 + Speed1
...
Track = Track0 + Track1 + Track2
succs = Track0->Track2 + Track1->Track0 + Track2->Track1
signals = Track0->Speed0 + Track1->Signal0 + Track2->Signal0
Semaphore = Semaphore0
Speed = Speed0
Signal = Signal0 + Speed0 + Semaphore0
no Junction
