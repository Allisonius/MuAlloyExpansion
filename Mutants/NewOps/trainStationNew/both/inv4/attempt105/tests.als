...
succs = Track0->Track0 + Track0->Track2 + Track1->Track1 + Track2->Track1
...
some disj Track2, Track1, Track0: Track {some disj Speed0, Semaphore0, Semaphore1: Signal {
Track = Track0 + Track1 + Track2
succs = Track0->Track0 + Track1->Track1 + Track2->Track1
...
signals = Track0->Speed0 + Track0->Speed1 + Track1->Speed0 + Track1->Signal0
no Semaphore
...
Track = Track0 + Track1 + Track2
succs = Track0->Track0 + Track0->Track2 + Track1->Track1
signals = Track1->Semaphore1 + Track1->Semaphore2 + Track2->Semaphore0
