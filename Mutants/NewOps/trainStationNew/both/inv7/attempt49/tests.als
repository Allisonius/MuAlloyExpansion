...
signals = Track0->Semaphore1 + Track1->Speed0 + Track1->Semaphore1 + Track2->Speed0 + Track2->Semaphore0
Semaphore = Semaphore0 + Semaphore1
Speed = Speed0
Signal = Speed0 + Semaphore0 + Semaphore1
Junction = Track1
...
Track = Track0 + Track1 + Track2
succs = Track0->Track0 + Track0->Track1 + Track2->Track1
signals = Track1->Signal0 + Track1->Semaphore0 + Track1->Semaphore1
Semaphore = Semaphore0 + Semaphore1
no Speed
no Speed' --loop state
...
Track = Track0 + Track1
succs = Track0->Track1
signals = Track0->Signal0 + Track1->Semaphore1
Semaphore = Semaphore0 + Semaphore1
no Speed
no Speed' --loop state
Signal = Signal0 + Semaphore0 + Semaphore1
