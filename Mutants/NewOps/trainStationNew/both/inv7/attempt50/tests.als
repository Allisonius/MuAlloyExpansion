...
Track = Track0 + Track1 + Track2
succs = Track0->Track2 + Track1->Track0 + Track1->Track1 + Track2->Track1 + Track2->Track2
no signals
...
Track = Track0 + Track1 + Track2
succs = Track0->Track1 + Track1->Track1 + Track1->Track2 + Track2->Track0
signals = Track0->Signal0 + Track1->Signal0 + Track2->Signal0
Semaphore = Semaphore0 + Semaphore1
no Speed
no Speed' --loop state
Signal = Signal0 + Semaphore0 + Semaphore1
...
Track = Track0 + Track1 + Track2
succs = Track0->Track0 + Track0->Track2 + Track1->Track0 + Track1->Track1 + Track2->Track1 + Track2->Track2
signals = Track1->Signal0 + Track1->Speed1
no Semaphore
no Semaphore' --loop state
Speed = Speed0 + Speed1
