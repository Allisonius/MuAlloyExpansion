...
Track = Track0 + Track1
succs = Track1->Track0
signals = Track1->Speed0 + Track1->Signal0 + Track1->Speed1
no Semaphore
...
signals = Track1->Semaphore2 + Track2->Semaphore0 + Track2->Semaphore1 + Track2->Semaphore2
...
signals = Track2->Semaphore0 + Track2->Semaphore1
Semaphore = Semaphore0 + Semaphore1
no Speed
no Speed' --loop state
...
some disj Track2, Track1, Track0: Track {some disj Speed0, Semaphore0, Signal0: Signal {
Track = Track0 + Track1 + Track2
succs = Track0->Track1 + Track0->Track2 + Track1->Track2
...
pred test50 {
some disj Track1, Track0: Track {some disj Speed1, Speed0: Signal {
Track = Track0 + Track1
succs = Track1->Track0
