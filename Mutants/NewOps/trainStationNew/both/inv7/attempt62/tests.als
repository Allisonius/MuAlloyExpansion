...
signals = Track1->Speed0 + Track2->Speed0 + Track2->Signal0
no Semaphore
no Semaphore' --loop state
Speed = Speed0
...
Track = Track0 + Track1 + Track2
succs = Track0->Track2 + Track1->Track0 + Track2->Track1
signals = Track0->Speed0 + Track1->Signal0
Semaphore = Semaphore0
Speed = Speed0
Signal = Signal0 + Speed0 + Semaphore0
Junction = Track2
...
Track = Track0 + Track1 + Track2
succs = Track0->Track2 + Track1->Track0 + Track2->Track1
signals = Track0->Signal0 + Track2->Signal0 + Track2->Speed0 + Track2->Semaphore0
Semaphore = Semaphore0
Speed = Speed0
Signal = Signal0 + Speed0 + Semaphore0
no Junction
