...
Track = Track0 + Track1 + Track2
succs = Track0->Track2 + Track1->Track0 + Track2->Track1
signals = Track0->Speed0 + Track0->Speed1 + Track0->Semaphore0 + Track2->Speed0 + Track2->Speed1 + Track2->Semaphore0
Semaphore = Semaphore0
Speed = Speed0 + Speed1
Signal = Speed0 + Speed1 + Semaphore0
Junction = Track1
...
Track = Track0 + Track1 + Track2
succs = Track0->Track1 + Track0->Track2 + Track1->Track2 + Track2->Track0
signals = Track1->Speed0 + Track2->Speed0 + Track2->Speed1 + Track2->Semaphore0
Semaphore = Semaphore0
Speed = Speed0 + Speed1
Signal = Speed0 + Speed1 + Semaphore0
no Junction
