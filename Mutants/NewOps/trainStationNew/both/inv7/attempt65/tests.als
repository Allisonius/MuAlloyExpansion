...
Track = Track0 + Track1
succs = Track1->Track1
signals = Track0->Semaphore1 + Track1->Speed0
Semaphore = Semaphore0 + Semaphore1
Speed = Speed0
...
pred test15 {
some disj Track0: Track {some disj Semaphore0, Signal0: Signal {
Track = Track0
no succs
no signals
Semaphore = Semaphore0
...
pred test20 {
some disj Track0: Track {some disj Semaphore0: Signal {
Track = Track0
no succs
no signals
Semaphore = Semaphore0
...
Track = Track0 + Track1 + Track2
no succs
signals = Track2->Signal0 + Track2->Signal1 + Track2->Semaphore0
Semaphore = Semaphore0
no Speed
no Speed' --loop state
Signal = Signal0 + Signal1 + Semaphore0
...
Track = Track0 + Track1 + Track2
succs = Track0->Track1
signals = Track1->Signal0 + Track2->Signal0 + Track2->Speed0 + Track2->Speed1
no Semaphore
no Semaphore' --loop state
Speed = Speed0 + Speed1
...
Track = Track0 + Track1 + Track2
succs = Track0->Track2
signals = Track1->Speed1 + Track2->Signal0 + Track2->Speed0 + Track2->Speed1
no Semaphore
no Semaphore' --loop state
Speed = Speed0 + Speed1
Signal = Signal0 + Speed0 + Speed1
