...
Track = Track0 + Track1
succs = Track0->Track1 + Track1->Track1
signals = Track0->Semaphore0 + Track0->Semaphore1 + Track1->Semaphore1 + Track1->Semaphore2
Semaphore = Semaphore0 + Semaphore1 + Semaphore2
no Speed
no Speed' --loop state
Signal = Semaphore0 + Semaphore1 + Semaphore2
...
signals = Track0->Speed0 + Track0->Semaphore1 + Track1->Speed0 + Track1->Semaphore0 + Track1->Semaphore1
Semaphore = Semaphore0 + Semaphore1
Speed = Speed0
Signal = Speed0 + Semaphore0 + Semaphore1
Junction = Track0
