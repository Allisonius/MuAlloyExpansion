...
succs = Track2->Track2
signals = Track0->Signal0 + Track2->Semaphore0
Semaphore = Semaphore0 + Semaphore1
no Speed
no Speed' --loop state
...
signals = Track0->Signal1 + Track2->Signal0
Semaphore = Semaphore0
no Speed
no Speed' --loop state
Signal = Signal0 + Signal1 + Semaphore0
...
Track = Track0 + Track1
succs = Track0->Track1 + Track1->Track0 + Track1->Track1
signals = Track0->Speed0 + Track1->Signal1
no Semaphore
no Semaphore' --loop state
Speed = Speed0
Signal = Signal0 + Signal1 + Speed0
...
signals = Track0->Semaphore2 + Track2->Semaphore0
