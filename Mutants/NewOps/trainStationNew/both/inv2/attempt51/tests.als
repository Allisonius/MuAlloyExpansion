...
Track = Track0 + Track1
succs = Track1->Track1
signals = Track0->Speed0 + Track0->Speed1 + Track1->Speed0 + Track1->Speed1
no Semaphore
...
Track = Track0 + Track1
succs = Track0->Track0
signals = Track0->Signal0 + Track0->Speed0 + Track1->Speed0 + Track1->Semaphore0
Semaphore = Semaphore0
Speed = Speed0
Signal = Signal0 + Speed0 + Semaphore0
no Junction
...
Track = Track0 + Track1
succs = Track0->Track0
signals = Track0->Signal0 + Track0->Signal1 + Track1->Signal0 + Track1->Signal1
no Semaphore
no Semaphore' --loop state
no Speed
no Speed' --loop state
