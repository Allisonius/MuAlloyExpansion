...
Track = Track0 + Track1
succs = Track0->Track0
signals = Track0->Speed0 + Track0->Speed1 + Track0->Speed2 + Track1->Speed0 + Track1->Speed2
no Semaphore
no Semaphore' --loop state
Speed = Speed0 + Speed1 + Speed2
Signal = Speed0 + Speed1 + Speed2
...
Track = Track0 + Track1
succs = Track0->Track0
signals = Track0->Speed0 + Track0->Speed1 + Track1->Speed0 + Track1->Speed1 + Track1->Speed2
no Semaphore
no Semaphore' --loop state
Speed = Speed0 + Speed1 + Speed2
Signal = Speed0 + Speed1 + Speed2
