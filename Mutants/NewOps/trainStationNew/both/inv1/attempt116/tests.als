...
Track = Track0 + Track1
succs = Track0->Track0 + Track0->Track1 + Track1->Track1
signals = Track0->Speed1 + Track0->Semaphore0
Semaphore = Semaphore0
Speed = Speed0 + Speed1
...
succs = Track0->Track0 + Track1->Track1 + Track1->Track2 + Track2->Track1 + Track2->Track2
signals = Track1->Speed0 + Track1->Semaphore0 + Track1->Semaphore1 + Track2->Speed0
Semaphore = Semaphore0 + Semaphore1
Speed = Speed0
Signal = Speed0 + Semaphore0 + Semaphore1
Junction = Track2
...
Track = Track0 + Track1 + Track2
succs = Track2->Track2
signals = Track0->Speed1 + Track1->Speed0 + Track1->Speed1 + Track1->Speed2
no Semaphore
