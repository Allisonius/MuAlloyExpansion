...
Track = Track0 + Track1
succs = Track0->Track0
signals = Track0->Signal1 + Track0->Speed0 + Track1->Signal0 + Track1->Signal1 + Track1->Speed0
no Semaphore
...
Track = Track0 + Track1
succs = Track0->Track0
signals = Track0->Signal1 + Track0->Semaphore0
Semaphore = Semaphore0
no Speed
no Speed' --loop state
Signal = Signal0 + Signal1 + Semaphore0
...
Track = Track0
succs = Track0->Track0
signals = Track0->Signal1 + Track0->Signal2
no Semaphore
no Semaphore' --loop state
no Speed
no Speed' --loop state
