...
succs = Track0->Track0 + Track0->Track2 + Track1->Track0 + Track1->Track1 + Track2->Track2
...
Track = Track0 + Track1 + Track2
succs = Track0->Track0 + Track0->Track1 + Track0->Track2 + Track1->Track1 + Track2->Track0 + Track2->Track2
no signals
Semaphore = Semaphore0
no Speed
no Speed' --loop state
