...
succs = Track0->Track0 + Track0->Track1 + Track1->Track1 + Track1->Track2 + Track2->Track1 + Track2->Track2
...
Track = Track0 + Track1 + Track2
succs = Track0->Track0 + Track0->Track1 + Track0->Track2 + Track1->Track1 + Track1->Track2 + Track2->Track0 + Track2->Track1 + Track2->Track2
...
signals = Track0->Signal1 + Track1->Signal0 + Track2->Signal1
no Semaphore
no Semaphore' --loop state
Speed = Speed0
