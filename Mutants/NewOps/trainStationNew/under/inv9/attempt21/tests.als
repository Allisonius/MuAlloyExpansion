...
signals = Track0->Semaphore1 + Track1->Signal0 + Track1->Semaphore0 + Track1->Semaphore1 + Track2->Semaphore0
Semaphore = Semaphore0 + Semaphore1
no Speed
no Speed' --loop state
Signal = Signal0 + Semaphore0 + Semaphore1
...
signals = Track0->Semaphore0 + Track0->Semaphore1 + Track0->Semaphore2 + Track1->Semaphore0 + Track1->Semaphore1 + Track2->Semaphore1
Semaphore = Semaphore0 + Semaphore1 + Semaphore2
no Speed
no Speed' --loop state
Signal = Semaphore0 + Semaphore1 + Semaphore2
