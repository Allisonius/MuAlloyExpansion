...
signals = Track1->Signal2 + Track2->Signal0 + Track2->Signal1
no Semaphore
...
signals = Track1->Semaphore0 + Track2->Speed1
Semaphore = Semaphore0
Speed = Speed0 + Speed1
...
some disj Track2, Track1, Track0: Track {some disj Speed0, Semaphore0, Semaphore1: Signal {
Track = Track0 + Track1 + Track2
succs = Track0->Track1 + Track0->Track2 + Track1->Track2 + Track2->Track1
signals = Track1->Semaphore1 + Track2->Speed0 + Track2->Semaphore1
Semaphore = Semaphore0 + Semaphore1
Speed = Speed0
Signal = Speed0 + Semaphore0 + Semaphore1
no Junction
