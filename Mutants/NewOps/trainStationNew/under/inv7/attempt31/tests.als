...
signals = Track0->Speed2 + Track1->Speed0 + Track1->Speed1 + Track2->Speed1 + Track2->Speed2
no Semaphore
...
some disj Track2, Track1, Track0: Track {some disj Speed0, Semaphore0, Signal0: Signal {
Track = Track0 + Track1 + Track2
succs = Track1->Track0 + Track1->Track2 + Track2->Track0
signals = Track1->Signal0
Semaphore = Semaphore0
Speed = Speed0
Signal = Signal0 + Speed0 + Semaphore0
...
signals = Track1->Speed1 + Track1->Speed2
no Semaphore
no Semaphore' --loop state
Speed = Speed0 + Speed1 + Speed2
Signal = Speed0 + Speed1 + Speed2
...
signals = Track1->Semaphore0 + Track1->Semaphore1 + Track2->Semaphore2
...
signals = Track1->Speed1 + Track2->Speed0 + Track2->Signal0
no Semaphore
no Semaphore' --loop state
Speed = Speed0 + Speed1
