...
pred test5 {
some disj Track0: Track {some disj Semaphore0, Semaphore1: Signal {
Track = Track0
no succs
no signals
...
signals = Track2->Signal0 + Track2->Semaphore1
Semaphore = Semaphore0 + Semaphore1
no Speed
no Speed' --loop state
Signal = Signal0 + Semaphore0 + Semaphore1
...
signals = Track0->Speed2 + Track1->Speed1 + Track1->Speed2 + Track2->Speed0
no Semaphore
no Semaphore' --loop state
