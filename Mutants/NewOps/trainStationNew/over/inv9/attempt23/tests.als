...
succs = Track2->Track0
signals = Track0->Semaphore0 + Track2->Semaphore2
...
signals = Track0->Signal0 + Track0->Semaphore1 + Track1->Signal0 + Track1->Semaphore0 + Track2->Semaphore1
Semaphore = Semaphore0 + Semaphore1
no Speed
no Speed' --loop state
...
signals = Track0->Speed0 + Track1->Speed0 + Track2->Signal0 + Track2->Speed0 + Track2->Semaphore0
Semaphore = Semaphore0
Speed = Speed0
Signal = Signal0 + Speed0 + Semaphore0
Junction = Track2
...
Track = Track0 + Track1 + Track2
succs = Track2->Track2
signals = Track0->Speed0 + Track1->Signal0 + Track2->Signal0 + Track2->Speed0 + Track2->Semaphore0
Semaphore = Semaphore0
Speed = Speed0
Signal = Signal0 + Speed0 + Semaphore0
Junction = Track2
