...
Track = Track0
succs = Track0->Track0
signals = Track0->Speed1 + Track0->Signal0
no Semaphore
...
Track = Track0 + Track1
succs = Track0->Track0
signals = Track0->Speed1 + Track1->Signal0 + Track1->Speed0
no Semaphore
no Semaphore' --loop state
Speed = Speed0 + Speed1
...
Track = Track0 + Track1
succs = Track0->Track0
signals = Track0->Signal0 + Track0->Speed1 + Track1->Signal0 + Track1->Speed1
no Semaphore
no Semaphore' --loop state
Speed = Speed0 + Speed1
Signal = Speed0 + Signal0 + Speed1
...
succs = Track1->Track1
signals = Track0->Speed0 + Track1->Speed0 + Track1->Semaphore0 + Track2->Signal0 + Track2->Speed0
Semaphore = Semaphore0
Speed = Speed0
Signal = Signal0 + Speed0 + Semaphore0
Junction = Track2
...
pred test31 {
some disj Speed1, Speed0: Signal {
no Track
no succs
no signals
no Track' --loop state
