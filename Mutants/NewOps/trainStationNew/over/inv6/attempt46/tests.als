...
pred test7 {
some disj Semaphore0, Signal0, Signal1: Signal {
no Track
no succs
no signals
no Track' --loop state
...
Track = Track0 + Track1 + Track2
succs = Track2->Track2
signals = Track0->Signal0 + Track0->Speed1 + Track1->Speed0 + Track1->Signal0 + Track2->Speed0 + Track2->Signal0
no Semaphore
no Semaphore' --loop state
Speed = Speed0 + Speed1
