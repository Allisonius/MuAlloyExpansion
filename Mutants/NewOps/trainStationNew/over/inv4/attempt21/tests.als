...
Track = Track0 + Track1
succs = Track0->Track0 + Track1->Track0 + Track1->Track1
signals = Track0->Signal0 + Track1->Speed0 + Track1->Speed1
no Semaphore
no Semaphore' --loop state
Speed = Speed0 + Speed1
Signal = Speed0 + Speed1 + Signal0
...
Track = Track0 + Track1 + Track2
succs = Track0->Track0 + Track2->Track0
signals = Track0->Speed1 + Track1->Speed0 + Track2->Semaphore0
Semaphore = Semaphore0
Speed = Speed0 + Speed1
Signal = Speed0 + Speed1 + Semaphore0
Junction = Track2
...
Track = Track0 + Track1 + Track2
succs = Track0->Track1 + Track0->Track2 + Track1->Track0 + Track2->Track0 + Track2->Track2
signals = Track1->Semaphore2 + Track2->Semaphore1
Semaphore = Semaphore0 + Semaphore1 + Semaphore2
no Speed
no Speed' --loop state
Signal = Semaphore0 + Semaphore1 + Semaphore2
...
signals = Track1->Speed0 + Track2->Semaphore1
Semaphore = Semaphore0 + Semaphore1
Speed = Speed0
Signal = Speed0 + Semaphore0 + Semaphore1
Junction = Track2
