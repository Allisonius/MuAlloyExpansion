...
Track = Track0 + Track1 + Track2
succs = Track0->Track0
signals = Track1->Speed0 + Track1->Semaphore0 + Track2->Speed1 + Track2->Semaphore0
Semaphore = Semaphore0
Speed = Speed0 + Speed1
...
signals = Track1->Semaphore2 + Track2->Semaphore0
...
Track = Track0 + Track1 + Track2
succs = Track1->Track0 + Track2->Track0
signals = Track1->Speed1 + Track2->Speed0 + Track2->Speed1 + Track2->Signal0
no Semaphore
no Semaphore' --loop state
Speed = Speed0 + Speed1
