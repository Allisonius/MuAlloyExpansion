...
suggested = User0->User0 + User1->User1 + User2->User0
Ad = Ad0
...
follows = User0->Influencer0 + User0->Influencer1 + Influencer0->Influencer0 + Influencer0->Influencer1 + Influencer1->User0 + Influencer1->Influencer0
...
sees = User0->Ad0 + User0->Ad1 + User1->Photo0 + Influencer0->Photo0
no posts
