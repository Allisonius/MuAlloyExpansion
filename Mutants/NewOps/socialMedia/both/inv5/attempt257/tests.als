...
sees = User0->Photo0 + User0->Ad0 + Influencer0->Ad0 + Influencer1->Ad1
...
sees = User0->Photo1 + User1->Photo0 + User1->Ad0 + User2->Photo1 + User2->Ad0
...
sees = User0->Photo1 + User0->Ad0 + Influencer0->Photo0 + Influencer1->Photo0
no posts
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->Influencer0
sees = User0->Photo2 + User1->Photo0 + User1->Photo1 + Influencer0->Photo0
...
posts = Influencer0->Photo0 + Influencer1->Ad0 + Influencer2->Photo0 + Influencer2->Ad1
...
posts = Influencer0->Ad0 + Influencer1->Ad1 + Influencer2->Ad0
suggested = Influencer0->Influencer2 + Influencer2->Influencer0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
