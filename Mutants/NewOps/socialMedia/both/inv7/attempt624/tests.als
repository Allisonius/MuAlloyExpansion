...
posts = Influencer0->Photo2 + Influencer1->Photo1 + Influencer1->Photo2
...
posts = User0->Photo1 + User0->Ad0 + Influencer1->Photo1 + Influencer1->Ad0
suggested = User0->Influencer0 + Influencer0->User0 + Influencer0->Influencer0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
sees = User0->Photo0 + User0->Photo1 + Influencer0->Ad0 + Influencer1->Photo0 + Influencer1->Photo1
posts = User0->Photo1 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Ad0
suggested = User0->Influencer1 + Influencer1->User0 + Influencer1->Influencer1
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
...
User = User0 + User1 + User2
follows = User0->User2 + User1->User1 + User1->User2 + User2->User0 + User2->User1
sees = User0->Photo1 + User1->Photo0 + User2->Ad0
