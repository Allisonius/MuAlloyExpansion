...
posts = User0->Ad1 + Influencer0->Ad1 + Influencer1->Ad0
...
no follows
no sees
posts = User0->Ad1 + Influencer0->Photo0 + Influencer1->Photo0 + Influencer1->Ad1
...
no sees
no posts
suggested = User0->Influencer1 + Influencer0->Influencer1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
