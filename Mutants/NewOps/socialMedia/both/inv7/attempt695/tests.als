...
no Influencer' --loop state
User = User0 + User1 + User2
follows = User0->User2 + User1->User2 + User2->User1 + User2->User2
...
suggested = User0->User0 + User1->User0 + User1->User1 + Influencer0->Influencer0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = User0->Influencer1 + Influencer0->Influencer0 + Influencer1->Influencer0
no sees
...
sees = User0->Ad1 + Influencer0->Ad2 + Influencer1->Ad1
