...
sees = User0->Photo0 + User1->Photo0 + User2->Photo1 + User2->Ad0
...
sees = User1->Ad0 + User2->Ad0 + User2->Ad2
...
User = User0 + User1 + User2
follows = User2->User1
sees = User0->Ad1 + User1->Ad1 + User1->Ad2 + User2->Ad0
...
posts = Influencer0->Photo1 + Influencer1->Photo1 + Influencer2->Photo1
no suggested
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
