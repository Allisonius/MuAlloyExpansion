...
pred test8 {
some disj Influencer1, Influencer0, User0: User {some disj Day0, Day1: Day {
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = User0->Influencer1 + Influencer0->Influencer0 + Influencer1->User0 + Influencer1->Influencer1
no sees
no posts
...
Influencer = Influencer0
User = User0 + User1 + Influencer0
follows = User0->User1 + User0->Influencer0 + User1->User1 + User1->Influencer0 + Influencer0->User1
