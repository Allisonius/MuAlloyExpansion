...
posts = User1->Photo0 + User1->Ad0 + User1->Ad1 + User2->Ad1
...
Influencer = Influencer0
User = User0 + User1 + Influencer0
follows = User0->User1 + User0->Influencer0 + User1->User0 + User1->User1 + Influencer0->User0 + Influencer0->Influencer0
sees = User0->Photo0 + User0->Ad1 + User1->Ad0 + Influencer0->Photo0
