...
follows = User0->User0 + Influencer0->User0 + Influencer0->Influencer1 + Influencer1->User0
sees = User0->Photo0 + User0->Photo2 + Influencer0->Photo1
posts = User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer1->Photo1 + Influencer1->Photo2
suggested = User0->Influencer0 + Influencer0->Influencer0 + Influencer0->Influencer1 + Influencer1->Influencer1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
date = Photo0->Day2 + Photo1->Day2 + Photo2->Day1
