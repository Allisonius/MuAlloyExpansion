...
sees = User0->Ad0 + User0->Ad1 + User2->Photo0 + User2->Ad0
posts = User1->Photo0 + User1->Ad0 + User1->Ad1
suggested = User0->User1 + User1->User2 + User2->User0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
...
posts = User0->Photo1 + User0->Ad0 + User2->Photo0 + User2->Ad0
suggested = User0->User1 + User1->User2 + User2->User0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
follows = User0->User0 + Influencer0->Influencer0 + Influencer1->User0 + Influencer1->Influencer1
...
Influencer = Influencer0
User = User0 + User1 + Influencer0
follows = User0->User0 + User1->User0 + User1->User1 + Influencer0->User0 + Influencer0->User1
sees = User0->Ad0 + User1->Photo1
posts = User0->Ad0 + User1->Photo1
suggested = User1->User0 + Influencer0->User1
Ad = Ad0
...
follows = Influencer0->Influencer0 + Influencer0->Influencer2 + Influencer2->Influencer0 + Influencer2->Influencer2
sees = Influencer0->Photo0 + Influencer0->Ad0 + Influencer1->Ad1
posts = Influencer0->Photo0 + Influencer0->Ad0 + Influencer1->Ad1 + Influencer2->Ad0
no suggested
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
no Influencer' --loop state
User = User0 + User1 + User2
follows = User1->User1 + User2->User1 + User2->User2
no sees
no posts
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = User0->User0 + User0->Influencer1 + Influencer0->User0 + Influencer1->Influencer1
sees = User0->Photo0 + User0->Ad1
posts = User0->Photo0 + User0->Ad1 + Influencer0->Ad0 + Influencer1->Photo0
suggested = User0->Influencer0 + Influencer0->Influencer1 + Influencer1->User0 + Influencer1->Influencer0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
