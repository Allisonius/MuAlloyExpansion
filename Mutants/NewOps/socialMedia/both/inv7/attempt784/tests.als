...
sees = User0->Photo1 + User1->Photo0 + User2->Photo1 + User2->Ad0
...
suggested = User0->User2 + User1->User0 + User1->User1 + User2->User2
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
Day = Day0 + Day1 + Day2
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = User0->User0 + User0->Influencer0 + Influencer0->Influencer0 + Influencer0->Influencer1 + Influencer1->Influencer0 + Influencer1->Influencer1
no sees
...
User = User0 + User1 + Influencer0
follows = User0->User0 + User0->User1 + User1->User0 + User1->User1 + Influencer0->User1
sees = User0->Photo1 + User0->Ad0 + User1->Photo0 + Influencer0->Photo1
...
suggested = User0->User0 + User0->User2 + User1->User0 + User1->User2
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
date = Photo0->Day2 + Photo1->Day2 + Photo2->Day1
...
posts = User0->Ad2 + User1->Ad0 + Influencer0->Ad1 + Influencer0->Ad2
...
sees = User0->Ad0 + User0->Ad2 + User1->Ad0 + User1->Ad1 + User2->Ad2
...
posts = User0->Ad2 + Influencer0->Ad1 + Influencer1->Ad0 + Influencer1->Ad2
...
Influencer = Influencer0
User = User0 + User1 + Influencer0
follows = User0->User0 + User0->Influencer0 + User1->User1 + User1->Influencer0
