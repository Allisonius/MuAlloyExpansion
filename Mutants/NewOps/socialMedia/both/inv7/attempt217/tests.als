...
suggested = User0->User0 + User0->User1 + User0->Influencer0 + User1->User0 + User1->Influencer0 + Influencer0->User1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
...
suggested = User0->User1 + User0->Influencer0 + User1->User0 + User1->Influencer0 + Influencer0->User1 + Influencer0->Influencer0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
...
suggested = User0->User0 + User0->User1 + User0->Influencer0 + User1->User0 + User1->Influencer0 + Influencer0->User1 + Influencer0->Influencer0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
