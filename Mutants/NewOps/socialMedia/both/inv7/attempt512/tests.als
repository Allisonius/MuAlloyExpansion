...
User = User0 + Influencer0 + Influencer1
follows = User0->User0 + User0->Influencer1 + Influencer0->User0 + Influencer0->Influencer1 + Influencer1->Influencer0
sees = User0->Ad0 + Influencer1->Ad1 + Influencer1->Ad2
posts = User0->Ad0 + User0->Ad1 + Influencer1->Ad1 + Influencer1->Ad2
...
sees = User0->Ad1 + User0->Ad2 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Ad2
...
User = User0 + User1 + User2
no follows
sees = User0->Ad2 + User2->Ad1 + User2->Ad2
...
posts = User0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo2
...
posts = User0->Photo1 + Influencer1->Photo1 + Influencer1->Ad0
suggested = User0->Influencer1 + Influencer0->User0 + Influencer0->Influencer0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
posts = User1->Photo0 + User1->Ad0 + User2->Photo0 + User2->Ad0 + User2->Ad1
