...
no sees
posts = User1->Photo1
suggested = User0->User0 + User0->User1 + User1->User0 + User1->User1 + User1->Influencer0 + Influencer0->Influencer0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
Day = Day0 + Day1 + Day2
...
no sees
no posts
suggested = User0->User0 + User0->User1 + User0->User2 + User1->User1 + User2->User0 + User2->User2
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
...
suggested = User0->User0 + User0->Influencer0 + User1->User1 + User1->Influencer0 + Influencer0->Influencer0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
Day = Day0 + Day1 + Day2
...
no sees
posts = User0->Photo1
suggested = User0->User0 + User1->User1 + User1->Influencer0 + Influencer0->User0 + Influencer0->User1 + Influencer0->Influencer0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
Day = Day0 + Day1 + Day2
