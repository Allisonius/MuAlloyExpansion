...
suggested = User0->User1 + User1->User0 + User1->User1 + User2->User0
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
Day = Day0 + Day1 + Day2
...
User = User0 + User1 + User2
no follows
sees = User0->Ad1 + User1->Ad0 + User1->Ad2 + User2->Ad0 + User2->Ad2
no posts
...
no sees
no posts
suggested = Influencer0->Influencer2 + Influencer1->Influencer2 + Influencer2->Influencer0 + Influencer2->Influencer1
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
Day = Day0 + Day1 + Day2
