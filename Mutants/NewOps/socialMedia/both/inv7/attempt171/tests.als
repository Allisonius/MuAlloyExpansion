...
no posts
suggested = User0->User0 + User0->User1 + User0->User2 + User1->User0 + User1->User1 + User1->User2 + User2->User0 + User2->User2
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
...
no follows
sees = Influencer1->Ad2 + Influencer2->Ad0
no posts
suggested = Influencer0->Influencer0 + Influencer0->Influencer1 + Influencer0->Influencer2 + Influencer1->Influencer0 + Influencer1->Influencer1 + Influencer2->Influencer0 + Influencer2->Influencer2
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
Day = Day0 + Day1 + Day2
