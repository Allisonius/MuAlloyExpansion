...
suggested = User0->User1 + User1->User1 + User2->User1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
...
no sees
posts = Influencer0->Photo1 + Influencer1->Photo0 + Influencer2->Photo0
...
posts = Influencer0->Photo1 + Influencer1->Photo1 + Influencer1->Photo2 + Influencer2->Photo0
...
no sees
posts = Influencer1->Photo1
suggested = User0->Influencer1 + Influencer0->User0 + Influencer0->Influencer1 + Influencer1->User0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
Day = Day0 + Day1 + Day2
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = User0->User0 + User0->Influencer0 + Influencer0->Influencer0 + Influencer1->Influencer1
...
no sees
no posts
suggested = Influencer1->User0 + Influencer1->Influencer0
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
...
suggested = User0->Influencer0 + Influencer0->User0 + Influencer1->Influencer0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
