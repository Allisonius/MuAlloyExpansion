...
sees = User1->Photo1 + User2->Photo0 + User2->Ad0
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = User0->Influencer1 + Influencer0->User0 + Influencer0->Influencer0 + Influencer1->User0 + Influencer1->Influencer0
...
sees = User0->Ad0
posts = User0->Ad0 + User0->Ad1 + Influencer0->Photo0 + Influencer1->Ad1
