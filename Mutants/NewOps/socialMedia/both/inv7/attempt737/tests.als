...
sees = User0->Photo0 + User0->Photo1 + User1->Ad0 + User2->Photo1
...
suggested = User0->User1 + User1->User0 + Influencer0->User0 + Influencer0->Influencer0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
...
follows = Influencer0->Influencer2 + Influencer2->Influencer0 + Influencer2->Influencer1 + Influencer2->Influencer2
no sees
...
suggested = Influencer1->Influencer2 + Influencer2->Influencer0 + Influencer2->Influencer1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
date = Photo0->Day2 + Photo1->Day2 + Photo2->Day1
