...
no posts
suggested = Influencer0->Influencer2 + Influencer1->Influencer2 + Influencer2->Influencer0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
Day = Day0 + Day1 + Day2
...
no sees
no posts
suggested = User0->Influencer1 + Influencer0->User0 + Influencer1->User0 + Influencer1->Influencer0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
...
posts = User0->Ad0 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer1->Ad0
...
sees = User0->Photo0 + User0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
...
sees = User0->Ad1 + User1->Ad0 + User1->Ad2
posts = User1->Ad0 + User1->Ad1 + User2->Ad2
