...
sees = User0->Photo1
posts = User0->Photo1 + User0->Photo2 + User1->Photo1 + User2->Photo0
no suggested
no Ad
no Ad' --loop state
...
suggested = User0->Influencer0 + User0->Influencer1 + Influencer0->User0 + Influencer0->Influencer0 + Influencer1->User0 + Influencer1->Influencer0 + Influencer1->Influencer1
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
Day = Day0 + Day1 + Day2
...
posts = User0->Photo1 + User1->Photo0 + User1->Photo2 + User2->Photo0
suggested = User0->User1 + User0->User2 + User1->User0 + User1->User1 + User1->User2 + User2->User1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
posts = User2->Photo1
suggested = User0->User1 + User0->User2 + User1->User0 + User1->User1 + User1->User2 + User2->User0 + User2->User1
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
Day = Day0 + Day1 + Day2
