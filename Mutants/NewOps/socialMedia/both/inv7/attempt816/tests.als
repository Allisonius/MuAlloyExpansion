...
posts = User0->Photo0 + User0->Ad1 + Influencer1->Ad0 + Influencer1->Ad1
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = User0->User0 + User0->Influencer0 + User0->Influencer1 + Influencer0->Influencer1 + Influencer1->User0
no sees
posts = User0->Ad0 + User0->Ad1 + Influencer1->Ad1
suggested = Influencer0->User0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
follows = User0->User0 + User0->User2 + User1->User0 + User1->User1 + User2->User1
no sees
posts = User2->Ad0 + User2->Ad1 + User2->Ad2
suggested = User0->User1 + User1->User2 + User2->User0
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
...
suggested = User0->User0 + User0->User1 + User1->User1 + User2->User0 + User2->User2
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
Day = Day0 + Day1 + Day2
...
sees = User1->Photo0 + User1->Photo1 + User2->Photo2
...
Influencer = Influencer0
User = User0 + User1 + Influencer0
follows = User0->User0 + User1->User1 + Influencer0->User1 + Influencer0->Influencer0
