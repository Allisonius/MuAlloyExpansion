...
User = User0 + User1 + User2
follows = User0->User2 + User1->User0 + User2->User1
sees = User0->Photo0 + User0->Ad0 + User1->Ad0 + User2->Photo0 + User2->Photo1
...
sees = Influencer1->Photo1 + Influencer2->Photo0 + Influencer2->Photo1 + Influencer2->Ad0
posts = Influencer2->Photo0 + Influencer2->Photo1 + Influencer2->Ad0
