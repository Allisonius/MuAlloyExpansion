...
sees = User0->Ad0 + User0->Ad2 + Influencer0->Ad1 + Influencer0->Ad2
...
suggested = User0->User0 + User0->Influencer0 + User1->User1 + User1->Influencer0 + Influencer0->User0 + Influencer0->User1 + Influencer0->Influencer0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
Day = Day0 + Day1 + Day2
