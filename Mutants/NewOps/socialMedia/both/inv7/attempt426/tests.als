...
no sees
no posts
suggested = User1->User0 + User1->User1 + User2->User0 + User2->User1
no Ad
no Ad' --loop state
no Photo
no date
...
no sees
no posts
suggested = Influencer0->Influencer1 + Influencer0->Influencer2 + Influencer1->Influencer2 + Influencer2->Influencer0 + Influencer2->Influencer1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
