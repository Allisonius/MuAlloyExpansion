...
posts = User0->Ad0 + User0->Ad1 + User0->Ad2 + Influencer1->Ad1
suggested = User0->User0 + User0->Influencer0 + User0->Influencer1 + Influencer0->Influencer0 + Influencer1->Influencer0 + Influencer1->Influencer1
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
Day = Day0 + Day1 + Day2
