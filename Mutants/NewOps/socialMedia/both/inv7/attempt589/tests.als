...
sees = User1->Photo0 + User1->Ad1 + User2->Photo0
...
sees = User0->Ad0 + User0->Ad1 + User0->Ad2 + Influencer1->Ad0 + Influencer1->Ad2
...
posts = User0->Photo1 + Influencer0->Photo2 + Influencer1->Photo1
suggested = Influencer0->User0
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
