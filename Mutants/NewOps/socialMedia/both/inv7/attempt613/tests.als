...
suggested = Influencer0->Influencer0 + Influencer0->Influencer1 + Influencer0->Influencer2 + Influencer1->Influencer0 + Influencer1->Influencer2 + Influencer2->Influencer0 + Influencer2->Influencer1 + Influencer2->Influencer2
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
...
suggested = User0->User0 + Influencer0->User0 + Influencer0->User1 + Influencer0->Influencer0
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
date = Photo0->Day2 + Photo1->Day2 + Photo2->Day1
...
sees = User1->Photo0 + User1->Ad0 + User1->Ad1
posts = User0->Photo0 + User0->Ad1 + User1->Ad1 + Influencer0->Photo0
suggested = User0->User1 + User0->Influencer0 + User1->User1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
