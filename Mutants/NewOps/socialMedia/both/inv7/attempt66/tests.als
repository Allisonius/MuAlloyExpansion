...
sees = User0->Photo0 + Influencer1->Photo1 + Influencer1->Ad0
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = User0->Influencer0 + User0->Influencer1 + Influencer0->User0 + Influencer1->User0 + Influencer1->Influencer1
no sees
