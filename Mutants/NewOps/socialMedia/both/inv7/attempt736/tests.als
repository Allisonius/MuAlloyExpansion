...
suggested = User0->User1 + User0->User2 + User1->User1 + User2->User2
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
date = Photo0->Day2 + Photo1->Day2 + Photo2->Day1
...
sees = User0->Photo1 + User1->Photo0
posts = User0->Photo1 + User1->Photo2 + User2->Photo0 + User2->Photo1
...
follows = User0->User1 + User0->User2 + User1->User1 + User2->User0
no sees
posts = User0->Ad1 + User1->Ad0 + User1->Ad2 + User2->Ad1
suggested = User0->User2 + User1->User0 + User2->User1
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
...
sees = User0->Photo0 + User0->Photo1 + User0->Ad0 + User2->Photo0 + User2->Photo1 + User2->Ad0
posts = User0->Photo0 + User0->Photo1 + User0->Ad0 + User2->Ad0
...
follows = User0->User1 + User0->User2 + User1->User1 + User2->User0
sees = User2->Ad0
posts = User0->Photo1 + User1->Photo0 + User1->Photo1 + User2->Photo0 + User2->Ad0
suggested = User0->User2 + User1->User0 + User2->User1
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
suggested = User0->User1 + User1->User0 + User2->User0 + User2->User1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
...
posts = User0->Photo0 + User0->Ad0 + User1->Ad0 + User1->Ad1 + User2->Photo0
...
sees = User0->Photo0 + User0->Ad1 + User2->Photo0 + User2->Ad1
no posts
suggested = User0->User2 + User1->User2 + User2->User1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
...
suggested = User0->User1 + User0->User2 + User1->User2 + User2->User0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
Day = Day0 + Day1 + Day2
...
no Influencer' --loop state
User = User0 + User1 + User2
follows = User0->User2 + User1->User0 + User1->User1 + User2->User0 + User2->User2
...
sees = User0->Ad0 + User1->Photo0 + User2->Ad0
