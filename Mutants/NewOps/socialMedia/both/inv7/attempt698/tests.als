...
sees = User0->Ad1 + User1->Ad0
posts = User0->Ad0 + User0->Ad1 + User2->Ad1 + User2->Ad2
suggested = User1->User0 + User1->User2
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
...
follows = User0->User2 + User1->User0
sees = User0->Ad1 + User1->Ad0
posts = User0->Ad1 + User2->Ad1 + User2->Ad2
...
follows = Influencer0->Influencer0 + Influencer0->Influencer2 + Influencer1->Influencer2
...
User = User0 + User1 + User2
no follows
sees = User0->Ad1 + User1->Ad0 + User1->Ad2 + User2->Ad0 + User2->Ad1
...
follows = User1->User0
sees = User1->Ad0 + User1->Ad2
posts = User0->Ad2 + User1->Ad0 + Influencer0->Ad2
suggested = User1->User0
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
...
posts = User0->Ad1 + User0->Ad2 + User1->Ad0 + User2->Ad2
suggested = User0->User1 + User1->User2 + User2->User0
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
