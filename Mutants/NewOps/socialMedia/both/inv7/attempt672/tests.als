...
suggested = User0->User0 + User0->Influencer1 + Influencer0->User0 + Influencer1->User0 + Influencer1->Influencer0 + Influencer1->Influencer1
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
Day = Day0 + Day1 + Day2
...
posts = User0->Photo2 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1
