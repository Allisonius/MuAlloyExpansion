...
posts = User0->Ad0 + User0->Ad1 + Influencer1->Photo0 + Influencer1->Ad0
...
User = User0 + User1 + User2
follows = User0->User0 + User0->User1 + User0->User2 + User1->User0 + User1->User1 + User1->User2 + User2->User0 + User2->User1 + User2->User2
sees = User0->Photo1 + User0->Ad0 + User1->Photo0 + User2->Photo0
posts = User0->Photo1 + User1->Photo1 + User2->Photo0
...
sees = User0->Ad0 + Influencer0->Ad1 + Influencer1->Ad0 + Influencer1->Ad2
