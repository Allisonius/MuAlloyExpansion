...
suggested = User1->User0 + User1->User1 + User2->User2
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
Day = Day0 + Day1 + Day2
...
posts = User0->Photo1 + User0->Photo2 + User1->Photo1 + User2->Photo2
...
follows = User0->User0 + Influencer0->Influencer0 + Influencer1->Influencer0
