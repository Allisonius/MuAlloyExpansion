...
posts = User0->Photo0 + User0->Ad0 + User1->Ad1 + Influencer0->Photo0
...
sees = User0->Photo2 + User1->Photo0 + User2->Photo0 + User2->Photo1 + User2->Photo2
...
User = User0 + User1 + User2
follows = User0->User2 + User1->User0 + User1->User1 + User1->User2
sees = User0->Photo0 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User1->Photo2 + User2->Photo0 + User2->Photo1
...
no follows
sees = Influencer0->Ad2 + Influencer1->Ad0 + Influencer1->Ad1 + Influencer1->Ad2
...
User = User0 + User1 + User2
follows = User2->User1 + User2->User2
sees = User0->Photo0 + User0->Ad1 + User1->Photo0 + User2->Photo0 + User2->Ad0
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User1 + Influencer0->User0
sees = User0->Ad1 + User1->Ad0 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer0->Ad2
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User1 + Influencer0->User0
sees = User0->Photo0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + Influencer0->Photo0 + Influencer0->Ad0
