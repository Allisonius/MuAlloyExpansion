...
sees = User0->Photo0 + User0->Ad0 + User1->Photo0 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1
...
sees = User0->Photo0 + User0->Ad1 + User1->Photo0 + User1->Ad1 + User2->Photo0
no posts
suggested = User0->User1 + User1->User0 + User1->User1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
...
sees = User0->Photo0 + User0->Ad0 + User1->Photo0 + User1->Ad0 + User1->Ad1 + User2->Photo0
...
sees = User0->Ad0 + User1->Photo0 + User1->Ad0 + User1->Ad1 + Influencer0->Photo0
