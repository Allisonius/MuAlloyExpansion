...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User1 + Influencer0->User0 + Influencer0->User1
sees = User0->Ad1 + User0->Ad2 + User1->Ad1 + Influencer0->Ad1 + Influencer0->Ad2
...
follows = User0->User0 + User0->Influencer0 + Influencer1->Influencer1
...
sees = User0->Photo0 + User0->Ad1 + Influencer1->Photo0 + Influencer1->Ad1
