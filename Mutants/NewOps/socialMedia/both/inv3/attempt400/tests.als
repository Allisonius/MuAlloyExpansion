...
posts = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Ad0 + Influencer0->Ad0 + Influencer0->Ad1
suggested = User0->User1 + User1->User0 + User1->User1 + User1->Influencer0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
User = User0 + User1 + Influencer0
follows = User0->User1 + User1->User0 + User1->User1 + User1->Influencer0
sees = User0->Photo0 + User1->Photo0 + User1->Photo1 + User1->Ad0 + Influencer0->Photo1
...
sees = User0->Photo0 + Influencer0->Photo2 + Influencer1->Photo1
