...
sees = User0->Photo1 + User0->Ad0 + User1->Photo0 + User1->Photo1 + Influencer0->Photo0 + Influencer0->Ad0
...
User = User0 + User1 + Influencer0
follows = User0->User1 + User1->User0 + User1->User1
sees = User0->Photo1 + User0->Ad0 + User1->Photo0 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Ad0
