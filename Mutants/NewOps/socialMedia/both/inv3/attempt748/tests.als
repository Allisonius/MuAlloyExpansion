...
posts = User0->Ad0 + User0->Ad1 + User1->Ad2
suggested = User0->Influencer0 + User1->User0 + User1->User1
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
...
posts = User0->Photo2 + User1->Photo0 + User1->Photo1 + Influencer0->Photo0 + Influencer0->Photo1
suggested = User0->Influencer0 + User1->User0 + User1->User1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
sees = User1->Photo0 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2
...
sees = User1->Photo0 + User1->Photo2 + User2->Photo2
...
User = User0 + User1 + Influencer0
follows = User0->User1 + User1->User0 + User1->User1 + Influencer0->User1
sees = User0->Photo0 + User1->Photo1 + Influencer0->Photo1 + Influencer0->Photo2
posts = User0->Photo1 + User1->Photo0 + User1->Photo2
...
User = User0 + User1 + Influencer0
follows = User1->User0 + User1->User1 + User1->Influencer0 + Influencer0->User1 + Influencer0->Influencer0
sees = User1->Photo0 + User1->Photo1 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo2
...
sees = User0->Photo0 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User2->Photo0 + User2->Photo1 + User2->Photo2
posts = User0->Photo1
suggested = User0->User1 + User1->User1
no Ad
no Ad' --loop state
...
sees = User0->Photo2 + User1->Photo1
posts = User1->Photo2
suggested = User0->User1 + User1->User1
no Ad
no Ad' --loop state
...
no follows
no sees
posts = Influencer2->Photo0 + Influencer2->Photo1
suggested = Influencer1->Influencer1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
