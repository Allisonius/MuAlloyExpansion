...
sees = User0->Ad1 + User0->Ad2 + User1->Ad0 + User1->Ad1 + User1->Ad2 + User2->Ad1 + User2->Ad2
posts = User1->Ad0
suggested = User1->User0
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
...
User = User0 + User1 + Influencer0
follows = User0->User0 + User1->User0 + User1->User1 + User1->Influencer0 + Influencer0->User0 + Influencer0->Influencer0
sees = User0->Ad1 + User1->Photo0 + User1->Ad0 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1
