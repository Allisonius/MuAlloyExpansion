...
sees = User0->Ad0 + User1->Photo0 + User1->Photo1 + Influencer0->Photo0 + Influencer0->Ad0
...
posts = User0->Ad0 + User0->Ad1 + Influencer0->Photo0 + Influencer0->Ad0
no suggested
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
follows = User2->User2
sees = User0->Ad0 + User1->Ad0 + User2->Ad1
no posts
