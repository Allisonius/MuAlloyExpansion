...
sees = User0->Ad1 + Influencer0->Ad1 + Influencer1->Ad1
posts = User0->Ad0 + Influencer0->Ad0 + Influencer1->Ad1
...
follows = Influencer0->Influencer2 + Influencer1->Influencer0 + Influencer1->Influencer1
sees = Influencer0->Photo0 + Influencer0->Ad0 + Influencer1->Photo1 + Influencer1->Ad0 + Influencer2->Ad0
posts = Influencer0->Photo0 + Influencer0->Photo1 + Influencer1->Photo1
...
pred test24 {
some disj User1, User0: User {some disj Ad0: Photo {some disj Day0, Day1: Day {
no Influencer
no Influencer' --loop state
User = User0 + User1
follows = User1->User0
...
pred test28 {
some disj Influencer0, User0: User {some disj Ad0, Ad1: Photo {some disj Day0, Day1: Day {
Influencer = Influencer0
...
posts = User0->Photo0 + User0->Ad0 + Influencer1->Ad0
...
pred test32 {
some disj User0: User {some disj Ad0, Photo0: Photo {some disj Day0, Day1, Day2: Day {
no Influencer
no Influencer' --loop state
User = User0
no follows
...
User = User0 + User1 + Influencer0
follows = User1->User0 + User1->User1 + Influencer0->User1
sees = User0->Photo0 + User0->Ad0 + User1->Photo0 + User1->Ad0 + Influencer0->Photo1 + Influencer0->Ad0
...
sees = User0->Ad0 + User1->Photo1 + User1->Ad0 + User2->Ad0
posts = User0->Photo1 + User1->Photo1 + User1->Ad0 + User2->Ad0
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User1 + Influencer0->User0 + Influencer0->User1
sees = User0->Ad1 + User1->Ad0 + User1->Ad1 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer0->Ad2
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User0 + User1->User1 + User1->Influencer0 + Influencer0->User1 + Influencer0->Influencer0
sees = User0->Ad1 + User1->Ad0 + User1->Ad1 + Influencer0->Ad0 + Influencer0->Ad1
posts = User1->Ad0 + Influencer0->Ad1
suggested = User1->User0 + User1->User1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
