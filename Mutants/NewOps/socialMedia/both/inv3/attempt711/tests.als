...
sees = User0->Ad2 + User1->Ad1 + Influencer0->Ad0 + Influencer0->Ad2
...
posts = User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad0
...
posts = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad0
...
sees = User0->Ad1 + User1->Photo0 + User1->Ad0 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1
...
posts = User0->Photo0 + User1->Photo0 + User1->Ad0 + Influencer0->Photo0 + Influencer0->Ad1
...
pred test9 {
some disj User1, User0: User {some disj Photo0: Photo {some disj Day0, Day1, Day2: Day {
no Influencer
no Influencer' --loop state
User = User0 + User1
follows = User1->User1
sees = User0->Photo0 + User1->Photo0
posts = User0->Photo0 + User1->Photo0
suggested = User1->User1
no Ad
no Ad' --loop state
Photo = Photo0
...
User = User0 + User1 + Influencer0
follows = User1->User0
sees = User0->Photo0 + User0->Photo1 + User1->Photo0 + User1->Photo1 + User1->Photo2 + Influencer0->Photo2
...
sees = User0->Ad2 + User1->Ad0 + User1->Ad1 + Influencer0->Ad2
...
User = User0 + User1 + Influencer0
follows = User0->User1 + User1->User0 + User1->User1 + Influencer0->User1
sees = User0->Ad2 + User1->Ad0 + User1->Ad1 + User1->Ad2
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User0 + Influencer0->User1 + Influencer0->Influencer0
sees = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + Influencer0->Photo2
...
sees = User0->Photo0 + User0->Ad0 + User1->Photo0 + User1->Ad0 + Influencer0->Ad1
...
sees = User0->Photo0 + User0->Photo1 + User1->Photo0 + User1->Photo1 + Influencer0->Photo2
...
sees = User0->Photo1 + User1->Photo0 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2
...
no follows
sees = User0->Photo1 + User1->Photo1 + User2->Photo0
...
posts = User0->Photo0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + Influencer0->Ad1
suggested = User0->Influencer0 + User1->User0 + User1->User1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
sees = User0->Photo0 + User0->Ad0 + User1->Ad0 + User1->Ad1 + Influencer0->Photo0
posts = User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + Influencer0->Ad1
suggested = User0->Influencer0 + User1->User0 + User1->User1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
posts = User0->Photo0 + User1->Photo0 + User1->Ad0 + User1->Ad1
suggested = User0->Influencer0 + User1->User0 + User1->User1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
pred test36 {
some disj Influencer0, User1, User0: User {some disj Photo1, Photo0: Photo {some disj Day0, Day1: Day {
Influencer = Influencer0
User = User0 + User1 + Influencer0
...
follows = User0->Influencer1 + Influencer1->Influencer1
sees = User0->Photo0 + User0->Ad1 + Influencer0->Photo0 + Influencer0->Ad1 + Influencer1->Photo0 + Influencer1->Ad0
posts = User0->Photo0 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer1->Photo0
...
sees = User0->Photo0 + User0->Photo1 + User1->Photo1 + User1->Ad0 + Influencer0->Photo1
posts = User0->Photo1 + User0->Ad0 + User1->Photo0 + User1->Photo1 + Influencer0->Photo0 + Influencer0->Ad0
suggested = User0->Influencer0 + User1->User0 + User1->User1
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
sees = User0->Photo0 + User0->Ad1 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Photo0 + Influencer1->Ad0 + Influencer1->Ad1
...
User = User0 + Influencer0 + Influencer1
follows = Influencer1->Influencer1
sees = User0->Photo1 + User0->Ad0 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer1->Photo1 + Influencer1->Ad0
...
Influencer = Influencer0
User = User0 + User1 + Influencer0
follows = User1->User1 + Influencer0->User1 + Influencer0->Influencer0
sees = User0->Photo0 + User0->Photo1 + User1->Photo1 + User1->Ad0 + Influencer0->Photo1 + Influencer0->Ad0
...
no follows
no sees
posts = Influencer0->Photo0 + Influencer1->Photo0 + Influencer1->Ad0 + Influencer1->Ad1
...
sees = User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = User0->Influencer1 + Influencer0->User0 + Influencer0->Influencer0 + Influencer1->Influencer0
sees = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
...
User = User0 + User1 + User2
no follows
sees = User0->Ad0 + User0->Ad1 + User1->Photo0 + User2->Ad0 + User2->Ad1
posts = User0->Photo0 + User0->Ad1 + User1->Photo0 + User1->Ad1 + User2->Photo0 + User2->Ad0 + User2->Ad1
...
pred test49 {
some disj Influencer0, User1, User0: User {some disj Photo0: Photo {some disj Day0, Day1, Day2: Day {
Influencer = Influencer0
User = User0 + User1 + Influencer0
follows = User0->User0 + User0->User1 + User0->Influencer0 + User1->User0 + User1->User1 + User1->Influencer0
sees = User0->Photo0 + User1->Photo0
posts = User0->Photo0 + User1->Photo0 + Influencer0->Photo0
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = User0->Influencer1 + Influencer1->User0 + Influencer1->Influencer1
sees = User0->Ad0 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer1->Photo1 + Influencer1->Ad0
posts = User0->Photo0 + User0->Photo1 + User0->Ad0 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Ad0
suggested = User0->Influencer1 + Influencer1->User0 + Influencer1->Influencer1
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
sees = User0->Ad1 + Influencer0->Photo0 + Influencer0->Ad1
posts = User0->Photo0 + User0->Ad1 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Photo0
suggested = User0->Influencer1 + Influencer0->Influencer0 + Influencer1->User0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
...
posts = User0->Photo0 + User1->Photo0 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1
suggested = User0->User1 + User1->User0 + User1->User1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
sees = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
suggested = User0->Influencer1 + Influencer1->User0 + Influencer1->Influencer1
no Ad
no Ad' --loop state
...
sees = User1->Photo0 + User2->Ad0 + User2->Ad1
posts = User0->Photo0 + User1->Photo0 + User2->Photo0 + User2->Ad1
...
User = User0 + User1 + Influencer0
follows = User0->User1 + User1->User0 + User1->User1 + User1->Influencer0
sees = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo1 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo1 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2
suggested = User0->User1 + User1->User0 + Influencer0->Influencer0
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
sees = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Photo0 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1
posts = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad0
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User0 + User1->User1 + Influencer0->User1
sees = User0->Photo0 + User0->Ad1 + User1->Photo0 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad1
posts = User0->Photo0 + User0->Ad1 + User1->Photo0 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1
...
posts = User0->Ad0 + User1->Photo0 + User1->Photo1 + User1->Ad0 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Ad0
suggested = User1->User0 + User1->User1
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
sees = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad1 + User2->Photo0 + User2->Ad0
posts = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + User1->Ad1 + User2->Photo0 + User2->Ad0
...
sees = User0->Photo0 + User1->Photo0 + User1->Ad0 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad0
posts = User0->Photo0 + User1->Photo0 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad0
suggested = User0->Influencer0 + User1->User0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
...
sees = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad0
posts = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad0
suggested = Influencer0->Influencer0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
...
User = User0 + Influencer0 + Influencer1
follows = User0->Influencer1
sees = User0->Photo0 + User0->Ad0 + User0->Ad1 + Influencer0->Ad1 + Influencer1->Photo0 + Influencer1->Ad0 + Influencer1->Ad1
posts = User0->Photo0 + User0->Ad1 + Influencer0->Ad1 + Influencer1->Ad0 + Influencer1->Ad1
suggested = User0->Influencer1 + Influencer1->User0 + Influencer1->Influencer1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
User = User0 + Influencer0 + Influencer1
follows = User0->Influencer1
sees = User0->Photo0 + User0->Ad0 + User0->Ad1 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Photo0 + Influencer1->Ad1
posts = User0->Photo0 + User0->Ad0 + User0->Ad1 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Ad1
suggested = User0->Influencer1 + Influencer1->User0 + Influencer1->Influencer1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User0 + Influencer0->Influencer0
sees = User0->Photo0 + User0->Ad0 + User1->Photo0 + User1->Ad0 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1
posts = User0->Photo0 + User0->Ad0 + User1->Photo0 + User1->Ad0 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1
suggested = User0->Influencer0 + User1->User0 + User1->User1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = Influencer0->User0 + Influencer0->Influencer1
sees = User0->Ad0 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer1->Photo0 + Influencer1->Ad0 + Influencer1->Ad1
...
User = User0 + Influencer0 + Influencer1
follows = Influencer0->User0 + Influencer0->Influencer1
sees = User0->Photo0 + User0->Ad1 + Influencer0->Ad1 + Influencer1->Ad0 + Influencer1->Ad1
posts = User0->Photo0 + User0->Ad1 + Influencer0->Ad1 + Influencer1->Ad0 + Influencer1->Ad1
suggested = User0->Influencer1 + Influencer0->Influencer0 + Influencer1->User0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
...
sees = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + User2->Photo0 + User2->Ad1
