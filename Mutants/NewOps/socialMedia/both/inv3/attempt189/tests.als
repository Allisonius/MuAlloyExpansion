...
posts = User0->Photo1 + User1->Photo0 + User1->Photo1 + User1->Ad0 + User2->Photo0 + User2->Photo1 + User2->Ad0
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = User0->Influencer1 + Influencer0->User0 + Influencer0->Influencer0 + Influencer1->User0 + Influencer1->Influencer1
sees = User0->Photo0 + User0->Photo1 + User0->Ad0 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Ad0 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Ad0
...
no Influencer' --loop state
User = User0 + User1 + User2
follows = User0->User0 + User0->User2 + User1->User0 + User1->User1 + User2->User0 + User2->User1
