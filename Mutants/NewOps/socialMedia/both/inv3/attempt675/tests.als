...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User0 + User1->User1 + Influencer0->User1
sees = User0->Photo1 + User0->Photo2 + User1->Photo0 + Influencer0->Photo0 + Influencer0->Photo2
...
sees = User0->Photo1 + User1->Photo1 + User1->Photo2 + Influencer0->Photo2
...
posts = User0->Photo1 + User1->Photo0 + User1->Photo1 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo1
...
sees = User0->Ad0 + User1->Ad2 + Influencer0->Ad0
