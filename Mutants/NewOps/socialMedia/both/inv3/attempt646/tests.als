...
sees = User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User1->Photo2 + Influencer0->Photo1 + Influencer0->Photo2
...
posts = User1->Ad0 + User1->Ad1 + User2->Ad0
...
posts = User0->Photo0 + User0->Photo1 + User1->Photo0 + User1->Photo1 + Influencer0->Photo1 + Influencer0->Ad0
suggested = User0->Influencer0 + User1->User0 + User1->User1
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
sees = User0->Photo1 + User0->Photo2 + User1->Photo1 + User1->Photo2 + User2->Photo2
posts = User0->Photo0 + User0->Photo1 + User1->Photo2 + User2->Photo2
...
follows = Influencer0->Influencer2 + Influencer1->Influencer1 + Influencer1->Influencer2
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User0 + Influencer0->User1 + Influencer0->Influencer0
sees = User0->Ad0 + User0->Ad1 + User0->Ad2 + User1->Ad0 + User1->Ad1 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer0->Ad2
no posts
suggested = User0->User1 + Influencer0->User0 + Influencer0->Influencer0
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
