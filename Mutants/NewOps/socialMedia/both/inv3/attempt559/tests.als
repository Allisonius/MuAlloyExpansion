...
no follows
sees = User0->Photo0 + User0->Photo1 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo1 + Influencer1->Photo2
...
suggested = User0->User0 + Influencer0->User0 + Influencer0->Influencer1 + Influencer1->Influencer1
no Ad
no Ad' --loop state
...
sees = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
...
no follows
sees = User1->Photo2 + User2->Photo0 + User2->Photo1 + User2->Photo2
...
sees = User0->Photo0 + User0->Photo1 + Influencer0->Photo0 + Influencer1->Photo1
...
User = User0 + Influencer0 + Influencer1
no follows
sees = User0->Photo1 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo1 + Influencer1->Photo2
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
...
sees = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
suggested = User0->Influencer1 + Influencer1->User0 + Influencer1->Influencer1
no Ad
no Ad' --loop state
...
sees = User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo2
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
suggested = Influencer0->User0 + Influencer0->Influencer0
no Ad
no Ad' --loop state
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = Influencer0->Influencer1 + Influencer1->User0 + Influencer1->Influencer1
...
User = User0 + User1 + User2
follows = User1->User1 + User2->User0
sees = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User2->Photo2
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User1->Photo2 + User2->Photo0 + User2->Photo1 + User2->Photo2
suggested = User0->User2 + User1->User1 + User2->User0
no Ad
no Ad' --loop state
...
User = User0 + User1 + User2
follows = User0->User0 + User1->User1 + User2->User1 + User2->User2
sees = User0->Photo0 + User0->Photo1 + User1->Photo0 + User2->Photo1
