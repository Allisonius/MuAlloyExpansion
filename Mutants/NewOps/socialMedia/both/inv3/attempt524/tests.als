...
posts = User0->Ad1 + User1->Ad1 + User1->Ad2 + User2->Ad1 + User2->Ad2
...
User = User0 + Influencer0 + Influencer1
no follows
sees = User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo2 + Influencer1->Photo1
posts = User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer1->Photo1 + Influencer1->Photo2
...
posts = User0->Ad0 + User0->Ad2 + Influencer0->Ad0 + Influencer1->Ad0
suggested = Influencer0->Influencer0
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
...
follows = User0->User2 + User1->User1
sees = User2->Photo1
posts = User0->Photo1 + User1->Photo0 + User1->Photo1 + User1->Ad0 + User2->Photo1
suggested = User0->User0 + User0->User2 + User2->User0 + User2->User2
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
