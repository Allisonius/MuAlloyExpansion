...
posts = User0->Ad0 + User0->Ad2 + User1->Ad0
...
pred test11 {
some disj Ad0, Photo0, Ad1: Photo {some disj Day0, Day1: Day {
no Influencer
no Influencer' --loop state
no User
no follows
...
posts = Influencer0->Photo0 + Influencer0->Ad1 + Influencer1->Ad0 + Influencer2->Photo0 + Influencer2->Ad1
suggested = Influencer0->Influencer1 + Influencer1->Influencer1 + Influencer2->Influencer0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
...
User = User0 + User1 + Influencer0
follows = User1->User0 + User1->User1 + Influencer0->User1
sees = User0->Ad0 + User0->Ad1 + User1->Ad0 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad0
