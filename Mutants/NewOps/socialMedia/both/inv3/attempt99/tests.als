...
sees = User0->Ad0 + User0->Ad1 + User1->Ad0 + User1->Ad1 + User2->Photo0
...
posts = User0->Ad0 + Influencer0->Ad0 + Influencer0->Ad2 + Influencer1->Ad0 + Influencer1->Ad1
...
User = User0 + Influencer0 + Influencer1
follows = Influencer0->User0 + Influencer1->Influencer0 + Influencer1->Influencer1
sees = User0->Photo1 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer1->Photo0
posts = User0->Photo0 + User0->Photo1 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer1->Photo0 + Influencer1->Photo1
