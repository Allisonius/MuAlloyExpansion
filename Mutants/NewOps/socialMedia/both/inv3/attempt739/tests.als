...
sees = User0->Photo0 + User0->Photo1 + User1->Photo0 + User1->Ad0 + Influencer0->Photo0
...
posts = User1->Ad1 + User1->Ad2 + Influencer0->Ad0 + Influencer0->Ad2
suggested = User0->Influencer0 + User1->User0 + User1->User1
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
...
no sees
no posts
suggested = User0->Influencer1 + Influencer0->Influencer0 + Influencer0->Influencer1
no Ad
no Ad' --loop state
no Photo
no date
...
sees = User0->Ad0 + User1->Ad1 + Influencer0->Ad0
posts = User1->Photo0 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1
...
sees = User0->Ad0 + User0->Ad2 + User1->Ad1 + User1->Ad2 + Influencer0->Ad0 + Influencer0->Ad1
posts = User0->Ad2 + User1->Ad1 + Influencer0->Ad1 + Influencer0->Ad2
suggested = User0->Influencer0 + User1->User1 + Influencer0->User0
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
...
sees = User0->Photo2 + User1->Photo0 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo2
