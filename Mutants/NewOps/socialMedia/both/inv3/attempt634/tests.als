...
suggested = User0->Influencer0 + Influencer0->Influencer1 + Influencer1->Influencer1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
...
posts = User0->Photo1 + User1->Photo1 + User1->Photo2 + User2->Photo2
suggested = User1->User0 + User1->User1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User0 + User1->User1 + Influencer0->User1
sees = User0->Photo2 + User1->Photo1 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2
...
User = User0 + User1 + Influencer0
follows = User1->User0 + User1->User1
sees = User0->Photo0 + User0->Ad1 + User1->Photo0 + Influencer0->Photo0 + Influencer0->Ad0
...
pred test62 {
some disj Ad0, Photo1, Photo0: Photo {some disj Day0: Day {
no Influencer
no Influencer' --loop state
no User
no follows
...
posts = User0->Photo1 + User0->Ad0 + User1->Photo0 + User2->Photo0 + User2->Photo1
