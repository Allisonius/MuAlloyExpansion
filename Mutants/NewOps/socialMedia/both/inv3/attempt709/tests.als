...
sees = User0->Ad1 + User1->Ad0 + User1->Ad2 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer0->Ad2
...
sees = User0->Ad1 + User1->Photo0 + User1->Ad0 + Influencer0->Photo0
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User0 + User1->User1 + Influencer0->User1
sees = User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo2
posts = User0->Photo1
suggested = User0->Influencer0 + User1->User0 + User1->User1
no Ad
no Ad' --loop state
...
User = User0 + User1 + Influencer0
follows = User0->User1 + User1->User0 + User1->User1 + User1->Influencer0
sees = User0->Photo2 + User1->Photo1 + Influencer0->Photo0
...
sees = User0->Ad0 + User1->Photo0 + Influencer0->Ad0
posts = User0->Ad1 + Influencer0->Photo0 + Influencer0->Ad1
suggested = User1->User0 + User1->User1 + User1->Influencer0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
follows = Influencer0->Influencer1 + Influencer1->Influencer1 + Influencer1->Influencer2
sees = Influencer0->Photo1 + Influencer1->Photo1
posts = Influencer1->Photo2 + Influencer2->Photo0 + Influencer2->Photo1
