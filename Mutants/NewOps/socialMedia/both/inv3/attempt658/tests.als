...
posts = User0->Photo1 + User1->Ad0 + Influencer0->Photo1 + Influencer0->Ad0
suggested = User0->Influencer0 + User1->User1 + Influencer0->User0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User1 + Influencer0->User0 + Influencer0->User1
sees = User1->Photo0 + User1->Photo1 + Influencer0->Photo0
...
sees = User0->Photo1 + User0->Photo2 + User1->Photo1 + User1->Photo2 + Influencer0->Photo1 + Influencer0->Photo2
posts = User0->Photo2
no suggested
no Ad
no Ad' --loop state
...
User = User0 + User1 + Influencer0
follows = User0->User1 + User1->User1 + User1->Influencer0 + Influencer0->User1
sees = User0->Photo0 + User0->Photo1 + User1->Photo2 + Influencer0->Photo2
posts = User1->Photo0 + User1->Photo1 + User1->Photo2
suggested = User1->User0 + User1->User1 + User1->Influencer0
no Ad
no Ad' --loop state
...
no sees
posts = User0->Photo1 + Influencer0->Photo1 + Influencer1->Photo2
...
follows = User0->Influencer0 + User1->User0 + User1->User1 + Influencer0->User1
sees = User0->Ad0 + User0->Ad1 + User1->Ad0 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1
posts = User1->Ad0 + Influencer0->Photo0 + Influencer0->Ad0
