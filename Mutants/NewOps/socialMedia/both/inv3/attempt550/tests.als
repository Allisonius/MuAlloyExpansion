...
posts = User0->Ad0 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Photo0 + Influencer1->Ad0 + Influencer1->Ad1
...
posts = User0->Photo1 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Ad0 + Influencer1->Photo0 + Influencer1->Photo1
suggested = Influencer1->User0 + Influencer1->Influencer1
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
sees = User0->Photo0 + User0->Ad0 + User0->Ad1 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Photo0 + Influencer1->Ad0 + Influencer1->Ad1
posts = User0->Ad0 + Influencer0->Photo0 + Influencer1->Photo0 + Influencer1->Ad0 + Influencer1->Ad1
...
pred test21 {
some disj Influencer1, Influencer0: User {some disj Ad0: Photo {some disj Day0: Day {
Influencer = Influencer0 + Influencer1
...
posts = User0->Photo1 + User2->Photo0 + User2->Photo1
...
pred test38 {
some disj User2, User1, User0: User {some disj Ad0, Ad1: Photo {some disj Day0, Day1: Day {
no Influencer
no Influencer' --loop state
User = User0 + User1 + User2
...
sees = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + User1->Ad1 + User2->Photo0 + User2->Ad0 + User2->Ad1
posts = User0->Photo0 + User0->Ad0 + User1->Photo0 + User1->Ad0 + User2->Ad1
...
sees = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + User1->Ad1 + User2->Photo0 + User2->Ad0 + User2->Ad1
posts = User0->Photo0 + User0->Ad1 + User1->Photo0 + User2->Ad0
suggested = User0->User1 + User1->User0 + User1->User1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
