...
sees = User0->Photo1 + User0->Photo2 + User1->Photo1 + User1->Photo2 + User2->Photo0
...
User = User0 + User1 + User2
no follows
sees = User1->Photo0 + User2->Photo0 + User2->Photo1 + User2->Photo2
...
sees = User0->Photo0 + User0->Photo2 + User1->Photo2 + Influencer0->Photo2
