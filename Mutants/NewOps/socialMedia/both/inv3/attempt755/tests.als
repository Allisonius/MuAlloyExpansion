...
sees = User0->Photo0 + User1->Photo1 + Influencer0->Photo0
...
User = User0 + User1 + User2
follows = User0->User2 + User1->User1 + User2->User0
sees = User1->Photo0 + User1->Ad0 + User2->Photo0 + User2->Photo1 + User2->Ad0
...
posts = User1->Ad0 + User1->Ad2 + Influencer0->Ad0 + Influencer0->Ad1
...
sees = User0->Ad1 + User1->Ad0 + Influencer0->Photo0 + Influencer0->Ad0
posts = User0->Photo0 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad1
suggested = User0->Influencer0 + User1->User1 + Influencer0->User0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
sees = User0->Photo0 + User0->Photo1 + User1->Ad0 + Influencer0->Photo0
...
follows = Influencer0->Influencer0 + Influencer0->Influencer2 + Influencer2->Influencer1
sees = Influencer0->Ad0 + Influencer2->Ad2
posts = Influencer1->Ad0 + Influencer1->Ad1 + Influencer2->Ad1
no suggested
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
...
User = User0 + User1 + Influencer0
follows = User1->User0 + User1->User1 + User1->Influencer0 + Influencer0->User1
sees = User0->Photo0 + User1->Photo1 + Influencer0->Ad0
posts = User0->Photo1 + User1->Ad0 + Influencer0->Photo1
suggested = User0->User1 + User1->User1 + User1->Influencer0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
...
pred test47 {
some disj User0: User {some disj Photo0: Photo {some disj Day0, Day1: Day {
no Influencer
no Influencer' --loop state
User = User0
no follows
...
sees = User0->Photo0 + User1->Photo2 + User2->Photo1
posts = User0->Photo2 + User1->Photo1 + User2->Photo0
suggested = User1->User0 + User1->User1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
pred test51 {
some disj Photo0: Photo {some disj Day0, Day1, Day2: Day {
no Influencer
no Influencer' --loop state
no User
no follows
...
pred test53 {
some disj Photo0: Photo {some disj Day0: Day {
no Influencer
no Influencer' --loop state
no User
no follows
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User0 + User1->User1 + Influencer0->User1
sees = User0->Photo0 + User1->Photo2 + Influencer0->Photo1
...
pred test57 {
some disj User2, User1, User0: User {some disj Day0, Day1, Day2: Day {
no Influencer
no Influencer' --loop state
User = User0 + User1 + User2
...
pred test59 {
some disj User1, User0: User {some disj Day0, Day1, Day2: Day {
no Influencer
no Influencer' --loop state
User = User0 + User1
...
posts = User2->Photo0 + User2->Photo1
suggested = User1->User1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User1 + Influencer0->User0 + Influencer0->User1
sees = User0->Photo0 + User0->Ad0 + User1->Photo0 + Influencer0->Photo1
posts = User1->Photo1 + Influencer0->Ad0
...
User = User0 + User1 + Influencer0
follows = User1->User0 + User1->User1 + User1->Influencer0 + Influencer0->User1
sees = User1->Photo0 + User1->Ad0 + Influencer0->Photo0
posts = Influencer0->Ad0
suggested = User0->Influencer0 + User1->User1 + Influencer0->User0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
...
pred test96 {
some disj User0: User {some disj Day0, Day1, Day2: Day {
no Influencer
no Influencer' --loop state
User = User0
follows = User0->User0
...
follows = User1->User0
sees = User1->Ad1
posts = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad0
no suggested
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
sees = User0->Ad0 + Influencer0->Ad0 + Influencer1->Photo0
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = User0->Influencer1 + Influencer0->User0 + Influencer0->Influencer0 + Influencer0->Influencer1
