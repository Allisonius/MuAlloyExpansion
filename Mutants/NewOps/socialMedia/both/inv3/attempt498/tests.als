...
User = User0 + User1 + Influencer0
no follows
sees = User0->Ad0 + User0->Ad2 + User1->Ad0 + User1->Ad1 + Influencer0->Ad0 + Influencer0->Ad2
posts = User0->Ad0 + User0->Ad2 + User1->Ad0 + User1->Ad2 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer0->Ad2
