...
sees = User0->Photo1 + User0->Photo2 + User1->Photo0 + Influencer0->Photo0
...
sees = User0->Photo2
posts = User0->Photo2 + User2->Photo2
...
sees = User0->Photo0 + User0->Photo2 + User1->Photo0 + User1->Photo1 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2
...
sees = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo1 + Influencer0->Photo2
...
posts = User0->Ad1 + Influencer0->Ad2
suggested = User0->Influencer0 + User1->User0 + User1->User1
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
...
posts = User0->Ad1 + Influencer1->Ad2
...
User = User0 + Influencer0 + Influencer1
follows = User0->Influencer1 + Influencer0->User0 + Influencer0->Influencer0
sees = User0->Photo0 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Ad0 + Influencer1->Photo0 + Influencer1->Ad0
posts = User0->Photo1
...
posts = User0->Photo1 + User1->Photo1 + User1->Ad0 + User2->Photo1 + User2->Ad0
