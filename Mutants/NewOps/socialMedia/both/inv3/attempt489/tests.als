...
sees = User0->Ad0 + User1->Photo1 + User1->Ad0 + User2->Photo0 + User2->Ad0
...
sees = User0->Photo2 + Influencer0->Photo1 + Influencer1->Photo0 + Influencer1->Photo2
...
sees = User0->Photo1 + User1->Photo0 + User1->Photo2 + User2->Photo1
posts = User0->Photo2 + User1->Photo0 + User1->Photo1 + User2->Photo2
...
sees = User0->Photo0 + User0->Photo2 + Influencer0->Photo1
...
posts = Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Ad1 + Influencer1->Ad2 + Influencer2->Ad0 + Influencer2->Ad1 + Influencer2->Ad2
suggested = Influencer0->Influencer0 + Influencer1->Influencer0 + Influencer1->Influencer2
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
...
posts = User1->Ad0 + User1->Ad1 + User1->Ad2 + User2->Ad0 + User2->Ad1 + User2->Ad2
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User0 + Influencer0->User0
sees = User0->Photo0 + User0->Photo1 + User0->Ad0 + User1->Photo1 + User1->Ad0 + Influencer0->Photo1 + Influencer0->Ad0
...
sees = User0->Photo2 + User1->Photo1 + User1->Photo2 + Influencer0->Photo2
...
posts = User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User1->Photo2 + Influencer0->Photo0
...
pred test34 {
some disj Influencer0: User {some disj Ad0, Photo1, Photo0: Photo {some disj Day0, Day1: Day {
Influencer = Influencer0
User = Influencer0
no follows
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User0 + Influencer0->User1
sees = User0->Photo1 + User0->Ad0 + User1->Photo1 + User1->Ad0 + Influencer0->Photo0 + Influencer0->Photo1
