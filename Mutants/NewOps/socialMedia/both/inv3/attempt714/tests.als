...
posts = Influencer0->Ad0 + Influencer0->Ad2 + Influencer1->Ad0 + Influencer1->Ad1 + Influencer2->Ad0 + Influencer2->Ad1 + Influencer2->Ad2
...
posts = User0->Ad1 + User1->Ad0 + User1->Ad2 + User2->Ad0
suggested = User0->User1 + User1->User0 + User1->User1
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
...
pred test15 {
some disj Ad0, Ad1: Photo {some disj Day0, Day1, Day2: Day {
no Influencer
no Influencer' --loop state
no User
no follows
...
posts = User0->Photo0 + User1->Photo0 + User1->Ad0 + User1->Ad1 + User2->Ad0 + User2->Ad1
...
posts = User0->Photo0 + User1->Ad0 + User1->Ad1 + User2->Ad0 + User2->Ad1
...
posts = User0->Photo0 + User0->Ad1 + User1->Ad0 + User2->Photo0 + User2->Ad0 + User2->Ad1
