...
sees = User0->Photo0 + User0->Ad0 + User1->Photo0 + User1->Ad0 + Influencer0->Photo0
...
no follows
sees = User0->Photo2 + User1->Photo2 + User2->Photo1
...
User = User0 + User1 + User2
no follows
sees = User0->Photo2 + User1->Photo1 + User2->Photo2
...
User = User0 + Influencer0 + Influencer1
no follows
sees = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo2 + Influencer1->Photo1
...
User = User0 + User1 + Influencer0
no follows
sees = User0->Photo2 + User1->Photo0 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo1
...
User = User0 + Influencer0 + Influencer1
no follows
sees = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo2 + Influencer1->Photo1 + Influencer1->Photo2
...
User = User0 + User1 + Influencer0
no follows
sees = User0->Photo0 + User0->Photo1 + User1->Photo0 + User1->Photo1 + Influencer0->Photo0 + Influencer0->Photo2
...
posts = User0->Photo1 + User1->Photo1 + User1->Photo2 + User2->Photo0 + User2->Photo1
no suggested
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
User = User0 + User1 + User2
no follows
sees = User0->Photo1 + User0->Photo2 + User1->Photo2 + User2->Photo0 + User2->Photo1
...
User = User0 + User1 + Influencer0
no follows
sees = User0->Photo0 + User0->Photo1 + User0->Ad0 + User1->Photo0 + User1->Photo1 + User1->Ad0 + Influencer0->Photo0 + Influencer0->Photo1
...
User = User0 + User1 + User2
no follows
sees = User0->Photo0 + User0->Photo2 + User1->Photo0 + User1->Photo2 + User2->Photo0 + User2->Photo2
posts = User0->Photo1 + User0->Photo2 + User1->Photo0 + User2->Photo0
no suggested
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
User = User0 + User1 + Influencer0
no follows
sees = User0->Photo0 + User0->Photo2 + User1->Photo1 + Influencer0->Photo1
posts = User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + Influencer0->Photo0 + Influencer0->Photo1
suggested = User0->User0 + User0->Influencer0 + User1->User0 + Influencer0->Influencer0
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
User = User0 + User1 + Influencer0
no follows
sees = User0->Photo0 + User0->Photo2 + User1->Photo0 + User1->Photo1 + Influencer0->Photo0 + Influencer0->Photo2
...
posts = User0->Photo0 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1
...
no follows
sees = User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
posts = User0->Photo0 + User0->Photo1 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer1->Photo0 + Influencer1->Photo2
...
posts = User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2
suggested = User0->Influencer0 + User1->User0 + User1->User1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
User = User0 + User1 + Influencer0
no follows
sees = User0->Photo1 + User0->Photo2 + User1->Photo1 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo2
posts = User0->Photo2 + User1->Photo0 + User1->Photo1 + Influencer0->Photo2
no suggested
no Ad
no Ad' --loop state
