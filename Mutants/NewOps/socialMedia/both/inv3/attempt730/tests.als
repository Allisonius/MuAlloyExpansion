...
sees = User0->Photo1 + User1->Photo0 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo2
posts = User0->Photo2 + User1->Photo0 + User1->Photo1 + Influencer0->Photo1
suggested = User0->Influencer0 + User1->User0 + User1->User1
no Ad
no Ad' --loop state
...
sees = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Ad0
...
posts = User0->Ad1 + Influencer0->Ad1 + Influencer1->Ad1 + Influencer1->Ad2
...
sees = User0->Photo1 + User0->Ad0 + User1->Photo1 + Influencer0->Photo0 + Influencer0->Photo1
...
User = User0 + User1 + Influencer0
follows = User1->User0 + User1->Influencer0 + Influencer0->Influencer0
sees = User0->Ad1 + User1->Ad0 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad1
...
sees = Influencer0->Ad0 + Influencer1->Photo1 + Influencer1->Ad0 + Influencer2->Photo0 + Influencer2->Photo1
posts = Influencer0->Photo1 + Influencer0->Ad0 + Influencer2->Ad0
suggested = Influencer0->Influencer1 + Influencer1->Influencer2 + Influencer2->Influencer2
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
Day = Day0 + Day1 + Day2
