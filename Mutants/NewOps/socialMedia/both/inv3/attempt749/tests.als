...
pred test43 {
some disj User0: User {some disj Photo2, Photo1, Photo0: Photo {some disj Day0, Day1: Day {
no Influencer
no Influencer' --loop state
User = User0
follows = User0->User0
...
pred test46 {
some disj Influencer0: User {some disj Day0, Day1, Day2: Day {
Influencer = Influencer0
User = Influencer0
no follows
no sees
...
pred test47 {
some disj Influencer1, Influencer0: User {some disj Day0, Day1, Day2: Day {
Influencer = Influencer0 + Influencer1
User = Influencer0 + Influencer1
...
posts = Influencer0->Photo1 + Influencer1->Photo0 + Influencer1->Photo1
suggested = User0->Influencer1 + Influencer0->User0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
Day = Day0 + Day1 + Day2
...
posts = User0->Photo1 + User1->Photo0 + User1->Photo1 + User2->Photo0 + User2->Photo1 + User2->Ad0
suggested = User0->User2 + User1->User0 + User1->User1
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
User = User0 + User1 + User2
follows = User0->User0 + User0->User1 + User0->User2 + User1->User0 + User1->User1 + User1->User2 + User2->User0 + User2->User1 + User2->User2
sees = User0->Ad1 + User1->Photo0 + User1->Ad1 + User2->Ad0
posts = User0->Ad1 + User1->Ad0 + User2->Photo0
suggested = User1->User0 + User1->User1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
no sees
posts = User0->Ad0 + User0->Ad2 + User2->Ad1
suggested = User1->User0 + User1->User1
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
...
no sees
posts = User0->Ad1 + User1->Ad2 + User2->Ad1
suggested = User1->User0 + User1->User1
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = User0->Influencer1 + Influencer0->Influencer0 + Influencer1->User0 + Influencer1->Influencer0
no sees
posts = User0->Photo1
...
sees = User2->Photo1
posts = User0->Photo1 + User1->Photo0 + User1->Photo2 + User2->Photo1
suggested = User0->User0 + User0->User1 + User1->User2 + User2->User0 + User2->User2
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
date = Photo0->Day2 + Photo1->Day2 + Photo2->Day1
...
posts = Influencer0->Photo1 + Influencer1->Photo1 + Influencer1->Ad0
no suggested
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
no sees
posts = Influencer0->Photo1 + Influencer1->Photo1 + Influencer2->Photo0
suggested = Influencer1->Influencer1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
