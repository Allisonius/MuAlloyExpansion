...
User = User0 + User1 + Influencer0
follows = User1->User0 + User1->User1
sees = User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo2 + Influencer0->Photo0
...
posts = User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo2 + User2->Photo0 + User2->Photo1
suggested = User0->User1 + User1->User0 + User1->User1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
