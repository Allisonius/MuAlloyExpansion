...
pred test8 {
some disj User2, User1, User0: User {some disj Photo1, Photo0: Photo {some disj Day0, Day1: Day {
no Influencer
no Influencer' --loop state
User = User0 + User1 + User2
follows = User2->User2
sees = User0->Photo0 + User1->Photo0 + User1->Photo1 + User2->Photo1
...
pred test9 {
some disj Influencer1, Influencer0: User {some disj Ad0, Photo0: Photo {some disj Day0, Day1, Day2: Day {
Influencer = Influencer0 + Influencer1
...
sees = User0->Photo0 + User0->Photo1 + User1->Photo1 + User2->Photo0 + User2->Ad0
...
User = User0 + Influencer0 + Influencer1
no follows
sees = User0->Photo0 + Influencer0->Photo1 + Influencer1->Photo0
...
sees = User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
suggested = User0->User0 + User0->Influencer1 + Influencer1->User0 + Influencer1->Influencer1
no Ad
no Ad' --loop state
...
no follows
sees = User0->Photo0
posts = User0->Photo0 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer1->Photo0 + Influencer1->Ad0
...
posts = User0->Photo0 + User1->Photo0 + User1->Ad0 + User1->Ad1 + User2->Photo0 + User2->Ad1
suggested = User0->User1 + User1->User0 + User1->User1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
sees = User0->Photo0 + User1->Photo0 + User1->Photo1 + Influencer0->Photo0 + Influencer0->Photo1
posts = User0->Photo0 + User0->Photo1 + User1->Photo0 + User1->Photo1 + Influencer0->Photo0 + Influencer0->Photo1
...
sees = Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Ad0 + Influencer1->Photo0 + Influencer1->Ad0
