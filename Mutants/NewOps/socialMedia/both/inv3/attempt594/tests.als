...
posts = User0->Ad0 + User0->Ad1 + Influencer0->Ad2 + Influencer1->Ad0 + Influencer1->Ad1
...
posts = User0->Ad2 + User1->Ad0 + User1->Ad1 + User1->Ad2 + Influencer0->Ad1
no suggested
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
...
posts = User0->Ad0 + User0->Ad1 + User0->Ad2 + User1->Ad0 + User1->Ad1 + Influencer0->Ad2
suggested = User0->Influencer0 + User1->User0 + User1->User1
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
...
posts = User0->Ad1 + User0->Ad2 + Influencer1->Ad0 + Influencer1->Ad1 + Influencer1->Ad2
suggested = User0->Influencer0 + Influencer0->User0 + Influencer0->Influencer0
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
...
User = User0 + User1 + Influencer0
follows = User0->User1 + User1->User0 + User1->Influencer0
sees = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + Influencer0->Photo0 + Influencer0->Photo1
...
no follows
sees = User0->Photo0 + User0->Photo1 + User0->Ad0 + User1->Photo0 + User1->Photo1 + User2->Photo0 + User2->Photo1 + User2->Ad0
posts = User0->Photo1 + User1->Photo1 + User1->Ad0 + User2->Photo0 + User2->Ad0
...
User = User0 + User1 + User2
no follows
sees = User0->Photo0 + User0->Photo1 + User1->Photo0 + User1->Photo1 + User2->Photo0 + User2->Photo1 + User2->Ad0
...
sees = User0->Photo0 + User1->Photo0 + User1->Ad0 + Influencer0->Photo0 + Influencer0->Ad1
posts = User0->Photo0 + User0->Ad0 + User1->Photo0 + User1->Ad1 + Influencer0->Ad0 + Influencer0->Ad1
suggested = User1->User0 + User1->Influencer0 + Influencer0->Influencer0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
