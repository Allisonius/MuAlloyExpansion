...
sees = User0->Photo0 + User1->Ad0 + Influencer0->Ad0 + Influencer0->Ad1
...
sees = User0->Photo1 + User1->Photo2 + Influencer0->Photo0
...
sees = User0->Photo0 + User0->Photo1 + User1->Photo1 + User2->Photo2
posts = User1->Photo2
no suggested
no Ad
no Ad' --loop state
