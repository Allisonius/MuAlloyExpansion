...
posts = User0->Photo1 + User0->Ad0 + User1->Ad0 + Influencer0->Photo0
...
posts = User0->Photo0 + User0->Ad0 + User1->Ad0 + User1->Ad1 + User2->Ad0 + User2->Ad1
...
posts = User1->Photo1 + User1->Ad0 + Influencer0->Photo0 + Influencer0->Ad0
suggested = User1->User0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
sees = User0->Photo0 + User0->Ad0 + User1->Photo1 + User1->Ad0 + Influencer0->Ad0
posts = User0->Photo0 + User0->Photo1 + User0->Ad0 + User1->Photo1 + User1->Ad0 + Influencer0->Ad0
suggested = User0->User0 + User0->Influencer0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
posts = User0->Ad0 + User0->Ad1 + User0->Ad2 + User1->Ad0 + User1->Ad1
no suggested
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
...
follows = User0->Influencer0 + Influencer0->User0 + Influencer0->Influencer0 + Influencer1->Influencer1
...
posts = Influencer1->Photo1 + Influencer1->Ad0 + Influencer2->Photo0 + Influencer2->Ad0
...
User = User0 + User1 + Influencer0
follows = User0->User1 + User1->User0 + User1->User1 + User1->Influencer0 + Influencer0->User1 + Influencer0->Influencer0
sees = User0->Ad0 + User1->Photo1 + User1->Ad0 + Influencer0->Photo1
