...
follows = User2->User1
no sees
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User2->Photo1 + User2->Photo2
...
posts = User0->Ad0 + User0->Ad1 + User1->Photo0 + Influencer0->Photo0 + Influencer0->Ad0
...
posts = User0->Photo0 + User0->Photo1 + User1->Photo1 + User1->Photo2 + Influencer0->Photo1 + Influencer0->Photo2
no suggested
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
sees = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User1 + Influencer0->User0 + Influencer0->User1
sees = User0->Ad1 + User1->Ad0 + User1->Ad1 + User1->Ad2 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer0->Ad2
...
User = User0 + User1 + Influencer0
follows = User1->User0 + User1->Influencer0 + Influencer0->User0
sees = User0->Photo0 + User0->Ad0 + User1->Photo1 + Influencer0->Photo1 + Influencer0->Ad0
...
User = User0 + User1 + User2
no follows
sees = User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + User1->Ad1 + User2->Photo0
