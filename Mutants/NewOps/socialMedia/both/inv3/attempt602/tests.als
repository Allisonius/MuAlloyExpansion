...
sees = User1->Photo0 + User1->Photo2 + Influencer0->Photo2
...
posts = User0->Ad0 + User0->Ad1 + User1->Ad1 + User1->Ad2 + User2->Ad0
...
pred test21 {
some disj User1, User0: User {some disj Ad0, Ad1: Photo {some disj Day0, Day1, Day2: Day {
no Influencer
no Influencer' --loop state
User = User0 + User1
follows = User1->User1
...
sees = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo1 + User1->Photo2 + User2->Photo0
posts = User1->Photo1 + User1->Photo2 + User2->Photo0 + User2->Photo1
suggested = User0->User1 + User1->User1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
posts = User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + Influencer0->Photo0 + Influencer0->Ad0
suggested = User0->Influencer0 + User1->User1 + Influencer0->User0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
no follows
sees = User0->Photo1 + User0->Ad0 + Influencer0->Ad0 + Influencer1->Photo1 + Influencer1->Ad0
no posts
...
User = User0 + Influencer0 + Influencer1
no follows
sees = User0->Ad0 + User0->Ad1 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Photo0 + Influencer1->Ad0
