...
posts = User0->Photo0 + User1->Photo0 + User1->Photo1 + Influencer0->Photo2
suggested = User0->Influencer0 + Influencer0->User0 + Influencer0->Influencer0
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
posts = User0->Photo0 + User1->Photo0 + User1->Photo1 + User1->Ad0
suggested = User0->User0 + User0->Influencer0 + User1->User0 + Influencer0->Influencer0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
...
posts = User0->Ad0 + User1->Photo1 + User1->Ad0 + User2->Photo1
