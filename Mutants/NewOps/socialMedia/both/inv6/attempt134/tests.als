...
posts = User0->Photo1 + Influencer0->Ad0 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Ad0
...
pred test15 {
some disj Influencer0, User1, User0: User {some disj Day0, Day1: Day {
Influencer = Influencer0
User = User0 + User1 + Influencer0
...
pred test18 {
some disj Influencer2, Influencer1, Influencer0: User {some disj Ad0, Photo1, Photo0: Photo {some disj Day0, Day1: Day {
Influencer = Influencer0 + Influencer1 + Influencer2
User = Influencer0 + Influencer1 + Influencer2
follows = Influencer0->Influencer0 + Influencer0->Influencer1 + Influencer0->Influencer2 + Influencer2->Influencer0
sees = Influencer0->Photo0 + Influencer0->Ad0 + Influencer1->Photo1
posts = Influencer0->Photo1 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Ad0 + Influencer2->Ad0
no suggested
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
...
posts = User0->Photo0 + User1->Ad0 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1
suggested = User0->Influencer0 + User1->User0 + User1->User1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
