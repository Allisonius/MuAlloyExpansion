...
posts = Influencer0->Ad0 + Influencer0->Ad2 + Influencer1->Ad1 + Influencer2->Ad2
no suggested
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
...
posts = User0->Ad0 + User1->Ad2 + Influencer0->Ad0
...
sees = User0->Photo0 + User1->Ad0 + User2->Photo0 + User2->Ad1
posts = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + User1->Ad1 + User2->Photo0 + User2->Ad0 + User2->Ad1
