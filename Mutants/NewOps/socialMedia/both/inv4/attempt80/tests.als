...
follows = User1->User0 + User1->User1
sees = User0->Ad0
posts = User0->Photo0 + User0->Ad0 + User1->Photo0 + Influencer0->Ad1
...
posts = User0->Photo0 + User0->Photo1 + User0->Ad0 + User1->Photo0 + User1->Photo1 + User1->Ad0 + Influencer0->Ad0
suggested = User1->User0 + User1->User1
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
