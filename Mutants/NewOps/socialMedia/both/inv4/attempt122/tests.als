...
posts = User0->Photo0 + User0->Photo1 + User0->Ad0 + User1->Photo1 + User2->Photo0 + User2->Ad0
suggested = User0->User0 + User0->User2 + User2->User0 + User2->User2
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
posts = User0->Photo0 + User0->Ad0 + User1->Photo1 + User1->Ad0 + User2->Photo0 + User2->Ad0
