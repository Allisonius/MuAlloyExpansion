...
sees = User0->Photo0 + User0->Ad1 + User1->Ad0 + User1->Ad1 + User2->Photo0
...
posts = User0->Ad0 + User0->Ad1 + User1->Ad0 + User2->Photo0 + User2->Ad0
no suggested
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
suggested = User0->User0 + User1->User0 + User1->User2
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
Day = Day0 + Day1 + Day2
...
sees = User1->Photo1 + Influencer0->Photo1 + Influencer0->Ad0
