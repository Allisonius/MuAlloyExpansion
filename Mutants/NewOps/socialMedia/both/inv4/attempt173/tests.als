...
pred test20 {
some disj Influencer0, User1, User0: User {some disj Ad0, Ad2, Ad1: Photo {some disj Day0: Day {
Influencer = Influencer0
User = User0 + User1 + Influencer0
follows = User0->User1 + User1->User0 + User1->User1 + User1->Influencer0
...
posts = User0->Photo0 + User0->Photo2 + User1->Photo1 + User1->Photo2 + User2->Photo0 + User2->Photo1
suggested = User0->User2 + User2->User0 + User2->User2
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
posts = User0->Ad1 + User0->Ad2 + User1->Ad1 + User1->Ad2 + Influencer0->Ad0 + Influencer0->Ad1
