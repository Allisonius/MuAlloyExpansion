...
posts = User0->Ad1 + User1->Ad0 + User2->Photo0 + User2->Ad0 + User2->Ad1
...
posts = User0->Ad0 + User1->Photo0 + User1->Ad0 + User1->Ad1 + User2->Ad1
...
posts = User0->Ad0 + User1->Ad1 + User2->Photo0 + User2->Ad1
suggested = User1->User0 + User1->User1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
