...
sees = User0->Ad0
posts = User0->Ad1 + User1->Photo0 + User1->Ad0 + User1->Ad1 + User2->Ad1
...
no sees
posts = User0->Photo0 + User0->Photo1 + User0->Ad0 + User1->Ad0 + User2->Photo0
no suggested
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
...
follows = User1->User1
sees = User0->Photo2
posts = User0->Photo0 + User1->Photo2
no suggested
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
