...
no follows
sees = User1->Ad2 + User2->Ad0 + User2->Ad1 + User2->Ad2
...
posts = User0->Photo0 + User0->Ad1 + User1->Ad0 + User1->Ad1 + User2->Photo0 + User2->Ad1
...
posts = User0->Photo0 + User1->Photo0 + User2->Photo1 + User2->Ad0
