...
posts = User0->Photo0 + User0->Ad0 + User1->Photo0 + User1->Ad0 + Influencer0->Photo1
suggested = User0->Influencer0 + User1->User0 + User1->User1
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
...
sees = User0->Ad0 + User0->Ad1 + Influencer0->Ad2 + Influencer1->Ad0 + Influencer1->Ad1
...
sees = User0->Photo0 + User0->Ad0 + User1->Photo1 + User1->Ad0 + Influencer0->Photo0
posts = User0->Photo0 + User1->Photo1 + Influencer0->Photo0 + Influencer0->Ad0
suggested = User0->User1 + User1->User0 + User1->User1 + User1->Influencer0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day1 + Ad0->Day2
...
User = User0 + User1 + User2
no follows
sees = User0->Ad0 + User1->Photo0 + User1->Ad1 + User2->Photo0 + User2->Ad0 + User2->Ad1
...
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo2
