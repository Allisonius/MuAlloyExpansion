...
posts = User0->Photo0 + User1->Photo1 + Influencer0->Photo0
...
sees = User0->Ad1 + Influencer1->Photo0 + Influencer1->Ad0
...
follows = User2->User1
no sees
posts = User0->Photo0 + User1->Photo0 + User2->Photo1
no suggested
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1
...
follows = User0->User2 + User1->User0 + User1->User1
sees = User1->Photo0
posts = User0->Photo0 + User1->Photo1 + User2->Photo0
