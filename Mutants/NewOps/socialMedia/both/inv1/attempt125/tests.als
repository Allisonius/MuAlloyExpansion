...
User = User0 + User1 + User2
no follows
sees = User0->Photo1 + User1->Photo1 + User1->Ad0 + User2->Photo0 + User2->Photo1
posts = User0->Ad0 + User1->Ad0 + User2->Photo0 + User2->Photo1 + User2->Ad0
suggested = User2->User0 + User2->User2
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
...
User = User0 + User1 + User2
follows = User0->User2 + User1->User1
sees = User0->Photo0 + User2->Photo0 + User2->Photo1 + User2->Ad0
...
User = User0 + User1 + User2
no follows
sees = User1->Photo0 + User2->Photo0 + User2->Ad0 + User2->Ad1
posts = User0->Photo0 + User1->Photo0 + User2->Photo0 + User2->Ad0 + User2->Ad1
suggested = User2->User0 + User2->User2
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
...
posts = User0->Ad0 + User0->Ad1 + User0->Ad2 + User1->Ad0 + User1->Ad2 + User2->Ad1 + User2->Ad2
