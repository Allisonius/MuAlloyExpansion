...
posts = User0->Photo0 + User1->Ad0 + User2->Ad1
...
sees = User1->Ad0 + User1->Ad1 + User2->Photo0
posts = User0->Ad0 + User0->Ad1 + User1->Photo0 + User2->Ad0 + User2->Ad1
...
User = User0 + User1 + User2
no follows
sees = User1->Ad0 + User2->Photo1 + User2->Ad0
...
posts = User0->Photo0 + User0->Photo1 + User1->Photo1 + User1->Ad0 + User2->Photo0 + User2->Photo1
suggested = User0->User2 + User2->User0 + User2->User2
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
...
posts = User0->Photo0 + Influencer0->Photo0 + Influencer1->Ad0
suggested = User0->Influencer1 + Influencer1->User0 + Influencer1->Influencer1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day0 + Ad0->Day0 + Ad1->Day0
...
no follows
no sees
posts = Influencer0->Ad1 + Influencer0->Ad2 + Influencer1->Ad0 + Influencer1->Ad2
