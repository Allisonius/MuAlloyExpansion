...
posts = User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer1->Photo0 + Influencer1->Photo2
suggested = User0->Influencer0 + Influencer0->User0 + Influencer0->Influencer0
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
sees = User0->Photo2 + User2->Photo1
no posts
...
pred test50 {
some disj Influencer0, User0: User {some disj Day0: Day {
Influencer = Influencer0
User = User0 + Influencer0
