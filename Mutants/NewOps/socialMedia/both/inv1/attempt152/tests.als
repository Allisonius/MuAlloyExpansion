...
posts = User0->Photo1 + User0->Photo2 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2
suggested = User0->User1 + User1->User1 + User1->Influencer0 + Influencer0->User0
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
pred test20 {
some disj Influencer0: User {some disj Ad0, Photo0: Photo {some disj Day0, Day1, Day2: Day {
Influencer = Influencer0
User = Influencer0
follows = Influencer0->Influencer0
no sees
...
User = User0 + User1 + User2
no follows
sees = User0->Photo1 + User1->Photo1 + User1->Ad0 + User2->Photo0 + User2->Ad0
posts = User0->Photo0 + User0->Photo1 + User0->Ad0 + User1->Photo0 + User1->Photo1 + User1->Ad0 + User2->Photo0 + User2->Photo1 + User2->Ad0
