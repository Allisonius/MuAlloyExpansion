...
no follows
sees = User0->Ad1 + User0->Ad2 + User1->Ad1 + User2->Ad0 + User2->Ad1 + User2->Ad2
...
sees = User0->Photo0 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo2
...
no follows
sees = Influencer0->Ad0 + Influencer0->Ad2 + Influencer1->Ad0 + Influencer1->Ad1
...
sees = User0->Ad0 + User0->Ad2 + User1->Ad0 + User1->Ad1 + User2->Ad0
posts = User0->Ad2 + User1->Ad0 + User1->Ad1 + User2->Ad0 + User2->Ad2
...
User = User0 + Influencer0 + Influencer1
no follows
sees = User0->Ad0 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Ad0 + Influencer1->Ad2
