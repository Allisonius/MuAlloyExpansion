...
sees = User0->Photo1 + User1->Photo1 + Influencer0->Photo1 + Influencer0->Ad0
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User1 + Influencer0->User0 + Influencer0->User1
sees = User0->Photo2 + User1->Photo0 + User1->Photo1 + Influencer0->Photo0 + Influencer0->Photo2
...
suggested = Influencer0->Influencer1 + Influencer1->Influencer0 + Influencer1->Influencer1 + Influencer2->Influencer0
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
Day = Day0 + Day1 + Day2
