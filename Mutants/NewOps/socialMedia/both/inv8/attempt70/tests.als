...
sees = User0->Ad0 + Influencer0->Photo1 + Influencer0->Ad0 + Influencer1->Photo0 + Influencer1->Ad0
posts = Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Ad0
...
sees = User0->Ad0 + Influencer0->Ad0 + Influencer1->Photo0 + Influencer1->Photo1
...
sees = User0->Ad0 + User1->Ad0 + User2->Photo0 + User2->Photo1 + User2->Ad0
posts = User2->Photo1
suggested = User0->User0 + User0->User1 + User0->User2 + User1->User2 + User2->User0 + User2->User1 + User2->User2
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
Day = Day0 + Day1 + Day2
...
posts = User1->Photo1 + User2->Photo0 + User2->Ad0
suggested = User0->User0 + User0->User2 + User1->User0 + User1->User1 + User1->User2 + User2->User1
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
Day = Day0 + Day1 + Day2
...
follows = Influencer0->Influencer0 + Influencer0->Influencer1 + Influencer1->Influencer0 + Influencer1->Influencer1 + Influencer2->Influencer1 + Influencer2->Influencer2
sees = Influencer0->Ad0 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Ad0 + Influencer2->Ad0
posts = Influencer1->Photo1
suggested = Influencer0->Influencer0 + Influencer0->Influencer1 + Influencer0->Influencer2 + Influencer1->Influencer0 + Influencer1->Influencer1 + Influencer1->Influencer2 + Influencer2->Influencer0 + Influencer2->Influencer2
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
Day = Day0 + Day1 + Day2
...
sees = User0->Ad0 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Ad0 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Ad0
posts = User0->Photo1
suggested = User0->Influencer1 + Influencer0->User0 + Influencer0->Influencer0 + Influencer1->User0 + Influencer1->Influencer0 + Influencer1->Influencer1
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
Day = Day0 + Day1 + Day2
