...
sees = User0->Photo0 + User0->Photo1 + User0->Ad0 + User1->Photo1 + User2->Photo1
...
sees = User0->Photo0 + User1->Photo1 + Influencer0->Photo1 + Influencer0->Ad0
...
posts = User0->Ad2 + User1->Ad0 + User1->Ad1 + User1->Ad2 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer0->Ad2
...
sees = Influencer0->Ad0 + Influencer0->Ad1 + Influencer0->Ad2 + Influencer1->Ad1 + Influencer1->Ad2
posts = User0->Ad0 + User0->Ad1 + User0->Ad2 + Influencer0->Ad1 + Influencer1->Ad0 + Influencer1->Ad2
