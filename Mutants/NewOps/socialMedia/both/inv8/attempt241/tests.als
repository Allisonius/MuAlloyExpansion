...
pred test19 {
some disj Influencer0: User {some disj Ad0, Ad1: Photo {some disj Day0, Day1: Day {
Influencer = Influencer0
User = Influencer0
no follows
...
sees = User0->Ad1 + Influencer0->Ad1 + Influencer1->Photo0
...
posts = User0->Ad0 + User0->Ad2 + User1->Ad0 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer0->Ad2
suggested = User0->User0 + User0->User1 + User1->User1 + Influencer0->User0 + Influencer0->User1 + Influencer0->Influencer0
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
Day = Day0 + Day1 + Day2
