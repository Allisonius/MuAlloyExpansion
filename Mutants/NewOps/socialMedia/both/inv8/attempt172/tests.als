...
no follows
sees = User0->Photo1 + User0->Ad0 + User2->Photo0 + User2->Photo1 + User2->Ad0
...
posts = User0->Ad0 + Influencer0->Photo1 + Influencer0->Ad0 + Influencer1->Photo0
suggested = User0->User0 + User0->Influencer0 + Influencer0->User0 + Influencer0->Influencer0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
posts = User0->Photo1 + User0->Ad0 + Influencer0->Ad0 + Influencer1->Photo0 + Influencer1->Photo1
suggested = User0->User0 + User0->Influencer0 + Influencer0->User0 + Influencer0->Influencer0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
sees = User0->Photo1 + User0->Ad0 + Influencer0->Photo1 + Influencer0->Ad0 + Influencer1->Photo0
posts = User0->Photo1 + User0->Ad0 + Influencer0->Photo1 + Influencer0->Ad0 + Influencer1->Photo0
suggested = User0->User0 + User0->Influencer0 + Influencer0->User0 + Influencer0->Influencer0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
sees = User0->Ad0 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer1->Ad0
