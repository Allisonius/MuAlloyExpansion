...
sees = User0->Photo0 + User0->Photo1 + Influencer1->Photo0
posts = User0->Photo0 + User0->Photo1 + Influencer0->Photo1 + Influencer1->Photo0 + Influencer1->Photo1
...
sees = User0->Ad0 + User0->Ad1 + User0->Ad2 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Ad1 + Influencer1->Ad2
...
no follows
sees = User0->Photo0 + User0->Photo1 + User0->Ad0 + User2->Ad0
...
User = User0 + User1 + User2
follows = User2->User2
sees = User0->Ad0 + User1->Photo0 + User2->Photo1 + User2->Ad0
...
sees = User0->Photo0 + User0->Ad0 + Influencer0->Photo1 + Influencer1->Photo0 + Influencer1->Ad0
posts = User0->Photo1 + User0->Ad0 + Influencer0->Photo1 + Influencer1->Photo1 + Influencer1->Ad0
suggested = User0->Influencer1 + Influencer1->User0 + Influencer1->Influencer1
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
