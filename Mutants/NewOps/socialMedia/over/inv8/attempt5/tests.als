...
User = User0 + User1 + Influencer0
follows = User0->User1 + User1->User0 + User1->User1 + User1->Influencer0
sees = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo1 + Influencer0->Photo0 + Influencer0->Photo1
...
User = User0 + User1 + Influencer0
follows = User0->User1 + User1->User0 + User1->User1 + User1->Influencer0
sees = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo1 + Influencer0->Photo1
posts = User0->Photo1 + Influencer0->Photo0
suggested = User0->Influencer0 + User1->User0 + User1->User1
no Ad
no Ad' --loop state
