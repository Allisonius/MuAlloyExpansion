...
pred test14 {
some disj User0: User {some disj Ad0, Photo0: Photo {some disj Day0, Day1: Day {
no Influencer
no Influencer' --loop state
User = User0
no follows
...
suggested = User0->User0 + User0->User1 + User1->User2 + User2->User0 + User2->User1 + User2->User2
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
date = Photo0->Day2 + Photo1->Day2 + Photo2->Day1
...
suggested = User0->User0 + User0->User1 + User0->Influencer0 + User1->User0 + User1->User1 + User1->Influencer0 + Influencer0->User1
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
...
suggested = User0->User1 + User0->User2 + User2->User0 + User2->User1 + User2->User2
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
...
sees = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + User1->Ad1 + User2->Photo0 + User2->Ad0 + User2->Ad1
posts = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + User1->Ad1 + User2->Photo0 + User2->Ad0 + User2->Ad1
suggested = User0->User0 + User0->User1 + User1->User1 + User2->User0 + User2->User1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
