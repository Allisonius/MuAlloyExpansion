...
sees = User0->Photo0 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User1->Photo2 + Influencer0->Photo2
...
sees = User0->Ad1 + User0->Ad2 + User1->Ad1 + User1->Ad2 + Influencer0->Ad1 + Influencer0->Ad2
posts = User0->Ad1 + User0->Ad2 + User1->Ad1 + User1->Ad2 + Influencer0->Ad1 + Influencer0->Ad2
suggested = User0->User0 + User0->User1 + User0->Influencer0 + User1->User0 + User1->User1 + Influencer0->User0 + Influencer0->User1
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
Day = Day0 + Day1 + Day2
...
posts = User0->Ad0 + User0->Ad1 + Influencer1->Photo0 + Influencer1->Ad1
...
sees = User1->Ad0 + User1->Ad1 + User1->Ad2 + Influencer0->Ad1 + Influencer0->Ad2
posts = User0->Ad0 + User1->Ad1 + User1->Ad2 + Influencer0->Ad1 + Influencer0->Ad2
...
follows = User1->User0
sees = User1->Photo0 + User1->Ad1
posts = User0->Ad1 + User1->Photo0 + Influencer0->Photo0 + Influencer0->Ad1
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User1 + Influencer0->User0 + Influencer0->User1
sees = User1->Ad0 + User1->Ad2 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer0->Ad2
...
sees = User1->Photo0 + User1->Ad1
posts = User1->Photo0 + User1->Ad1
suggested = User0->Influencer0 + User1->User0 + User1->User1 + Influencer0->User0 + Influencer0->Influencer0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
...
sees = User1->Ad0 + User1->Ad2 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer0->Ad2
posts = User0->Ad1 + User1->Ad0 + User1->Ad2
suggested = User1->User1 + User1->Influencer0 + Influencer0->Influencer0
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
Day = Day0 + Day1 + Day2
...
sees = User1->Ad0 + User1->Ad2 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer0->Ad2
posts = User0->Ad1 + User1->Ad0 + User1->Ad2
suggested = User0->Influencer0 + User1->User1 + Influencer0->Influencer0
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
Day = Day0 + Day1 + Day2
...
posts = User0->Ad0 + User0->Ad1 + User0->Ad2 + User1->Ad0 + Influencer0->Ad1
...
follows = Influencer0->Influencer2
sees = Influencer0->Ad0 + Influencer0->Ad1 + Influencer0->Ad2 + Influencer1->Ad1 + Influencer1->Ad2 + Influencer2->Ad0 + Influencer2->Ad1
posts = Influencer0->Ad1 + Influencer0->Ad2 + Influencer1->Ad2 + Influencer2->Ad0 + Influencer2->Ad1
suggested = Influencer0->Influencer0 + Influencer0->Influencer1 + Influencer1->Influencer0 + Influencer2->Influencer2
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
Day = Day0 + Day1 + Day2
...
sees = User0->Photo0 + User0->Ad1 + User1->Ad1 + Influencer0->Ad0 + Influencer0->Ad1
...
sees = User0->Ad0 + Influencer0->Ad1 + Influencer0->Ad2 + Influencer1->Ad1 + Influencer1->Ad2
posts = User0->Ad1 + User0->Ad2 + Influencer0->Ad0 + Influencer1->Ad0 + Influencer1->Ad1 + Influencer1->Ad2
...
Influencer = Influencer0 + Influencer1 + Influencer2
User = Influencer0 + Influencer1 + Influencer2
follows = Influencer2->Influencer0
sees = Influencer0->Ad1 + Influencer0->Ad2 + Influencer2->Ad2
posts = Influencer0->Ad2 + Influencer1->Ad1 + Influencer1->Ad2 + Influencer2->Ad2
