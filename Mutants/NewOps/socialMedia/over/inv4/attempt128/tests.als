...
posts = User0->Ad0 + User0->Ad1 + User0->Ad2 + User1->Ad1
...
posts = User0->Photo0 + User0->Ad0 + User1->Ad1 + User2->Ad1
no suggested
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
sees = User0->Ad0
posts = User0->Photo0 + User1->Ad1 + Influencer0->Ad1
suggested = User1->User0 + User1->User1 + User1->Influencer0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
User = User0 + User1 + User2
follows = User0->User2 + User1->User0 + User1->User1
sees = User0->Photo0 + User2->Photo2
...
sees = User1->Photo2 + User2->Photo0
posts = User0->Photo2 + User1->Photo1 + User1->Photo2 + User2->Photo1
...
posts = User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer1->Photo2
...
posts = User0->Photo1 + User0->Photo2 + Influencer1->Photo0 + Influencer1->Photo2
no suggested
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
no sees
posts = User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2
suggested = User1->User0 + User1->User1 + User1->Influencer0
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
