...
sees = User0->Ad0 + User0->Ad2 + User1->Ad1 + Influencer0->Ad2
...
posts = User0->Photo0 + User0->Ad0 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad1
...
pred test23 {
some disj Influencer0, User0: User {some disj Ad0, Photo0, Ad1: Photo {some disj Day0, Day1: Day {
Influencer = Influencer0
...
pred test27 {
some disj Influencer0: User {some disj Ad0, Photo0, Ad1: Photo {some disj Day0, Day1: Day {
Influencer = Influencer0
User = Influencer0
no follows
no sees
...
User = User0 + User1 + Influencer0
follows = User0->User1 + User0->Influencer0 + User1->User1 + Influencer0->User0
sees = User0->Photo0 + User0->Photo2 + User1->Photo1
posts = User0->Photo1 + User1->Photo0 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo2
suggested = User0->User1 + User1->User1
no Ad
no Ad' --loop state
...
sees = User0->Photo1 + Influencer0->Photo2 + Influencer1->Photo1
posts = User0->Photo1 + Influencer0->Photo1 + Influencer1->Photo0 + Influencer1->Photo2
suggested = Influencer0->Influencer0
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
posts = User0->Photo2 + Influencer0->Photo1 + Influencer1->Photo0 + Influencer1->Photo2
suggested = Influencer0->Influencer0
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
sees = User0->Ad1 + User1->Ad1 + User2->Photo0 + User2->Ad1
...
posts = User0->Photo1 + Influencer0->Photo0 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = User0->Influencer0 + User0->Influencer1 + Influencer1->Influencer0 + Influencer1->Influencer1
sees = Influencer0->Photo2
posts = User0->Photo1 + User0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
suggested = User0->Influencer0 + Influencer0->Influencer0
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
pred test63 {
some disj Influencer2, Influencer1, Influencer0: User {
