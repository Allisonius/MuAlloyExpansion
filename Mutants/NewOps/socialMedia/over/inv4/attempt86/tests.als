...
pred test6 {
some disj Influencer2, Influencer1, Influencer0: User {some disj Ad0: Photo {some disj Day0, Day1: Day {
...
posts = Influencer0->Ad0 + Influencer2->Ad0
...
pred test21 {
some disj User2, User1, User0: User {some disj Ad0, Ad1: Photo {some disj Day0: Day {
no Influencer
no Influencer' --loop state
User = User0 + User1 + User2
follows = User0->User2 + User1->User1
