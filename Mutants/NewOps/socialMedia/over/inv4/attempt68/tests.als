...
posts = User0->Ad2 + Influencer0->Ad0 + Influencer1->Ad1
...
posts = User0->Ad2 + User1->Ad0 + User2->Ad2
suggested = User2->User0 + User2->User2
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
...
posts = User0->Photo0 + User1->Photo1 + Influencer0->Ad0
suggested = User0->User0 + User0->Influencer0 + Influencer0->User0 + Influencer0->Influencer0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
...
User = User0 + User1 + Influencer0
no follows
sees = User1->Photo0 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1
...
posts = User0->Ad0 + Influencer0->Ad0 + Influencer1->Ad2
...
posts = User0->Ad0 + User1->Ad2 + Influencer0->Ad1
