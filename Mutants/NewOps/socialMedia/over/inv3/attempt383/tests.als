...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User0 + User1->User1 + Influencer0->User1
sees = User0->Photo2 + User1->Photo1 + Influencer0->Photo1 + Influencer0->Photo2
...
pred test21 {
some disj Influencer0, User0: User {some disj Ad0, Ad1: Photo {some disj Day0, Day1, Day2: Day {
Influencer = Influencer0
User = User0 + Influencer0
follows = User0->User0 + Influencer0->Influencer0
sees = User0->Ad0 + User0->Ad1 + Influencer0->Ad0 + Influencer0->Ad1
...
posts = User0->Photo0 + User0->Photo1 + User1->Photo1 + User1->Photo2 + Influencer0->Photo2
...
posts = User0->Photo1 + User1->Photo0 + User1->Ad0 + User2->Photo0 + User2->Photo1
