...
sees = User0->Ad0 + User1->Ad0 + User2->Photo0 + User2->Photo1
...
posts = User0->Photo0 + User0->Ad1 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer1->Photo0
...
posts = User0->Photo0 + User0->Photo1 + User1->Photo0 + User2->Photo0 + User2->Photo1 + User2->Ad0
...
sees = User1->Photo0 + User1->Ad0 + User1->Ad1
posts = User0->Ad0 + User1->Ad1 + User2->Ad0 + User2->Ad1
