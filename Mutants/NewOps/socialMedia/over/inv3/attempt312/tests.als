...
posts = User0->Photo0 + User0->Photo1 + User1->Ad0 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Ad0
...
posts = User0->Photo1 + User0->Ad0 + User1->Photo0 + User1->Ad0 + Influencer0->Photo0 + Influencer0->Photo1
no suggested
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
sees = Influencer0->Photo0 + Influencer1->Photo0 + Influencer1->Photo1
posts = Influencer0->Photo2 + Influencer1->Photo1 + Influencer2->Photo0
no suggested
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
posts = User0->Photo0 + User0->Photo1 + User1->Photo1 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo1
suggested = User1->User0 + User1->User1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
sees = Influencer0->Photo1 + Influencer0->Ad0 + Influencer1->Ad0
