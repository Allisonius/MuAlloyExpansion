...
posts = User0->Photo0 + User0->Ad0 + User2->Photo0
no suggested
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
posts = User0->Photo0 + User0->Ad1 + User1->Ad0 + Influencer0->Photo0 + Influencer0->Ad0
...
sees = User0->Ad0
posts = User0->Ad1 + User0->Ad2 + User1->Ad0 + User1->Ad1 + Influencer0->Ad0
...
posts = User0->Photo0 + User0->Ad1 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Photo0 + Influencer1->Ad0
...
sees = Influencer0->Photo0 + Influencer1->Photo0 + Influencer1->Ad0 + Influencer1->Ad1
...
sees = User1->Ad0 + User1->Ad2 + Influencer0->Ad0 + Influencer0->Ad2
...
sees = User0->Ad0 + User1->Ad1 + Influencer0->Ad0 + Influencer0->Ad1
...
sees = User0->Ad2 + User1->Ad1 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer0->Ad2
posts = User1->Ad0 + User1->Ad1 + User1->Ad2
no suggested
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
