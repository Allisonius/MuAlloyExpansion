...
sees = User0->Ad0 + User0->Ad1 + User0->Ad2 + User1->Ad0 + User1->Ad1 + User1->Ad2 + User2->Ad0 + User2->Ad1 + User2->Ad2
posts = User1->Ad1
suggested = User0->User0 + User1->User2 + User2->User0 + User2->User2
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
Day = Day0 + Day1 + Day2
...
sees = User0->Ad0 + User0->Ad1 + User0->Ad2 + User1->Ad0 + User1->Ad1 + User1->Ad2 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer0->Ad2
posts = User0->Ad1 + User0->Ad2 + User1->Ad0 + User1->Ad2 + Influencer0->Ad0 + Influencer0->Ad1
...
pred test28 {
some disj Influencer1, Influencer0: User {some disj Ad0: Photo {some disj Day0, Day1, Day2: Day {
...
sees = User0->Ad0 + User0->Ad1 + User0->Ad2 + User1->Ad0 + User1->Ad1 + User1->Ad2 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer0->Ad2
posts = User0->Ad0 + User0->Ad1 + User1->Ad0 + User1->Ad2 + Influencer0->Ad1 + Influencer0->Ad2
suggested = User0->User1 + User1->User1 + User1->Influencer0
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
...
follows = User1->User0 + User1->Influencer0
sees = User0->Ad0 + User0->Ad1 + User0->Ad2 + User1->Ad0 + User1->Ad1 + User1->Ad2 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer0->Ad2
posts = User0->Ad1 + User1->Ad0 + User1->Ad2 + Influencer0->Ad1 + Influencer0->Ad2
suggested = User0->User1 + User1->User1 + User1->Influencer0
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
...
sees = User0->Ad0 + User0->Ad1 + User0->Ad2 + User1->Ad0 + User1->Ad1 + User1->Ad2 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer0->Ad2
posts = User1->Ad1
suggested = User0->User1 + User1->User1 + User1->Influencer0 + Influencer0->User0 + Influencer0->User1 + Influencer0->Influencer0
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
Day = Day0 + Day1 + Day2
...
User = User0 + User1 + Influencer0
follows = User0->User1 + User1->User0 + User1->User1 + User1->Influencer0 + Influencer0->User1 + Influencer0->Influencer0
sees = User1->Ad1 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer0->Ad2
...
sees = User0->Ad1 + User1->Ad1 + Influencer0->Ad0
...
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day1 + Ad1->Day0 + Ad2->Day1
Day = Day0 + Day1
inv3[]
}}}
}
...
sees = User0->Ad1 + User0->Ad2 + Influencer0->Ad2
posts = User0->Ad1 + User1->Ad0
no suggested
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
...
posts = User0->Photo0 + User0->Photo1 + User1->Photo1 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2
no suggested
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = User0->Influencer1 + Influencer0->User0 + Influencer0->Influencer1 + Influencer1->Influencer0 + Influencer1->Influencer1
sees = User0->Ad0 + User0->Ad1 + User0->Ad2 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer0->Ad2 + Influencer1->Ad0 + Influencer1->Ad1 + Influencer1->Ad2
