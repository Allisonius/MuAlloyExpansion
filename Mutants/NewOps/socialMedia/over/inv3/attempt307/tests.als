...
sees = User0->Photo0 + User0->Ad0 + Influencer1->Photo0 + Influencer1->Ad0 + Influencer1->Ad1
posts = User0->Photo0 + User0->Ad1 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer1->Ad1
...
posts = User0->Photo0 + User1->Ad0 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1
...
posts = User0->Ad0 + User1->Photo0 + User1->Ad0 + User1->Ad1 + User2->Photo0 + User2->Ad0 + User2->Ad1
...
pred test11 {
some disj Ad0, Photo0: Photo {some disj Day0, Day1: Day {
no Influencer
no Influencer' --loop state
no User
no follows
...
Influencer = Influencer0
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User0 + Influencer0->User0
...
posts = User0->Ad1 + User1->Photo0 + User1->Ad0 + Influencer0->Photo0
suggested = User0->User1 + User1->User0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = User0->Influencer1 + Influencer0->Influencer1 + Influencer1->User0 + Influencer1->Influencer0
sees = User0->Photo0 + User0->Photo1 + User0->Ad0 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Ad0 + Influencer1->Photo0 + Influencer1->Ad0
...
sees = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1
posts = User0->Photo0 + User0->Ad0 + User1->Photo0 + User1->Ad0 + User1->Ad1 + Influencer0->Ad0 + Influencer0->Ad1
...
pred test20 {
some disj User1, User0: User {some disj Day0: Day {
no Influencer
no Influencer' --loop state
User = User0 + User1
no follows
...
pred test21 {
some disj Influencer0: User {some disj Day0: Day {
Influencer = Influencer0
User = Influencer0
no follows
no sees
...
pred test22 {
some disj User0: User {some disj Day0, Day1: Day {
no Influencer
no Influencer' --loop state
User = User0
no follows
...
sees = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1
posts = User0->Ad1 + User1->Photo0 + User1->Ad0 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad0
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->Influencer0 + Influencer0->User0 + Influencer0->User1
sees = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Ad1
posts = User0->Ad1 + User1->Photo0 + User1->Ad1 + Influencer0->Ad1
suggested = User0->Influencer0 + User1->User1 + Influencer0->User0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
posts = User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad1 + User2->Photo0 + User2->Ad0 + User2->Ad1
no suggested
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
no Influencer' --loop state
User = User0 + User1 + User2
follows = User0->User2 + User1->User0 + User2->User0
...
no Influencer' --loop state
User = User0 + User1 + User2
follows = User0->User2 + User1->User2 + User2->User1
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = User0->Influencer0 + User0->Influencer1 + Influencer0->Influencer1 + Influencer1->Influencer0
...
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1
...
sees = Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Photo0 + Influencer1->Ad0 + Influencer1->Ad1
...
pred test38 {
some disj Influencer2, Influencer1, Influencer0: User {some disj Photo1, Photo0: Photo {some disj Day0, Day1, Day2: Day {
Influencer = Influencer0 + Influencer1 + Influencer2
User = Influencer0 + Influencer1 + Influencer2
follows = Influencer0->Influencer1 + Influencer1->Influencer0 + Influencer1->Influencer2 + Influencer2->Influencer0 + Influencer2->Influencer1
sees = Influencer0->Photo0 + Influencer0->Photo1 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer2->Photo0 + Influencer2->Photo1
posts = Influencer0->Photo1 + Influencer2->Photo0 + Influencer2->Photo1
no suggested
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1
...
pred test39 {
some disj Influencer1, Influencer0: User {some disj Ad0, Ad1: Photo {some disj Day0, Day1, Day2: Day {
Influencer = Influencer0 + Influencer1
User = Influencer0 + Influencer1
follows = Influencer0->Influencer1 + Influencer1->Influencer0
...
follows = Influencer0->Influencer1 + Influencer1->Influencer0
sees = Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Ad0 + Influencer1->Ad1
posts = Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Ad1
no suggested
Ad = Ad0 + Ad1
Photo = Ad0 + Ad1
date = Ad0->Day2 + Ad1->Day1
...
Influencer = Influencer0 + Influencer1 + Influencer2
User = Influencer0 + Influencer1 + Influencer2
follows = Influencer0->Influencer1 + Influencer0->Influencer2 + Influencer1->Influencer2 + Influencer2->Influencer1
sees = Influencer0->Photo0 + Influencer0->Photo1 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer2->Photo0 + Influencer2->Photo1
posts = Influencer0->Photo1 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer2->Photo0 + Influencer2->Photo1
suggested = Influencer0->Influencer2
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1
date = Photo0->Day2 + Photo1->Day1
...
sees = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + User1->Ad1 + User2->Photo0 + User2->Ad0 + User2->Ad1
posts = User0->Photo0 + User0->Ad0 + User0->Ad1 + User2->Photo0 + User2->Ad0 + User2->Ad1
suggested = User0->User2 + User2->User0 + User2->User2
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
posts = User0->Photo0 + User0->Ad0 + User0->Ad1 + Influencer1->Photo0 + Influencer1->Ad0 + Influencer1->Ad1
...
pred test50 {
some disj Influencer1, Influencer0: User {some disj Photo1, Photo0: Photo {some disj Day0, Day1, Day2: Day {
Influencer = Influencer0 + Influencer1
User = Influencer0 + Influencer1
follows = Influencer0->Influencer1 + Influencer1->Influencer0
sees = Influencer0->Photo0 + Influencer0->Photo1
...
Influencer = Influencer0
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User0 + Influencer0->User0 + Influencer0->User1
sees = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1
posts = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Ad0 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1
suggested = User0->Influencer0 + User1->User0 + User1->User1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
