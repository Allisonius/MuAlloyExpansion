...
pred test10 {
some disj User1, User0: User {some disj Ad0, Ad2, Ad1: Photo {some disj Day0, Day1: Day {
no Influencer
no Influencer' --loop state
User = User0 + User1
...
pred test29 {
some disj Influencer1, Influencer0: User {some disj Photo2, Photo1, Photo0: Photo {some disj Day0, Day1: Day {
Influencer = Influencer0 + Influencer1
User = Influencer0 + Influencer1
follows = Influencer0->Influencer0 + Influencer0->Influencer1 + Influencer1->Influencer0 + Influencer1->Influencer1
sees = Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0
no posts
suggested = Influencer0->Influencer0
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
date = Photo0->Day1 + Photo1->Day1 + Photo2->Day1
Day = Day0 + Day1
inv3[]
}}}
}
...
sees = User0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1
