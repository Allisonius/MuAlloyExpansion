...
sees = User1->Photo0 + User1->Photo1 + User1->Photo2 + Influencer0->Photo2
...
posts = User0->Photo1 + User0->Photo2 + User1->Photo1 + Influencer0->Photo2
...
sees = User0->Photo1 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1
posts = User0->Photo0 + User0->Photo1 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1
...
pred test55 {
some disj User1, User0: User {some disj Ad0: Photo {some disj Day0: Day {
no Influencer
no Influencer' --loop state
User = User0 + User1
no follows
