...
sees = User0->Photo0
posts = User0->Photo0 + User1->Photo0 + User1->Ad0 + Influencer0->Ad1
suggested = User0->Influencer0 + User1->User0 + User1->User1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
sees = User0->Photo0 + User0->Photo2 + User1->Photo0 + User1->Photo1 + Influencer0->Photo2
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User1 + User1->Influencer0 + Influencer0->User0
sees = User0->Photo0 + User0->Photo1 + User1->Photo1 + User1->Photo2
...
posts = Influencer1->Ad0 + Influencer2->Photo0 + Influencer2->Photo1
...
posts = User0->Photo1 + User1->Ad0 + User2->Photo0 + User2->Ad0
...
posts = User0->Photo1 + User0->Ad0 + User1->Ad0 + User2->Photo0 + User2->Photo1 + User2->Ad0
