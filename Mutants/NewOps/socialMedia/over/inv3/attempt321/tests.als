...
sees = User0->Ad1 + User1->Photo0 + User2->Ad1
posts = User0->Photo0 + User1->Photo0 + User1->Ad0 + User2->Photo0
suggested = User1->User0 + User1->User2 + User2->User2
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
...
posts = Influencer0->Photo0 + Influencer0->Photo1 + Influencer1->Photo1 + Influencer1->Ad0
...
follows = Influencer1->Influencer0 + Influencer1->Influencer2 + Influencer2->Influencer0 + Influencer2->Influencer1 + Influencer2->Influencer2
...
sees = User1->Ad0 + Influencer0->Photo0 + Influencer0->Ad1
posts = User0->Photo0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + Influencer0->Photo0 + Influencer0->Ad0
...
sees = User0->Photo2 + User1->Photo0 + User1->Photo2 + User2->Photo1
