...
sees = User0->Photo2
posts = User1->Photo0 + User1->Photo1 + User1->Photo2 + Influencer0->Photo1 + Influencer0->Photo2
suggested = User0->User1 + User1->User0 + User1->User1 + User1->Influencer0
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
Influencer = Influencer0
User = User0 + User1 + Influencer0
follows = User1->User0 + Influencer0->User0 + Influencer0->User1 + Influencer0->Influencer0
sees = Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2
...
follows = User0->Influencer1 + Influencer0->User0 + Influencer0->Influencer0 + Influencer0->Influencer1 + Influencer1->User0 + Influencer1->Influencer0 + Influencer1->Influencer1
sees = Influencer0->Photo0 + Influencer0->Photo2
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = Influencer0->User0 + Influencer1->User0 + Influencer1->Influencer0 + Influencer1->Influencer1
...
sees = User0->Photo1 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
...
sees = User1->Photo0
posts = User0->Photo0 + User0->Photo2 + User1->Photo0 + User1->Photo1
...
sees = User0->Photo1 + User1->Photo0 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo1
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2
suggested = User0->Influencer0 + User1->User0 + User1->User1
no Ad
no Ad' --loop state
...
sees = User0->Photo0 + User1->Photo0 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2
...
sees = User0->Photo1 + User0->Photo2 + Influencer1->Photo1 + Influencer1->Photo2
...
follows = User2->User0 + User2->User1 + User2->User2
sees = User2->Photo2
posts = User0->Photo2 + User1->Photo1 + User1->Photo2 + User2->Photo2
suggested = User2->User0 + User2->User1 + User2->User2
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
pred test56 {
some disj Ad0, Ad2, Ad1: Photo {some disj Day0, Day1: Day {
no Influencer
no Influencer' --loop state
no User
no follows
...
sees = Influencer2->Photo0 + Influencer2->Photo1
posts = Influencer0->Photo0 + Influencer0->Photo1 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2 + Influencer2->Photo0 + Influencer2->Photo1
suggested = Influencer1->Influencer1 + Influencer1->Influencer2
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
date = Photo0->Day2 + Photo1->Day2 + Photo2->Day1
