...
pred test11 {
some disj Influencer1, Influencer0: User {some disj Ad0, Photo0: Photo {some disj Day0, Day1: Day {
...
follows = Influencer0->Influencer2 + Influencer1->Influencer0 + Influencer2->Influencer0 + Influencer2->Influencer1 + Influencer2->Influencer2
sees = Influencer1->Photo0
posts = Influencer0->Photo0 + Influencer1->Ad0 + Influencer2->Photo0 + Influencer2->Ad0
no suggested
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
sees = User0->Photo0 + User1->Ad1 + User2->Photo0
...
sees = User0->Photo1 + Influencer0->Ad0 + Influencer1->Photo0 + Influencer1->Photo1
...
posts = User0->Photo0 + User0->Ad0 + User0->Ad1 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Photo0 + Influencer1->Ad0 + Influencer1->Ad1
...
sees = User1->Photo1 + User1->Photo2 + User2->Photo0
...
User = User0 + Influencer0 + Influencer1
follows = User0->User0 + User0->Influencer0 + User0->Influencer1 + Influencer0->User0 + Influencer0->Influencer0 + Influencer0->Influencer1 + Influencer1->User0 + Influencer1->Influencer0 + Influencer1->Influencer1
sees = User0->Photo1 + User0->Photo2 + Influencer0->Photo0
...
suggested = User0->User0 + Influencer0->User0 + Influencer0->Influencer0 + Influencer0->Influencer1 + Influencer1->Influencer0
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
