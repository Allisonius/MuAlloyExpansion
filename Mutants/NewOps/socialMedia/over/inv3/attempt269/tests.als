...
sees = User0->Ad0 + Influencer0->Ad1 + Influencer1->Photo0
...
posts = User0->Ad0 + User0->Ad1 + User0->Ad2 + User1->Ad0 + Influencer0->Ad1 + Influencer0->Ad2
suggested = User0->User0 + User0->Influencer0 + Influencer0->User0 + Influencer0->Influencer0
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
...
pred test27 {
some disj Influencer0: User {some disj Photo1, Photo0: Photo {some disj Day0, Day1: Day {
Influencer = Influencer0
User = Influencer0
...
follows = User0->User0 + User0->User1 + User0->User2 + User1->User0 + User1->User1 + User1->User2 + User2->User0 + User2->User1 + User2->User2
sees = User0->Photo0
posts = User0->Photo0 + User1->Photo0 + User1->Photo1 + User2->Photo0 + User2->Photo1
...
sees = User0->Ad0 + Influencer0->Photo0 + Influencer1->Ad0 + Influencer1->Ad1
posts = User0->Photo0 + User0->Ad0 + Influencer0->Photo0 + Influencer0->Ad1 + Influencer1->Photo0 + Influencer1->Ad0 + Influencer1->Ad1
...
User = User0 + User1 + Influencer0
follows = User0->User0 + User0->User1 + User0->Influencer0 + User1->User0 + User1->User1 + User1->Influencer0 + Influencer0->User0 + Influencer0->User1 + Influencer0->Influencer0
sees = User0->Photo0 + User0->Photo1 + User1->Photo0 + User1->Photo1 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo1
...
posts = User0->Photo1 + User1->Photo0 + User1->Photo1 + User1->Ad0 + User2->Photo1 + User2->Ad0
suggested = User0->User1 + User1->User0 + User1->User1
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
posts = Influencer0->Photo0 + Influencer0->Ad0 + Influencer1->Photo0 + Influencer1->Ad1
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = Influencer0->User0 + Influencer0->Influencer0 + Influencer0->Influencer1 + Influencer1->Influencer0 + Influencer1->Influencer1
...
sees = User0->Photo1
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo1 + User1->Photo2 + User2->Photo0 + User2->Photo1 + User2->Photo2
...
sees = Influencer1->Ad1 + Influencer2->Photo0 + Influencer2->Ad0
posts = Influencer0->Photo0 + Influencer0->Ad1 + Influencer1->Photo0 + Influencer1->Ad1 + Influencer2->Photo0 + Influencer2->Ad0 + Influencer2->Ad1
suggested = Influencer0->Influencer0 + Influencer0->Influencer1 + Influencer0->Influencer2 + Influencer2->Influencer0 + Influencer2->Influencer2
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
