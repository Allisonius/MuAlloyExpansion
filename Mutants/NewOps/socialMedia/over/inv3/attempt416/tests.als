...
follows = User0->Influencer0 + User0->Influencer1 + Influencer0->Influencer0 + Influencer1->User0 + Influencer1->Influencer0 + Influencer1->Influencer1
...
pred test35 {
some disj User0: User {some disj Photo1, Photo0: Photo {some disj Day0, Day1: Day {
no Influencer
no Influencer' --loop state
User = User0
follows = User0->User0
...
sees = User0->Ad0 + User1->Ad0 + User2->Ad0
posts = User0->Photo1 + User1->Photo0 + User1->Photo1 + User2->Photo0
