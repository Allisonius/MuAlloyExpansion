...
sees = Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo1 + Influencer2->Photo1
posts = Influencer0->Photo1 + Influencer1->Photo0 + Influencer1->Photo2 + Influencer2->Photo0
no suggested
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User0 + Influencer0->User1 + Influencer0->Influencer0
sees = User0->Ad0 + User1->Photo0 + User1->Ad0 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1
...
posts = User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer1->Photo0 + Influencer1->Photo2
...
sees = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo1 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo1
...
User = User0 + User1 + Influencer0
follows = User1->User0 + User1->User1
sees = User0->Photo2 + User1->Photo2 + Influencer0->Photo1
