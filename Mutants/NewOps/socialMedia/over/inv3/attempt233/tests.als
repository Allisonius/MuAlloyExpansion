...
sees = User0->Photo0 + User0->Ad0 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Ad0 + Influencer1->Ad0
...
posts = User0->Photo0 + User0->Photo1 + User0->Ad0 + User1->Photo0 + User1->Ad0
no suggested
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
...
posts = User0->Photo1 + User0->Ad0 + User1->Ad0 + User2->Photo1 + User2->Ad0
