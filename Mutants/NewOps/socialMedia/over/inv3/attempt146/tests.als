...
User = User0 + User1 + User2
follows = User0->User2 + User1->User1 + User1->User2 + User2->User0
sees = User0->Photo0 + User0->Photo1 + User1->Ad0 + User2->Photo0 + User2->Photo1
...
sees = User0->Photo0 + User0->Ad0 + User1->Ad0 + User1->Ad1 + User2->Photo0 + User2->Ad0
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = Influencer0->Influencer0 + Influencer0->Influencer1 + Influencer1->User0 + Influencer1->Influencer0
...
no follows
sees = User0->Ad2
posts = User0->Ad1 + User0->Ad2 + User1->Ad0 + User1->Ad2
suggested = User0->User0
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
