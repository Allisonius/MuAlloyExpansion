...
sees = Influencer0->Ad1 + Influencer2->Ad1 + Influencer2->Ad2
posts = Influencer0->Ad1 + Influencer1->Ad1 + Influencer2->Ad0
...
pred test14 {
some disj Influencer1, Influencer0, User0: User {some disj Ad0: Photo {some disj Day0, Day1: Day {
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = User0->User0 + Influencer0->Influencer1 + Influencer1->User0 + Influencer1->Influencer0
...
Influencer = Influencer0 + Influencer1 + Influencer2
User = Influencer0 + Influencer1 + Influencer2
follows = Influencer0->Influencer1 + Influencer0->Influencer2 + Influencer1->Influencer1 + Influencer2->Influencer0
sees = Influencer0->Ad0 + Influencer1->Ad0 + Influencer2->Ad0
posts = Influencer0->Ad0 + Influencer1->Ad1 + Influencer2->Ad1
...
posts = User0->Ad1 + User0->Ad2 + User2->Ad0 + User2->Ad1
...
pred test19 {
some disj Influencer2, Influencer1, Influencer0: User {some disj Ad0: Photo {some disj Day0, Day1, Day2: Day {
Influencer = Influencer0 + Influencer1 + Influencer2
User = Influencer0 + Influencer1 + Influencer2
...
sees = Influencer0->Ad0 + Influencer1->Ad0 + Influencer2->Ad0
posts = Influencer1->Ad0 + Influencer2->Ad0
...
User = User0 + User1 + User2
follows = User0->User0 + User0->User1 + User0->User2 + User1->User0 + User1->User1 + User1->User2 + User2->User0 + User2->User1 + User2->User2
sees = User0->Ad1 + User1->Ad1 + User2->Ad0 + User2->Ad2
...
pred test29 {
some disj Influencer0, User0: User {some disj Ad0: Photo {some disj Day0, Day1, Day2: Day {
Influencer = Influencer0
