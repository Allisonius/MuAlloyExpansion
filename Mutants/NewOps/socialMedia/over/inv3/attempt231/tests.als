...
sees = User1->Photo0 + User2->Photo1 + User2->Photo2
...
posts = User0->Photo1 + User0->Ad0 + User1->Photo0 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Ad0
no suggested
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
follows = User0->User0 + User1->User1 + User2->User2
sees = User0->Photo1 + User0->Ad0 + User1->Ad0 + User2->Ad0
posts = User0->Photo1 + User1->Photo0 + User1->Ad0 + User2->Photo0 + User2->Photo1 + User2->Ad0
no suggested
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
