...
follows = User0->User2 + User1->User0 + User1->User1 + User1->User2
sees = User1->Ad2
posts = User0->Ad1 + User0->Ad2 + User1->Ad2 + User2->Ad0 + User2->Ad1 + User2->Ad2
...
sees = User2->Ad0
posts = User0->Ad0 + User1->Photo0 + User1->Ad0 + User2->Ad0 + User2->Ad1
...
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo2
suggested = User0->User1 + User1->User1 + Influencer0->User0
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
User = User0 + User1 + User2
follows = User0->User2 + User1->User0 + User1->User1 + User1->User2
sees = User0->Ad0 + User0->Ad1 + User1->Ad0 + User2->Ad1 + User2->Ad2
...
sees = User1->Ad0 + User1->Ad1
posts = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Ad0 + User1->Ad1 + User2->Photo0 + User2->Ad0 + User2->Ad1
suggested = User0->User1 + User1->User0 + User1->User1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
posts = User0->Photo2 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo2
...
no Influencer' --loop state
User = User0 + User1 + User2
follows = User0->User2 + User1->User0 + User1->User1 + User1->User2 + User2->User0 + User2->User1 + User2->User2
sees = User1->Photo1 + User2->Photo0 + User2->Photo2
...
sees = User1->Ad1 + User1->Ad2 + User2->Ad0
no posts
suggested = User0->User1 + User1->User0 + User1->User1
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
...
sees = User0->Photo1 + Influencer1->Photo1 + Influencer1->Photo2
...
follows = Influencer0->Influencer0 + Influencer0->Influencer2 + Influencer1->Influencer0 + Influencer1->Influencer1 + Influencer1->Influencer2
...
sees = Influencer0->Ad0 + Influencer1->Photo0 + Influencer1->Ad0
