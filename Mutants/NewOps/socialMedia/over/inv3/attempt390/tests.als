...
sees = User0->Photo2 + User1->Photo1 + User2->Photo0 + User2->Photo2
...
posts = User1->Ad1 + User1->Ad2 + User2->Ad0 + User2->Ad1 + User2->Ad2
...
User = User0 + User1 + User2
follows = User0->User0 + User0->User1 + User0->User2 + User1->User0 + User1->User1 + User1->User2 + User2->User0 + User2->User1 + User2->User2
sees = User0->Photo2 + User1->Photo2 + User2->Photo0 + User2->Photo1
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User1->Photo2 + User2->Photo0 + User2->Photo1 + User2->Photo2
...
pred test20 {
some disj User2, User1, User0: User {some disj Photo2, Photo1, Photo0: Photo {some disj Day0, Day1: Day {
no Influencer
no Influencer' --loop state
User = User0 + User1 + User2
follows = User0->User1 + User0->User2 + User1->User1 + User2->User0 + User2->User2
sees = User0->Photo1 + User0->Photo2 + User1->Photo0 + User2->Photo1 + User2->Photo2
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User1->Photo2 + User2->Photo0 + User2->Photo1 + User2->Photo2
...
posts = User0->Photo0 + User1->Photo0 + Influencer0->Photo0 + Influencer0->Ad1
...
posts = User0->Photo0 + User0->Ad0 + User0->Ad1 + Influencer0->Photo0 + Influencer0->Ad1 + Influencer1->Photo0 + Influencer1->Ad0 + Influencer1->Ad1
...
User = User0 + User1 + User2
follows = User0->User0 + User0->User1 + User0->User2 + User1->User0 + User1->User1 + User1->User2 + User2->User0 + User2->User1 + User2->User2
sees = User0->Photo1 + User1->Photo0 + User2->Photo1 + User2->Photo2
posts = User0->Photo0 + User0->Photo1 + User1->Photo0 + User1->Photo1 + User2->Photo0 + User2->Photo1 + User2->Photo2
suggested = User0->User1 + User1->User1 + User2->User0
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
User = User0 + Influencer0 + Influencer1
follows = User0->User0 + User0->Influencer0 + User0->Influencer1 + Influencer0->User0 + Influencer0->Influencer0 + Influencer0->Influencer1 + Influencer1->User0 + Influencer1->Influencer0 + Influencer1->Influencer1
sees = User0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
...
User = User0 + Influencer0 + Influencer1
follows = User0->User0 + User0->Influencer0 + User0->Influencer1 + Influencer0->User0 + Influencer0->Influencer0 + Influencer0->Influencer1 + Influencer1->User0 + Influencer1->Influencer0 + Influencer1->Influencer1
sees = User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
suggested = User0->Influencer0 + Influencer0->User0 + Influencer0->Influencer0 + Influencer0->Influencer1
no Ad
no Ad' --loop state
...
User = User0 + User1 + Influencer0
follows = User0->User0 + User0->User1 + User0->Influencer0 + User1->User0 + User1->User1 + User1->Influencer0 + Influencer0->User0 + Influencer0->User1 + Influencer0->Influencer0
sees = User0->Photo2 + User1->Photo0 + Influencer0->Photo1 + Influencer0->Photo2
posts = User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo1
suggested = User0->Influencer0 + User1->User0 + User1->User1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
User = User0 + User1 + User2
follows = User0->User0 + User0->User1 + User0->User2 + User1->User0 + User1->User1 + User1->User2 + User2->User0 + User2->User1 + User2->User2
sees = User0->Photo2 + User1->Photo1 + User1->Photo2 + User2->Photo0 + User2->Photo1
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User1->Photo2 + User2->Photo0 + User2->Photo1 + User2->Photo2
...
User = User0 + User1 + User2
follows = User0->User0 + User0->User1 + User0->User2 + User1->User0 + User1->User1 + User1->User2 + User2->User0 + User2->User1 + User2->User2
sees = User0->Photo0 + User0->Photo1 + User1->Photo0 + User1->Photo1 + User1->Photo2 + User2->Photo0 + User2->Photo1 + User2->Photo2
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User1->Photo2 + User2->Photo0 + User2->Photo1 + User2->Photo2
...
User = User0 + User1 + Influencer0
follows = User0->User1 + User1->User0 + User1->User1 + User1->Influencer0
sees = User0->Ad0 + User0->Ad1 + User0->Ad2 + User1->Ad1 + User1->Ad2 + Influencer0->Ad0
posts = User0->Ad2 + User1->Ad1 + Influencer0->Ad0 + Influencer0->Ad2
suggested = User0->User1 + User1->User0 + User1->User1 + User1->Influencer0
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
...
sees = User0->Ad2 + User1->Ad2 + Influencer0->Ad0 + Influencer0->Ad1
posts = User0->Ad1
suggested = User0->Influencer0 + User1->User1 + Influencer0->User0
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
...
User = User0 + Influencer0 + Influencer1
follows = User0->User0 + User0->Influencer0 + User0->Influencer1 + Influencer0->User0 + Influencer0->Influencer0 + Influencer0->Influencer1 + Influencer1->User0 + Influencer1->Influencer0 + Influencer1->Influencer1
sees = User0->Photo0 + User0->Ad0 + User0->Ad1 + Influencer0->Photo0 + Influencer0->Ad1 + Influencer1->Photo0 + Influencer1->Ad0 + Influencer1->Ad1
posts = User0->Photo0 + Influencer0->Photo0 + Influencer1->Photo0
...
posts = User0->Photo0 + User1->Photo0 + User1->Ad0 + User2->Photo0 + User2->Ad0
suggested = User0->User2 + User1->User1 + User2->User0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
sees = Influencer0->Photo0 + Influencer0->Photo1 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2 + Influencer2->Photo0 + Influencer2->Photo1 + Influencer2->Photo2
posts = Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2 + Influencer2->Photo0 + Influencer2->Photo1 + Influencer2->Photo2
suggested = Influencer0->Influencer2 + Influencer1->Influencer0
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
date = Photo0->Day2 + Photo1->Day2 + Photo2->Day1
