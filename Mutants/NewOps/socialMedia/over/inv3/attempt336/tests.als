...
posts = User0->Photo0 + User0->Ad0 + User0->Ad1 + Influencer0->Photo0 + Influencer1->Ad0 + Influencer1->Ad1
...
follows = User1->User1 + User2->User0 + User2->User1 + User2->User2
sees = User2->Photo1
posts = User0->Photo1 + User1->Photo1 + User2->Photo1 + User2->Photo2
...
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo2
suggested = User0->Influencer0 + Influencer0->User0 + Influencer0->Influencer0
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
follows = User0->User1 + User1->User0 + User1->User1 + User1->Influencer0
sees = User1->Ad0
posts = User0->Ad0 + User0->Ad1 + User0->Ad2 + User1->Ad0 + User1->Ad1 + Influencer0->Ad0
suggested = User0->Influencer0 + User1->User0 + User1->User1
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
...
follows = Influencer1->Influencer1 + Influencer2->Influencer0 + Influencer2->Influencer1 + Influencer2->Influencer2
sees = Influencer2->Ad0
...
sees = Influencer0->Ad1 + Influencer1->Ad0 + Influencer1->Ad1 + Influencer2->Ad0 + Influencer2->Ad1
posts = Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Ad0 + Influencer1->Ad1 + Influencer2->Ad0 + Influencer2->Ad1
suggested = Influencer0->Influencer2 + Influencer1->Influencer2
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
