...
posts = User0->Photo1 + User1->Photo0 + User2->Photo0 + User2->Photo1 + User2->Ad0
...
pred test17 {
some disj Influencer0, User1, User0: User {some disj Ad0, Ad1: Photo {some disj Day0: Day {
Influencer = Influencer0
User = User0 + User1 + Influencer0
...
sees = Influencer0->Photo0 + Influencer0->Ad0 + Influencer1->Ad0 + Influencer2->Ad0
...
follows = User2->User2
sees = User0->Ad0 + User1->Ad0 + User2->Photo0 + User2->Photo1 + User2->Ad0
posts = User0->Photo1 + User1->Photo0 + User1->Photo1 + User2->Photo0 + User2->Photo1
suggested = User0->User0 + User0->User2 + User2->User0 + User2->User2
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
posts = User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo2
no suggested
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
Influencer = Influencer0 + Influencer1 + Influencer2
User = Influencer0 + Influencer1 + Influencer2
follows = Influencer0->Influencer0 + Influencer0->Influencer2 + Influencer1->Influencer0 + Influencer1->Influencer1 + Influencer1->Influencer2 + Influencer2->Influencer0 + Influencer2->Influencer1 + Influencer2->Influencer2
sees = Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2 + Influencer2->Photo0 + Influencer2->Photo1 + Influencer2->Photo2
...
pred test45 {
some disj Influencer1, Influencer0: User {some disj Photo0: Photo {some disj Day0, Day1, Day2: Day {
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User0 + Influencer0->User1
sees = User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1
...
posts = User0->Photo0 + User0->Photo1 + Influencer0->Ad0 + Influencer1->Photo1
no suggested
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User0 + User1->Influencer0 + Influencer0->Influencer0
sees = User0->Photo0 + User1->Photo2 + Influencer0->Photo0
posts = User0->Photo1 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo1
suggested = User0->Influencer0 + User1->User0 + User1->User1
no Ad
no Ad' --loop state
