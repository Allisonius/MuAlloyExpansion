...
no follows
sees = User1->Photo0 + User1->Ad0 + User1->Ad1 + User2->Ad0 + User2->Ad1
...
no follows
sees = User0->Ad1 + Influencer1->Ad1
posts = User0->Photo0 + User0->Ad0 + User0->Ad1 + Influencer0->Photo0 + Influencer0->Ad1 + Influencer1->Photo0 + Influencer1->Ad1
...
User = User0 + User1 + User2
no follows
sees = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + User2->Photo0 + User2->Ad0 + User2->Ad1
