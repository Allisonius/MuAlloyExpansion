...
pred test6 {
some disj User2, User1, User0: User {some disj Photo2, Photo1, Photo0: Photo {some disj Day0: Day {
no Influencer
no Influencer' --loop state
User = User0 + User1 + User2
follows = User0->User2 + User1->User0 + User1->User1 + User1->User2
sees = User1->Photo2
posts = User0->Photo1 + User0->Photo2 + User1->Photo2 + User2->Photo2
...
sees = User0->Photo0 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2
...
posts = User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + User1->Ad1 + Influencer0->Ad0 + Influencer0->Ad1
...
posts = User0->Photo0 + User0->Photo1 + User0->Ad0 + User1->Photo1 + User1->Ad0 + User2->Photo1
...
sees = User1->Photo0 + User1->Photo2
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User1->Photo2 + Influencer0->Photo1
...
Influencer = Influencer0
User = User0 + User1 + Influencer0
follows = User1->User0 + User1->User1 + User1->Influencer0 + Influencer0->User0 + Influencer0->User1 + Influencer0->Influencer0
sees = User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo1
posts = User0->Photo1 + User0->Photo2 + User1->Photo1 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2
...
follows = User0->User1 + User1->User0 + User1->User1 + User1->Influencer0
sees = User1->Photo2
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User1->Photo2 + Influencer0->Photo1 + Influencer0->Photo2
...
sees = User0->Photo2 + User1->Photo1 + Influencer0->Photo2
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User1->Photo2 + Influencer0->Photo1 + Influencer0->Photo2
...
no Influencer' --loop state
User = User0 + User1 + User2
follows = User0->User1 + User0->User2 + User1->User1 + User1->User2 + User2->User0 + User2->User2
sees = User0->Ad0 + User1->Ad0 + User2->Ad0
posts = User0->Photo0 + User0->Photo1 + User0->Ad0 + User1->Photo0 + User1->Photo1 + User1->Ad0 + User2->Photo1 + User2->Ad0
no suggested
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
sees = User0->Ad0 + User0->Ad1 + User1->Ad0 + User1->Ad1 + Influencer0->Ad0 + Influencer0->Ad1
posts = User0->Photo0 + User0->Ad0 + Influencer0->Ad0
suggested = User0->Influencer0 + User1->User0 + User1->User1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
follows = User0->User0 + User0->User1 + User0->Influencer0 + User1->User0 + User1->User1 + User1->Influencer0 + Influencer0->User1
sees = User0->Ad0 + User1->Ad0 + Influencer0->Ad0
posts = User0->Photo0 + User0->Photo1 + User0->Ad0 + User1->Ad0 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Ad0
suggested = User0->Influencer0 + User1->User0 + User1->User1
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
pred test27 {
some disj Influencer2, Influencer1, Influencer0: User {some disj Ad0, Photo1, Photo0: Photo {some disj Day0: Day {
Influencer = Influencer0 + Influencer1 + Influencer2
User = Influencer0 + Influencer1 + Influencer2
follows = Influencer0->Influencer0 + Influencer0->Influencer1 + Influencer0->Influencer2 + Influencer1->Influencer1 + Influencer1->Influencer2 + Influencer2->Influencer0 + Influencer2->Influencer1 + Influencer2->Influencer2
sees = Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Ad0 + Influencer1->Ad0 + Influencer2->Photo0 + Influencer2->Photo1 + Influencer2->Ad0
...
suggested = Influencer0->Influencer2 + Influencer2->Influencer0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
...
sees = User1->Photo0 + User1->Photo1 + Influencer0->Photo0 + Influencer0->Photo2
...
sees = User1->Photo1 + User2->Photo0
...
User = User0 + User1 + Influencer0
follows = User0->User0 + User0->User1 + User0->Influencer0 + User1->User0 + User1->User1 + User1->Influencer0 + Influencer0->User1
sees = User0->Photo0 + User0->Photo1 + User1->Photo0 + User1->Photo1 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2
posts = User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo2 + Influencer0->Photo1 + Influencer0->Photo2
suggested = User1->User0 + User1->User1 + User1->Influencer0
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
sees = User1->Photo1
posts = User0->Photo1 + User1->Photo1 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2
suggested = User0->Influencer0 + User1->User0 + User1->User1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
posts = User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2
suggested = User1->User0 + User1->User1 + User1->Influencer0
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
follows = User0->User2 + User1->User0 + User1->User1 + User1->User2
sees = User1->Photo2
posts = User0->Photo1 + User1->Photo2 + User2->Photo2
suggested = User1->User0 + User1->User1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
User = User0 + User1 + User2
follows = User0->User0 + User0->User1 + User0->User2 + User1->User0 + User1->User1 + User1->User2 + User2->User0 + User2->User1 + User2->User2
sees = User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + User1->Ad1 + User2->Photo0 + User2->Ad0 + User2->Ad1
posts = User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + User1->Ad1 + User2->Photo0 + User2->Ad0 + User2->Ad1
suggested = User0->User2 + User1->User2
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
...
posts = User0->Photo0 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Ad0 + Influencer1->Photo0
suggested = User0->User0 + User0->Influencer0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day1 + Ad0->Day2
Day = Day0 + Day1 + Day2
inv3[]
}}}
}
...
sees = Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Photo0 + Influencer1->Ad0 + Influencer1->Ad1
posts = Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Photo0 + Influencer1->Ad0 + Influencer1->Ad1
no suggested
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
pred test45 {
some disj Influencer2, Influencer1, Influencer0: User {some disj Ad0, Ad2, Ad1: Photo {some disj Day0, Day1: Day {
Influencer = Influencer0 + Influencer1 + Influencer2
User = Influencer0 + Influencer1 + Influencer2
...
posts = Influencer0->Ad0 + Influencer0->Ad1 + Influencer0->Ad2 + Influencer1->Ad0 + Influencer1->Ad1 + Influencer1->Ad2 + Influencer2->Ad0 + Influencer2->Ad1 + Influencer2->Ad2
suggested = Influencer1->Influencer2 + Influencer2->Influencer0
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day1 + Ad1->Day1 + Ad2->Day0
Day = Day0 + Day1
inv3[]
}}}
}
...
pred test46 {
some disj User1, User0: User {some disj Ad0, Photo0, Ad1: Photo {some disj Day0, Day1: Day {
no Influencer
no Influencer' --loop state
User = User0 + User1
...
pred test47 {
some disj User2, User1, User0: User {some disj Photo0: Photo {some disj Day0: Day {
no Influencer
no Influencer' --loop state
User = User0 + User1 + User2
...
suggested = User1->User0 + User1->User1 + User1->Influencer0 + Influencer0->User0 + Influencer0->User1 + Influencer0->Influencer0
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
date = Photo0->Day2 + Photo1->Day2 + Photo2->Day1
...
follows = User0->Influencer0 + User1->User1 + Influencer0->User0 + Influencer0->User1
no sees
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo1 + Influencer0->Photo2
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = User0->User0 + User0->Influencer0 + User0->Influencer1 + Influencer0->Influencer0 + Influencer0->Influencer1
...
follows = User0->User2 + User1->User0 + User1->User1 + User1->User2
sees = User1->Ad1
posts = User0->Ad1 + User1->Ad0 + User1->Ad1 + User2->Ad1
suggested = User0->User0 + User0->User2 + User2->User2
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
...
posts = User0->Photo1 + User0->Ad0 + User1->Photo0 + User1->Photo1 + User1->Ad0 + User2->Photo1
suggested = User1->User0 + User1->User1
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day2 + Photo1->Day2 + Ad0->Day1
...
follows = User0->User2 + User1->User0 + User1->User1 + User1->User2
sees = User0->Ad0 + User1->Photo1 + User1->Ad0 + User2->Ad0
posts = User0->Photo0 + User0->Photo1 + User1->Photo1 + User2->Photo0 + User2->Photo1 + User2->Ad0
...
pred test67 {
some disj User1, User0: User {some disj Ad0, Photo1, Photo0: Photo {some disj Day0, Day1: Day {
no Influencer
no Influencer' --loop state
User = User0 + User1
follows = User0->User0 + User0->User1 + User1->User0 + User1->User1
sees = User0->Photo1 + User0->Ad0 + User1->Ad0
posts = User0->Photo1 + User1->Photo1 + User1->Ad0
suggested = User0->User0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
date = Photo0->Day1 + Photo1->Day1 + Ad0->Day0
