...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = User0->Influencer0 + User0->Influencer1 + Influencer0->User0 + Influencer0->Influencer1 + Influencer1->User0 + Influencer1->Influencer0
sees = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
...
pred test18 {
some disj User1, User0: User {some disj Photo1, Photo0: Photo {some disj Day0, Day1, Day2: Day {
no Influencer
no Influencer' --loop state
User = User0 + User1
...
pred test28 {
some disj User1, User0: User {some disj Photo2, Photo1, Photo0: Photo {some disj Day0: Day {
no Influencer
no Influencer' --loop state
User = User0 + User1
follows = User0->User0 + User0->User1 + User1->User0 + User1->User1
...
sees = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
suggested = User0->User0 + User0->Influencer0 + User0->Influencer1 + Influencer0->Influencer0 + Influencer1->User0 + Influencer1->Influencer0
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
date = Photo0->Day2 + Photo1->Day2 + Photo2->Day1
