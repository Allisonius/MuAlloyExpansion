...
posts = User0->Photo1 + User0->Photo2 + User1->Photo0 + User2->Photo0 + User2->Photo1
...
posts = User0->Photo2 + User1->Photo1 + Influencer0->Photo1
...
User = User0 + User1 + Influencer0
follows = User0->User1 + User1->User0 + User1->User1 + User1->Influencer0
sees = User0->Photo0 + User0->Photo2 + User1->Photo0
...
posts = User0->Photo1 + User0->Photo2 + User1->Photo2
...
sees = User0->Ad1 + User0->Ad2 + User1->Ad0 + User1->Ad1 + User1->Ad2 + User2->Ad0 + User2->Ad1 + User2->Ad2
...
no follows
no sees
posts = User0->Photo2 + User1->Photo1 + User2->Photo1 + User2->Photo2
suggested = User2->User0 + User2->User2
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
