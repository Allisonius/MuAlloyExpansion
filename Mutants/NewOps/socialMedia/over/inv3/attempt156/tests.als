...
follows = User0->User0 + User0->Influencer1 + Influencer0->User0 + Influencer0->Influencer1 + Influencer1->User0 + Influencer1->Influencer1
sees = User0->Ad1
posts = User0->Photo0 + Influencer0->Ad1 + Influencer1->Photo0 + Influencer1->Ad0
...
posts = User0->Photo0 + User0->Ad0 + User0->Ad1 + Influencer0->Photo0 + Influencer1->Ad1
