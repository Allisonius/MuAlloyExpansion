...
sees = User0->Photo1 + User0->Photo2 + User1->Photo1 + User1->Photo2 + User2->Photo0 + User2->Photo1
...
sees = User1->Photo2
posts = User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User1->Photo2 + User2->Photo0 + User2->Photo2
suggested = User0->User1 + User1->User0 + User1->User1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
posts = User0->Photo0 + User0->Photo1 + Influencer0->Photo1 + Influencer1->Photo1 + Influencer1->Photo2
suggested = User0->Influencer1 + Influencer1->User0 + Influencer1->Influencer1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
sees = User0->Photo2
posts = User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo2
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = Influencer0->User0 + Influencer0->Influencer1 + Influencer1->Influencer0
sees = Influencer0->Photo2
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo2 + Influencer1->Photo1 + Influencer1->Photo2
...
sees = User0->Ad1
posts = User0->Ad0 + User0->Ad1 + User0->Ad2 + User1->Ad0 + User1->Ad1 + Influencer0->Ad1
suggested = User0->Influencer0 + User1->User0 + User1->User1
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
...
no follows
no sees
posts = User0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
