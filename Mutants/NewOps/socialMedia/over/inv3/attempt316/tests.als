...
posts = User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + User1->Ad1 + User2->Photo0
...
posts = User0->Photo0 + User0->Ad0 + Influencer0->Ad0 + Influencer1->Ad1
...
User = User0 + User1 + User2
follows = User0->User2 + User1->User1
sees = User0->Photo0 + User2->Photo1
