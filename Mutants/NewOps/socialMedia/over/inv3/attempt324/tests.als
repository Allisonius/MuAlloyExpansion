...
User = User0 + User1 + Influencer0
follows = User0->User1 + User1->User0 + User1->Influencer0 + Influencer0->Influencer0
sees = User1->Ad1 + Influencer0->Ad1 + Influencer0->Ad2
posts = User0->Ad1 + User1->Ad2 + Influencer0->Ad1 + Influencer0->Ad2
suggested = User0->Influencer0 + User1->User0 + User1->User1
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
...
posts = User0->Photo0 + User0->Photo1 + User1->Photo1 + Influencer0->Photo1 + Influencer0->Photo2
suggested = User0->Influencer0 + User1->User0 + User1->User1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
posts = User0->Photo1 + User1->Photo1 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo2
suggested = User0->Influencer0 + User1->User0 + User1->User1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
