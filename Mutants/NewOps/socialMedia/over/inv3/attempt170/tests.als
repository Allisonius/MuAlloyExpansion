...
pred test18 {
some disj User2, User1, User0: User {some disj Day0, Day1: Day {
no Influencer
no Influencer' --loop state
...
posts = User0->Photo0 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User1->Photo2
...
pred test20 {
some disj User0: User {some disj Photo0: Photo {some disj Day0: Day {
no Influencer
no Influencer' --loop state
User = User0
follows = User0->User0
...
posts = User0->Ad1 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer0->Ad2 + Influencer1->Ad0 + Influencer1->Ad1 + Influencer1->Ad2
suggested = Influencer1->User0 + Influencer1->Influencer1
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
...
posts = User0->Ad0 + User0->Ad1 + User0->Ad2 + User2->Ad0 + User2->Ad1 + User2->Ad2
suggested = User2->User0 + User2->User2
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = User0->Influencer1 + Influencer0->Influencer0 + Influencer0->Influencer1 + Influencer1->Influencer0 + Influencer1->Influencer1
sees = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
posts = Influencer0->Photo0 + Influencer0->Photo1 + Influencer1->Photo1 + Influencer1->Photo2
suggested = Influencer1->User0 + Influencer1->Influencer1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
sees = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
posts = User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
...
follows = User0->User2 + User1->User0 + User2->User2
sees = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User1->Photo2 + User2->Photo0 + User2->Photo1 + User2->Photo2
posts = User0->Photo0 + User0->Photo1 + User1->Photo1 + User1->Photo2 + User2->Photo0 + User2->Photo1 + User2->Photo2
suggested = User2->User0 + User2->User2
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
sees = User0->Photo0 + User0->Photo1 + User0->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
posts = User0->Photo0 + User0->Photo1 + Influencer0->Photo1 + Influencer1->Photo2
suggested = User0->User0 + User0->Influencer1 + Influencer1->User0 + Influencer1->Influencer1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
sees = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User1->Photo2 + User2->Photo0 + User2->Photo1 + User2->Photo2
posts = User0->Photo1 + User1->Photo0 + User1->Photo1 + User1->Photo2 + User2->Photo0 + User2->Photo1 + User2->Photo2
...
Influencer = Influencer0
User = User0 + User1 + Influencer0
follows = User0->User0 + User1->User0 + User1->User1 + Influencer0->User0 + Influencer0->Influencer0
...
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
follows = User0->Influencer1 + Influencer0->Influencer0 + Influencer0->Influencer1 + Influencer1->User0 + Influencer1->Influencer1
no sees
...
sees = User0->Photo0 + User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo1 + User1->Photo2 + User2->Photo0 + User2->Photo1 + User2->Photo2
posts = User0->Photo0 + User0->Photo1 + User0->Photo2 + User2->Photo0 + User2->Photo1 + User2->Photo2
