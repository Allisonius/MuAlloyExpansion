...
sees = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Ad0 + User2->Photo0
...
posts = User0->Photo1 + User0->Ad0 + User2->Photo0 + User2->Photo1 + User2->Ad0
...
no Influencer' --loop state
User = User0 + User1 + User2
follows = User0->User2 + User1->User1 + User1->User2 + User2->User2
...
posts = User0->Photo0 + User0->Ad1 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad0
...
sees = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Ad1 + User2->Ad0
posts = User0->Ad0 + User1->Photo0 + User2->Photo0 + User2->Ad0 + User2->Ad1
...
posts = User0->Photo1 + User0->Photo2 + User1->Photo0 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo2
...
posts = User0->Photo0 + User0->Ad0 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Ad0 + Influencer1->Ad1
...
sees = User0->Ad1 + User1->Ad0 + User2->Photo0 + User2->Ad1
posts = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + User1->Ad1 + User2->Photo0 + User2->Ad0 + User2->Ad1
...
sees = User0->Photo1 + User1->Photo1 + User2->Photo0 + User2->Ad0
...
pred test29 {
some disj User1, User0: User {some disj Ad0, Photo1, Photo0: Photo {some disj Day0: Day {
no Influencer
no Influencer' --loop state
User = User0 + User1
...
posts = User0->Photo0 + User0->Ad0 + User0->Ad1 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Photo0 + Influencer1->Ad0 + Influencer1->Ad1
suggested = User0->Influencer0 + Influencer0->Influencer0 + Influencer0->Influencer1 + Influencer1->User0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
...
User = User0 + User1 + Influencer0
follows = User0->User0 + User0->User1 + User0->Influencer0 + User1->User0 + User1->User1 + User1->Influencer0 + Influencer0->User0 + Influencer0->User1 + Influencer0->Influencer0
sees = User1->Photo0 + User1->Ad0 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad0
posts = User0->Photo0 + User0->Ad0 + User0->Ad1 + User1->Photo0 + User1->Ad0 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1
suggested = User0->Influencer0 + Influencer0->User0 + Influencer0->Influencer0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
