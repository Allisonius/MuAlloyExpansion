...
no sees
posts = User0->Photo1 + Influencer1->Photo0 + Influencer1->Photo2
...
sees = User1->Photo1
posts = User0->Photo1 + User1->Photo0 + User1->Photo1 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo1 + Influencer0->Photo2
suggested = User0->Influencer0 + User1->User0 + User1->User1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
sees = User1->Photo0 + User1->Photo2
posts = User0->Photo0 + User0->Photo1 + User1->Photo1 + User1->Photo2 + Influencer0->Photo0 + Influencer0->Photo2
suggested = User0->Influencer0 + User1->User0 + User1->User1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
posts = User0->Photo2 + Influencer0->Photo1 + Influencer0->Photo2 + Influencer1->Photo0 + Influencer1->Photo1 + Influencer1->Photo2
...
no sees
posts = User0->Photo0 + User0->Photo1 + User1->Photo1 + User1->Photo2 + User2->Photo0
suggested = User0->User1 + User1->User0 + User1->User1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
pred test57 {
some disj Influencer0, User0: User {some disj Photo2, Photo1, Photo0: Photo {some disj Day0: Day {
Influencer = Influencer0
User = User0 + Influencer0
