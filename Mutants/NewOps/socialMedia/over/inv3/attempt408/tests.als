...
sees = User1->Photo2
posts = User0->Photo1 + User1->Photo0 + User1->Photo1 + User2->Photo0 + User2->Photo2
...
posts = Influencer1->Photo0 + Influencer1->Photo2
no suggested
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
...
suggested = User0->User0 + User0->Influencer0 + Influencer0->User0 + Influencer0->User1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
date = Photo0->Day2 + Photo1->Day2 + Photo2->Day1
...
suggested = Influencer1->Influencer1 + Influencer1->Influencer2 + Influencer2->Influencer0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
