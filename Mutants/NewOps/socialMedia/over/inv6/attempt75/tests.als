...
posts = Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Photo0 + Influencer1->Ad0
suggested = Influencer0->Influencer0
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day0 + Ad0->Day0 + Ad1->Day0
...
pred test30 {
some disj Influencer0: User {some disj Ad0, Photo0: Photo {some disj Day0: Day {
Influencer = Influencer0
User = Influencer0
no follows
no sees
