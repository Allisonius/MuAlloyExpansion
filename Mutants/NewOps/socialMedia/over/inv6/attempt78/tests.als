...
follows = Influencer0->Influencer0 + Influencer1->Influencer0 + Influencer1->Influencer2 + Influencer2->Influencer0 + Influencer2->Influencer2
sees = Influencer0->Ad0 + Influencer1->Photo0 + Influencer1->Ad1 + Influencer2->Ad0
posts = Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Photo0 + Influencer1->Ad1 + Influencer2->Photo0 + Influencer2->Ad1
...
posts = User1->Photo0 + User1->Ad0 + User1->Ad1 + User2->Ad0
suggested = User0->User2 + User1->User0 + User1->User1
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
...
pred test22 {
some disj Influencer0, User0: User {some disj Ad0, Photo0: Photo {some disj Day0, Day1: Day {
Influencer = Influencer0
User = User0 + Influencer0
no follows
sees = User0->Photo0
...
pred test30 {
some disj Influencer2, Influencer1, Influencer0: User {some disj Ad0, Photo0: Photo {some disj Day0, Day1: Day {
Influencer = Influencer0 + Influencer1 + Influencer2
User = Influencer0 + Influencer1 + Influencer2
...
posts = Influencer0->Photo0 + Influencer0->Ad0 + Influencer1->Photo0 + Influencer2->Photo0
