...
sees = User0->Ad1 + User0->Ad2 + Influencer1->Ad2
posts = User0->Ad0 + User0->Ad2 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Ad0 + Influencer1->Ad2
suggested = User0->User0 + User0->Influencer1 + Influencer1->User0 + Influencer1->Influencer1
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
...
pred test37 {
some disj Influencer1, Influencer0, User0: User {some disj Photo0: Photo {some disj Day0: Day {
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
...
posts = User0->Photo0 + User0->Ad1 + Influencer0->Ad0 + Influencer0->Ad1 + Influencer1->Ad0 + Influencer1->Ad1
no suggested
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day1 + Ad0->Day1 + Ad1->Day0
...
posts = User0->Photo0 + User0->Ad0 + User1->Photo0 + User1->Ad0 + User2->Ad0 + User2->Ad1
...
sees = Influencer0->Ad1 + Influencer1->Ad1
posts = User0->Photo0 + User0->Ad1 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer1->Photo0 + Influencer1->Ad1
...
pred test42 {
some disj Influencer0, User1, User0: User {some disj Photo0: Photo {some disj Day0, Day1: Day {
Influencer = Influencer0
User = User0 + User1 + Influencer0
...
pred test52 {
some disj Influencer2, Influencer1, Influencer0: User {some disj Ad0, Photo0: Photo {some disj Day0: Day {
...
posts = Influencer0->Photo0 + Influencer1->Photo0 + Influencer2->Ad0
