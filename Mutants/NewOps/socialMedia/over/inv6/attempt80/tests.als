...
pred test23 {
some disj Influencer1, Influencer0: User {some disj Ad0, Photo0: Photo {some disj Day0: Day {
Influencer = Influencer0 + Influencer1
User = Influencer0 + Influencer1
follows = Influencer1->Influencer1
...
pred test32 {
some disj Influencer0: User {some disj Ad0: Photo {some disj Day0, Day1: Day {
Influencer = Influencer0
User = Influencer0
no follows
no sees
...
pred test38 {
some disj Influencer0: User {some disj Ad0, Ad2, Ad1: Photo {some disj Day0, Day1: Day {
Influencer = Influencer0
User = Influencer0
no follows
no sees
