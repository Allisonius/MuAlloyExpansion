...
no follows
sees = User0->Ad1 + User0->Ad2 + User1->Ad0 + User2->Ad0 + User2->Ad1 + User2->Ad2
...
User = User0 + User1 + User2
no follows
sees = User1->Photo0 + User1->Photo1 + User2->Photo1 + User2->Ad0
...
User = User0 + User1 + User2
no follows
sees = User1->Ad1 + User2->Ad1 + User2->Ad2
...
User = User0 + User1 + User2
no follows
sees = User0->Ad1 + User0->Ad2 + User1->Ad0 + User2->Ad0 + User2->Ad2
...
User = User0 + User1 + User2
no follows
sees = User1->Ad0 + User2->Ad0 + User2->Ad1 + User2->Ad2
posts = User2->Ad0 + User2->Ad1
suggested = User0->User0 + User0->User2 + User2->User0 + User2->User2
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
