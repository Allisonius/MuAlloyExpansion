...
sees = Influencer0->Photo1 + Influencer1->Photo2
posts = Influencer1->Photo1 + Influencer1->Photo2
suggested = User0->User0 + Influencer0->Influencer0 + Influencer0->Influencer1
no Ad
no Ad' --loop state
...
follows = User0->User2 + User1->User0 + User1->User1 + User1->User2 + User2->User1
sees = User1->Ad0 + User1->Ad1 + User1->Ad2
posts = User0->Ad1 + User0->Ad2 + User1->Ad0 + User1->Ad1
suggested = User0->User1 + User2->User0 + User2->User2
Ad = Ad0 + Ad1 + Ad2
Photo = Ad0 + Ad1 + Ad2
date = Ad0->Day2 + Ad1->Day2 + Ad2->Day1
