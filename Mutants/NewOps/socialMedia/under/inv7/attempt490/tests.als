...
User = User0 + User1 + User2
follows = User0->User2 + User1->User1 + User2->User0
sees = User0->Photo0 + User0->Photo1 + User1->Ad0 + User2->Photo0
...
Influencer = Influencer0 + Influencer1 + Influencer2
User = Influencer0 + Influencer1 + Influencer2
follows = Influencer0->Influencer2 + Influencer1->Influencer1 + Influencer1->Influencer2 + Influencer2->Influencer0 + Influencer2->Influencer1
no sees
no posts
suggested = Influencer1->Influencer0
Ad = Ad0 + Ad1 + Ad2
