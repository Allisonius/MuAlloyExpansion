...
follows = Influencer0->Influencer1 + Influencer1->Influencer0 + Influencer1->Influencer1 + Influencer2->Influencer1 + Influencer2->Influencer2
no sees
no posts
suggested = Influencer0->Influencer1 + Influencer1->Influencer0 + Influencer2->Influencer0 + Influencer2->Influencer1
no Ad
no Ad' --loop state
Photo = Photo0 + Photo1 + Photo2
date = Photo0->Day2 + Photo1->Day2 + Photo2->Day1
