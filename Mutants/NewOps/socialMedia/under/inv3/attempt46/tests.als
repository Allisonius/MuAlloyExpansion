...
User = User0 + User1 + User2
no follows
sees = User0->Photo0 + User0->Photo1 + User2->Photo1 + User2->Photo2
posts = User1->Photo2 + User2->Photo1
...
sees = User0->Photo1 + User0->Photo2 + User1->Photo1 + User2->Photo1 + User2->Photo2
...
User = User0 + User1 + User2
no follows
sees = User0->Photo0 + User2->Photo1 + User2->Photo2
posts = User1->Photo2 + User2->Photo1
suggested = User2->User0 + User2->User2
no Ad
no Ad' --loop state
...
User = User0 + User1 + User2
follows = User2->User2
sees = User0->Photo1 + User2->Photo2
