...
posts = User0->Photo0 + User0->Ad0 + Influencer0->Photo1 + Influencer1->Photo0 + Influencer1->Ad0
...
pred test5 {
some disj User1, User0: User {some disj Day0, Day1: Day {
no Influencer
...
pred test24 {
some disj Influencer0: User {some disj Day0, Day1: Day {
Influencer = Influencer0
User = Influencer0
no follows
no sees
