...
follows = Influencer0->Influencer2 + Influencer2->Influencer0 + Influencer2->Influencer2
...
pred test19 {
some disj Influencer1, Influencer0, User0: User {some disj Photo1, Photo0: Photo {some disj Day0: Day {
Influencer = Influencer0 + Influencer1
User = User0 + Influencer0 + Influencer1
