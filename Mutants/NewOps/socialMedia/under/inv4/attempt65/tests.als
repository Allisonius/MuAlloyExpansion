...
sees = User0->Photo1 + User1->Photo0 + User2->Photo0 + User2->Ad0
posts = User0->Photo0 + User0->Photo1 + User2->Photo0 + User2->Photo1 + User2->Ad0
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User0 + User1->User1 + Influencer0->User1
sees = User0->Photo1 + User1->Photo0 + Influencer0->Photo0 + Influencer0->Photo2
