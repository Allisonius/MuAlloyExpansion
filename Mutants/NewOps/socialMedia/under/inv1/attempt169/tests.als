...
posts = User0->Photo0 + User1->Photo0 + User1->Ad0 + Influencer0->Photo1
suggested = User0->User0 + User0->Influencer0 + Influencer0->User0 + Influencer0->Influencer0
Ad = Ad0
Photo = Photo0 + Photo1 + Ad0
...
User = User0 + User1 + User2
no follows
sees = User0->Photo1 + User1->Photo0 + User1->Photo1 + User1->Ad0 + User2->Photo0 + User2->Photo1 + User2->Ad0
...
posts = User0->Ad0 + User1->Photo0 + User1->Ad0 + Influencer0->Photo1
