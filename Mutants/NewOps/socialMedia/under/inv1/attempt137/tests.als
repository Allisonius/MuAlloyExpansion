...
posts = User0->Ad2 + User2->Ad1 + User2->Ad2
...
pred test7 {
some disj Ad0, Photo0: Photo {some disj Day0, Day1, Day2: Day {
no Influencer
no Influencer' --loop state
no User
no follows
...
suggested = User0->User1 + User0->User2 + User2->User2
Ad = Ad0 + Ad1
Photo = Photo0 + Ad0 + Ad1
date = Photo0->Day2 + Ad0->Day2 + Ad1->Day1
Day = Day0 + Day1 + Day2
...
posts = Influencer0->Photo0 + Influencer0->Ad1 + Influencer2->Ad1
...
sees = Influencer0->Ad1 + Influencer1->Ad0 + Influencer1->Ad1 + Influencer1->Ad2
no posts
...
User = User0 + User1 + Influencer0
follows = User0->Influencer0 + User1->User0 + User1->User1
sees = User0->Ad0 + User1->Photo0 + User1->Ad1 + Influencer0->Photo0 + Influencer0->Ad0 + Influencer0->Ad1
