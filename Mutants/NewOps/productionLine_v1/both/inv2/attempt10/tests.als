...
Position = Position0 + Position1 + Position2
Component = Component0 + Component1
parts = Component0->Resource0 + Component0->Component1 + Component1->Resource0
position = Component0->Position0 + Component1->Position1
Resource = Resource0
Product = Resource0 + Component0 + Component1
Robot = Robot0 + Robot1
...
parts = Component0->Component1 + Component0->Component2 + Component2->Component1
...
pred test5 {
some disj Position0, Position1, Position2: Position {some disj Resource0, Resource1: Product {some disj Robot1, Robot0: Robot {
Position = Position0 + Position1 + Position2
no Component
no parts
no position
...
Position = Position0 + Position1 + Position2
Component = Component0 + Component1
parts = Component1->Resource0 + Component1->Component0
position = Component0->Position0 + Component1->Position1
Resource = Resource0
Product = Resource0 + Component0 + Component1
Robot = Robot0 + Robot1
...
Position = Position0 + Position1 + Position2
Component = Component0 + Component1
parts = Component1->Product0 + Component1->Component0
position = Component0->Position0 + Component1->Position1
no Resource
no Resource' --loop state
