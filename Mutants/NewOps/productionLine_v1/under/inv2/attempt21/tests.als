...
pred test2 {
some disj Position0, Position1, Position2: Position {some disj Component1, Component2, Component0: Product {some disj Robot0: Robot {
Position = Position0 + Position1 + Position2
Component = Component0 + Component1 + Component2
parts = Component0->Component1 + Component1->Component0
position = Component0->Position1 + Component1->Position0 + Component2->Position1
no Resource
...
position = Component0->Position0 + Component1->Position0 + Component2->Position1
no Resource
no Resource' --loop state
Product = Component0 + Component1 + Component2
Robot = Robot0
...
pred test6 {
some disj Position0, Position1, Position2: Position {some disj Component1, Component2, Component0: Product {some disj Robot1, Robot0: Robot {
Position = Position0 + Position1 + Position2
Component = Component0 + Component1 + Component2
parts = Component0->Component1 + Component1->Component0
position = Component0->Position2 + Component1->Position2 + Component2->Position2
no Resource
no Resource' --loop state
Product = Component0 + Component1 + Component2
Robot = Robot0 + Robot1
...
Position = Position0 + Position1 + Position2
Component = Component0 + Component1 + Component2
parts = Component0->Component1 + Component0->Component2 + Component1->Component0 + Component1->Component2
position = Component0->Position2 + Component1->Position2 + Component2->Position1
no Resource
no Resource' --loop state
Product = Component0 + Component1 + Component2
no Robot
...
Position = Position0 + Position1 + Position2
Component = Component0 + Component1
parts = Component0->Resource0 + Component0->Component1
position = Component0->Position0 + Component1->Position1
Resource = Resource0
Product = Resource0 + Component0 + Component1
Robot = Robot0 + Robot1
position = Robot0->Position0 + Robot1->Position0
ordering/first = Position0
ordering/next = Position0->Position1 + Position1->Position2
inv2[]
}}}
...
pred test16 {
some disj Position0, Position1, Position2: Position {some disj Resource0, Resource1: Product {
Position = Position0 + Position1 + Position2
no Component
no parts
no position
...
pred test17 {
some disj Position0, Position1, Position2: Position {some disj Product0, Resource0, Resource1: Product {some disj Robot1, Robot0: Robot {
Position = Position0 + Position1 + Position2
no Component
no parts
no position
no Component' --loop state
Resource = Resource0 + Resource1
Product = Resource0 + Product0 + Resource1
Robot = Robot0 + Robot1
position = Robot0->Position1 + Robot1->Position0
ordering/first = Position0
ordering/next = Position0->Position1 + Position1->Position2
