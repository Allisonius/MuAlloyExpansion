...
pred test3 {
some disj Position0, Position1, Position2: Position {some disj Product0, Resource0: Product {
Position = Position0 + Position1 + Position2
no Component
no parts
no position
...
Product = Resource0 + Component0 + Component1
Robot = Robot0 + Robot1
position = Robot0->Position2 + Robot1->Position0
ordering/first = Position0
ordering/next = Position0->Position1 + Position1->Position2
inv3[]
}}}
...
pred test9 {
some disj Position0, Position1, Position2: Position {some disj Product0, Resource0, Resource1: Product {
Position = Position0 + Position1 + Position2
no Component
no parts
no position
