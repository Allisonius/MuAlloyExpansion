...
pred test4 {
some disj Position0, Position1, Position2: Position {some disj Product0, Resource0: Product {some disj Robot1, Robot0, Robot2: Robot {
Position = Position0 + Position1 + Position2
no Component
no parts
no position
...
pred test5 {
some disj Position0, Position1, Position2: Position {some disj Product1, Product0, Resource0: Product {some disj Robot1, Robot0: Robot {
Position = Position0 + Position1 + Position2
no Component
no parts
no position
no Component' --loop state
Resource = Resource0
Product = Resource0 + Product0 + Product1
Robot = Robot0 + Robot1
position = Robot0->Position1 + Robot1->Position0
ordering/first = Position0
ordering/next = Position0->Position1 + Position1->Position2
...
Position = Position0 + Position1 + Position2
Component = Component0 + Component1
parts = Component0->Product0 + Component1->Component0
position = Component0->Position0 + Component1->Position1
no Resource
...
Position = Position0 + Position1 + Position2
Component = Component0 + Component1
parts = Component0->Resource0 + Component0->Component0 + Component1->Component0
position = Component0->Position0 + Component1->Position1
Resource = Resource0
Product = Resource0 + Component0 + Component1
Robot = Robot0 + Robot1 + Robot2
