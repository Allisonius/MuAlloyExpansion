...
pred test4 {
some disj Position0, Position1, Position2: Position {some disj Resource0: Product {some disj Robot1, Robot0: Robot {
Position = Position0 + Position1 + Position2
no Component
no parts
no position
...
pred test5 {
some disj Position0, Position1, Position2: Position {some disj Resource2, Resource0, Resource1: Product {some disj Robot1, Robot0: Robot {
Position = Position0 + Position1 + Position2
no Component
no parts
no position
no Component' --loop state
Resource = Resource0 + Resource1 + Resource2
Product = Resource0 + Resource1 + Resource2
Robot = Robot0 + Robot1
...
pred test8 {
some disj Position0, Position1, Position2: Position {some disj Component0: Product {some disj Robot1, Robot0: Robot {
Position = Position0 + Position1 + Position2
Component = Component0
...
Component = Component0 + Component1
no parts
position = Component0->Position2 + Component1->Position0
no Resource
no Resource' --loop state
Product = Component0 + Component1
Robot = Robot0 + Robot1
