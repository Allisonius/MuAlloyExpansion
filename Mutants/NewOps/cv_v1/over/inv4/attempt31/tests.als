...
visible = User0->Work0 + User0->Work1 + User1->Work0 + User1->Work2
no Institution
...
source = Work0->Institution2 + Work1->Institution1
inv4[]
}}}
}
run test7 for 3 but 1 steps
pred test8 {
some disj Institution2, Institution0, Institution1: Source {some disj Id0, Id2, Id1: Id {some disj Work0: Work {
no User
no profile
no visible
no User' --loop state
