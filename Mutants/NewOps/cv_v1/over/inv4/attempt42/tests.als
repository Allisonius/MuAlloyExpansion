...
pred test3 {
some disj User0: Source {some disj Id0, Id2, Id1: Id {
User = User0
no profile
no visible
no Institution
...
pred test5 {
some disj Institution2, Institution0, Institution1: Source {some disj Id0, Id2, Id1: Id {
no User
no profile
no visible
no User' --loop state
