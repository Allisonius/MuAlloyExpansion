...
workers = Workstation0->Robot0 + Workstation1->Worker0 + Workstation1->Robot0 + Workstation2->Robot0
...
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation0->Worker1 + Workstation0->Robot0
succ = Workstation2->Workstation2
no Human
no Human' --loop state
Robot = Robot0
...
Workstation = Workstation0 + Workstation1
workers = Workstation0->Worker1 + Workstation0->Robot0 + Workstation1->Worker0 + Workstation1->Robot0
succ = Workstation0->Workstation1 + Workstation1->Workstation1
no Human
no Human' --loop state
Robot = Robot0
...
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation0->Worker0 + Workstation0->Robot0 + Workstation1->Human0 + Workstation2->Robot0
...
Workstation = Workstation0 + Workstation1
workers = Workstation0->Human1 + Workstation1->Worker0 + Workstation1->Human1
succ = Workstation0->Workstation1 + Workstation1->Workstation1
Human = Human0 + Human1
no Robot
no Robot' --loop state
...
some disj Workstation1, Workstation0: Workstation {some disj Robot1, Robot0, Human0: Worker {some disj Component1, Component2, Component0: Product {
Workstation = Workstation0 + Workstation1
workers = Workstation0->Human0 + Workstation1->Robot0 + Workstation1->Robot1
succ = Workstation0->Workstation1 + Workstation1->Workstation1
Human = Human0
Robot = Robot0 + Robot1
Worker = Robot0 + Robot1 + Human0
...
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Robot0, Worker0, Human0: Worker {some disj Component1, Component2, Component0: Product {
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation1->Worker0 + Workstation1->Human0 + Workstation2->Robot0
succ = Workstation1->Workstation2 + Workstation2->Workstation2
Human = Human0
Robot = Robot0
Worker = Worker0 + Robot0 + Human0
