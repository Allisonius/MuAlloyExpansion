...
parts = Material0->Material0 + Material1->Material0 + Material1->Material1 + Component0->Material1
begin = Workstation1
end = Workstation1
...
Product = Material0 + Material1 + Component0
parts = Material0->Component0 + Material1->Material1 + Component0->Component0
begin = Workstation1
end = Workstation1
Dangerous = Material1
inv4[]
