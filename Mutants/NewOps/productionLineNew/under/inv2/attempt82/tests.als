...
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation0->Human0 + Workstation1->Worker0 + Workstation2->Robot0 + Workstation2->Human0
succ = Workstation1->Workstation2 + Workstation2->Workstation2
Human = Human0
Robot = Robot0
Worker = Worker0 + Robot0 + Human0
...
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation0->Robot1 + Workstation0->Human0 + Workstation1->Robot1 + Workstation1->Human0 + Workstation2->Robot0
succ = Workstation1->Workstation2 + Workstation2->Workstation2
Human = Human0
Robot = Robot0 + Robot1
Worker = Robot0 + Robot1 + Human0
