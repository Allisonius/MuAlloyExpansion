...
Workstation = Workstation0 + Workstation1
workers = Workstation1->Worker1 + Workstation1->Worker2
succ = Workstation0->Workstation1 + Workstation1->Workstation1
no Human
no Human' --loop state
no Robot
...
pred test13 {
some disj Workstation0: Workstation {some disj Robot0, Worker0, Worker1: Worker {
Workstation = Workstation0
workers = Workstation0->Worker0 + Workstation0->Worker1
succ = Workstation0->Workstation0
no Human
...
pred test14 {
some disj Workstation0: Workstation {some disj Robot0, Worker0, Worker1: Worker {some disj Material2, Material1, Material0: Product {
Workstation = Workstation0
workers = Workstation0->Worker0 + Workstation0->Worker1
succ = Workstation0->Workstation0
no Human
