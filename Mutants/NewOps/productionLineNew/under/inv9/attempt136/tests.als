...
Workstation = Workstation0 + Workstation1 + Workstation2
no workers
succ = Workstation0->Workstation0 + Workstation0->Workstation2 + Workstation1->Workstation0 + Workstation1->Workstation2 + Workstation2->Workstation1
Human = Human0 + Human1
Robot = Robot0
...
Workstation = Workstation0 + Workstation1 + Workstation2
no workers
succ = Workstation0->Workstation2 + Workstation1->Workstation1 + Workstation1->Workstation2 + Workstation2->Workstation0 + Workstation2->Workstation1 + Workstation2->Workstation2
Human = Human0
Robot = Robot0
Worker = Robot0 + Human0
Material = Material0 + Material1
...
pred test46 {
some disj Workstation0: Workstation {some disj Robot1, Robot0, Worker0: Worker {some disj Material1, Material0, Component0: Product {
Workstation = Workstation0
no workers
succ = Workstation0->Workstation0
no Human
