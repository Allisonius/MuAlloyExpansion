...
succ = Workstation1->Workstation0 + Workstation1->Workstation1 + Workstation2->Workstation0 + Workstation2->Workstation1
Human = Human0
Robot = Robot0
Worker = Worker0 + Robot0 + Human0
no Material
...
no workstation
Product = Material0 + Material1 + Component0
parts = Material0->Material1 + Material1->Material1 + Material1->Component0 + Component0->Material0 + Component0->Component0
begin = Workstation2
end = Workstation1
