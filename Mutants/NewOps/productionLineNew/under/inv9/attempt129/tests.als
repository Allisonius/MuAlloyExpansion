...
Workstation = Workstation0 + Workstation1 + Workstation2
no workers
succ = Workstation0->Workstation2 + Workstation1->Workstation1 + Workstation1->Workstation2 + Workstation2->Workstation0 + Workstation2->Workstation1
Human = Human0
Robot = Robot0
Worker = Robot0 + Human0
Material = Material0 + Material1
...
Workstation = Workstation0 + Workstation1 + Workstation2
no workers
succ = Workstation0->Workstation1 + Workstation1->Workstation0 + Workstation1->Workstation1 + Workstation1->Workstation2
Human = Human0
Robot = Robot0
Worker = Worker0 + Robot0 + Human0
Material = Material0 + Material1
...
pred test44 {
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Robot1, Robot0, Robot2: Worker {some disj Material1, Material0, Component0: Product {
Workstation = Workstation0 + Workstation1 + Workstation2
no workers
succ = Workstation0->Workstation2 + Workstation1->Workstation0 + Workstation1->Workstation2 + Workstation2->Workstation1
no Human
