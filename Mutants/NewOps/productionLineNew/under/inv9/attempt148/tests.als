...
Workstation = Workstation0 + Workstation1 + Workstation2
no workers
succ = Workstation0->Workstation1 + Workstation1->Workstation2 + Workstation2->Workstation1
Human = Human0
Robot = Robot0
Worker = Worker0 + Robot0 + Human0
no Material
...
workstation = Component0->Workstation1 + Component1->Workstation0 + Component1->Workstation2 + Component2->Workstation1
Product = Component0 + Component1 + Component2
parts = Component0->Component0 + Component0->Component1 + Component1->Component2 + Component2->Component0 + Component2->Component2
begin = Workstation2
end = Workstation2
Dangerous = Component2
inv9[]
