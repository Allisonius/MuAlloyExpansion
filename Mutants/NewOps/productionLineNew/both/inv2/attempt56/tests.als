...
pred test12 {
some disj Workstation0: Workstation {some disj Worker0: Worker {some disj Component1, Component0: Product {
Workstation = Workstation0
...
parts = Material1->Material0 + Material1->Material1
begin = Workstation1
end = Workstation1
Dangerous = Material2
inv2[]
...
some disj Workstation1, Workstation0: Workstation {some disj Robot1, Robot0, Human0: Worker {some disj Component1, Component2, Component0: Product {
Workstation = Workstation0 + Workstation1
workers = Workstation0->Robot0 + Workstation0->Robot1 + Workstation0->Human0 + Workstation1->Robot0 + Workstation1->Robot1
succ = Workstation0->Workstation1 + Workstation1->Workstation1
Human = Human0
Robot = Robot0 + Robot1
Worker = Robot0 + Robot1 + Human0
...
pred test51 {
some disj Workstation0: Workstation {some disj Worker0, Worker1: Worker {
Workstation = Workstation0
workers = Workstation0->Worker0 + Workstation0->Worker1
succ = Workstation0->Workstation0
no Human
