...
pred test9 {
some disj Workstation0: Workstation {some disj Human0, Human1, Human2: Worker {some disj Component1, Component2, Component0: Product {
Workstation = Workstation0
...
pred test39 {
some disj Workstation1, Workstation0: Workstation {some disj Worker0, Worker1: Worker {some disj Material2, Material1, Material0: Product {
Workstation = Workstation0 + Workstation1
workers = Workstation0->Worker0 + Workstation0->Worker1 + Workstation1->Worker0 + Workstation1->Worker1
succ = Workstation0->Workstation1 + Workstation1->Workstation1
no Human
