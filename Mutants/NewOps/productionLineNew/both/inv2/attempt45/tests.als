...
pred test3 {
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Component0: Product {
...
Workstation = Workstation0 + Workstation1
workers = Workstation0->Robot0 + Workstation0->Robot1 + Workstation0->Robot2 + Workstation1->Robot0 + Workstation1->Robot1 + Workstation1->Robot2
succ = Workstation0->Workstation1 + Workstation1->Workstation1
no Human
no Human' --loop state
...
Workstation = Workstation0 + Workstation1
workers = Workstation0->Worker0 + Workstation0->Robot0 + Workstation0->Robot1 + Workstation1->Worker0 + Workstation1->Robot0 + Workstation1->Robot1
succ = Workstation0->Workstation1 + Workstation1->Workstation1
no Human
no Human' --loop state
Robot = Robot0 + Robot1
