...
pred test8 {
some disj Workstation0: Workstation {some disj Worker0: Worker {some disj Component0: Product {
...
pred test11 {
some disj Workstation1, Workstation0: Workstation {some disj Worker0, Worker1, Worker2: Worker {
Workstation = Workstation0 + Workstation1
...
pred test20 {
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Robot0: Worker {some disj Material2, Material1, Material0: Product {
Workstation = Workstation0 + Workstation1 + Workstation2
...
Workstation = Workstation0 + Workstation1
workers = Workstation0->Human0 + Workstation0->Human1 + Workstation1->Human0 + Workstation1->Human1
succ = Workstation0->Workstation1 + Workstation1->Workstation1
Human = Human0 + Human1
no Robot
no Robot' --loop state
...
pred test32 {
some disj Workstation1, Workstation0: Workstation {some disj Robot1, Robot0: Worker {some disj Component1, Component2, Component0: Product {
Workstation = Workstation0 + Workstation1
...
pred test35 {
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Material0: Product {
Workstation = Workstation0 + Workstation1 + Workstation2
no workers
...
pred test39 {
some disj Workstation0: Workstation {some disj Robot0: Worker {some disj Material0, Component0: Product {
Workstation = Workstation0
workers = Workstation0->Robot0
succ = Workstation0->Workstation0
no Human
