...
Workstation = Workstation0 + Workstation1
workers = Workstation0->Robot1 + Workstation0->Robot2 + Workstation1->Robot1 + Workstation1->Robot2
succ = Workstation0->Workstation1 + Workstation1->Workstation1
no Human
no Human' --loop state
...
some disj Workstation1, Workstation0: Workstation {some disj Human0, Human1, Human2: Worker {some disj Component1, Component2, Component0: Product {
Workstation = Workstation0 + Workstation1
workers = Workstation0->Human1 + Workstation0->Human2 + Workstation1->Human1 + Workstation1->Human2
succ = Workstation0->Workstation1 + Workstation1->Workstation1
Human = Human0 + Human1 + Human2
no Robot
no Robot' --loop state
...
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation0->Worker0 + Workstation0->Robot0 + Workstation1->Worker0 + Workstation1->Robot0 + Workstation2->Worker0 + Workstation2->Robot0
succ = Workstation1->Workstation2 + Workstation2->Workstation2
no Human
no Human' --loop state
Robot = Robot0
