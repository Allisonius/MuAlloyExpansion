...
parts = Material0->Material0 + Material0->Component0 + Component0->Material0 + Component1->Material0 + Component1->Component0
begin = Workstation1
end = Workstation1
...
no Material' --loop state
Component = Component0 + Component1 + Component2
workstation = Component0->Workstation0 + Component0->Workstation2 + Component2->Workstation1
Product = Component0 + Component1 + Component2
