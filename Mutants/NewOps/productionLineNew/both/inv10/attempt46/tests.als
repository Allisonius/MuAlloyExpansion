...
succ = Workstation0->Workstation2 + Workstation1->Workstation1 + Workstation1->Workstation2 + Workstation2->Workstation1
Human = Human0
no Robot
no Robot' --loop state
Worker = Worker0 + Human0
...
Product = Material0 + Component0 + Component1
parts = Material0->Material0 + Material0->Component0 + Component0->Material0 + Component0->Component1
begin = Workstation2
end = Workstation1
