...
Product = Component0 + Component1 + Component2
parts = Component0->Component2 + Component2->Component1 + Component2->Component2
begin = Workstation1
end = Workstation1
Dangerous = Component2
inv7[]
...
parts = Material0->Material0 + Material0->Material1 + Material1->Material0 + Material1->Material1 + Component0->Material0
begin = Workstation1
end = Workstation1
Dangerous = Material1
inv7[]
