...
succ = Workstation0->Workstation1 + Workstation1->Workstation0 + Workstation2->Workstation0 + Workstation2->Workstation2
Human = Human0
Robot = Robot0
Worker = Worker0 + Robot0 + Human0
...
Workstation = Workstation0 + Workstation1 + Workstation2
no workers
succ = Workstation0->Workstation2 + Workstation1->Workstation0 + Workstation1->Workstation2 + Workstation2->Workstation0
Human = Human0
Robot = Robot0
...
Workstation = Workstation0 + Workstation1 + Workstation2
no workers
succ = Workstation0->Workstation0 + Workstation0->Workstation2 + Workstation1->Workstation2 + Workstation2->Workstation2
Human = Human0
Robot = Robot0
Worker = Robot0 + Human0
no Material
no Material' --loop state
Component = Component0 + Component1 + Component2
workstation = Component0->Workstation0 + Component0->Workstation1 + Component1->Workstation1 + Component2->Workstation0 + Component2->Workstation2
Product = Component0 + Component1 + Component2
parts = Component0->Component2 + Component1->Component0 + Component1->Component1
begin = Workstation2
end = Workstation2
...
pred test26 {
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Worker0, Worker1: Worker {some disj Material0, Component0: Product {
Workstation = Workstation0 + Workstation1 + Workstation2
no workers
...
Workstation = Workstation0 + Workstation1 + Workstation2
no workers
succ = Workstation0->Workstation0 + Workstation0->Workstation1 + Workstation1->Workstation0 + Workstation2->Workstation1
Human = Human0
Robot = Robot0
Worker = Worker0 + Robot0 + Human0
Material = Material0
