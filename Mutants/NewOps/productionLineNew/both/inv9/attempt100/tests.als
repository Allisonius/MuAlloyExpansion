...
pred test11 {
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Human0, Human1: Worker {some disj Component0: Product {
Workstation = Workstation0 + Workstation1 + Workstation2
no workers
succ = Workstation0->Workstation1 + Workstation1->Workstation0
Human = Human0 + Human1
...
pred test14 {
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Robot0, Human0, Human1: Worker {some disj Component1, Component0: Product {
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation1->Robot0 + Workstation1->Human0
succ = Workstation0->Workstation1 + Workstation1->Workstation0
Human = Human0 + Human1
...
pred test29 {
some disj Workstation2, Workstation1, Workstation0: Workstation {some disj Human0: Worker {
Workstation = Workstation0 + Workstation1 + Workstation2
no workers
