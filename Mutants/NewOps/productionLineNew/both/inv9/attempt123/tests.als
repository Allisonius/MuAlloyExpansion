...
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation1->Worker0
succ = Workstation0->Workstation0 + Workstation0->Workstation1 + Workstation0->Workstation2 + Workstation1->Workstation1 + Workstation2->Workstation0 + Workstation2->Workstation1
Human = Human0
Robot = Robot0
Worker = Worker0 + Robot0 + Human0
no Material
