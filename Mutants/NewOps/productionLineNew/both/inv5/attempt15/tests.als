...
parts = Material0->Material1 + Material1->Material0 + Material1->Material1 + Material1->Material2
begin = Workstation2
end = Workstation1
Dangerous = Material2
inv5[]
...
Workstation = Workstation0 + Workstation1
workers = Workstation0->Robot1 + Workstation1->Robot0 + Workstation1->Robot2
succ = Workstation0->Workstation1 + Workstation1->Workstation1
no Human
no Human' --loop state
...
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation0->Robot1 + Workstation0->Robot2 + Workstation2->Robot0 + Workstation2->Robot2
succ = Workstation1->Workstation2 + Workstation2->Workstation2
no Human
no Human' --loop state
Robot = Robot0 + Robot1 + Robot2
...
some disj Workstation1, Workstation0: Workstation {some disj Human0, Human1, Human2: Worker {some disj Component1, Component2, Component0: Product {
Workstation = Workstation0 + Workstation1
workers = Workstation0->Human0 + Workstation0->Human1 + Workstation0->Human2 + Workstation1->Human1
succ = Workstation0->Workstation1 + Workstation1->Workstation1
Human = Human0 + Human1 + Human2
no Robot
no Robot' --loop state
...
Workstation = Workstation0 + Workstation1 + Workstation2
workers = Workstation0->Human0 + Workstation0->Human1 + Workstation0->Human2 + Workstation2->Human0 + Workstation2->Human1
succ = Workstation1->Workstation2 + Workstation2->Workstation2
Human = Human0 + Human1 + Human2
no Robot
no Robot' --loop state
