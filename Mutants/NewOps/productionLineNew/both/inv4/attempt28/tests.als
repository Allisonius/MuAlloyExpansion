...
pred test6 {
some disj Workstation1, Workstation0: Workstation {some disj Robot0, Worker0: Worker {some disj Material1, Material0: Product {
Workstation = Workstation0 + Workstation1
no workers
succ = Workstation0->Workstation1 + Workstation1->Workstation1
no Human
...
parts = Material1->Material0 + Material1->Material1 + Material1->Material2 + Material2->Material1
begin = Workstation1
end = Workstation1
Dangerous = Material2
inv4[]
...
no Component' --loop state
Product = Material0 + Material1 + Material2
parts = Material0->Material1 + Material1->Material0 + Material2->Material1 + Material2->Material2
begin = Workstation1
end = Workstation1
Dangerous = Material2
inv4[]
