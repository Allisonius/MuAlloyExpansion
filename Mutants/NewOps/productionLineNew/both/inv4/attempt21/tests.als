...
pred test8 {
some disj Workstation0: Workstation {some disj Robot0, Human0: Worker {some disj Material0: Product {
...
no workstation
Product = Material0 + Material1 + Component0
parts = Material0->Component0 + Component0->Material0 + Component0->Material1
begin = Workstation1
end = Workstation1
Dangerous = Material1
inv4[]
