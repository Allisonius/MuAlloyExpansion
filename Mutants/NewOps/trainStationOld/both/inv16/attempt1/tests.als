...
pos'' = Train0->Track1 + Train1->Junction0 --loop state
Entry = Track0 + Track1
Exit = Junction0
Green = Signal1
no Green'
...
pos' = Train0->Track0 + Train1->Junction1 + Train2->Track0
...
pos''' = Train0->Track1 + Train1->Track0 + Train2->Track1 --loop state
Entry = Track2
Exit = Track1
Green = Signal0
Green' = Signal0
...
pos''' = Train1->Junction0 + Train2->Junction1 --loop state
Entry = Junction1
Exit = Junction0
Green = Signal1
no Green'
...
pred test43 {
some disj Track0, Junction0, Junction1: Track {some disj Signal0, Signal1: Signal {some disj Train0: Train {
Junction = Junction0 + Junction1
Track = Track0 + Junction0 + Junction1
prox = Track0->Junction0 + Junction1->Track0 + Junction1->Junction0
signal = Track0->Signal1 + Junction1->Signal0
...
pos'' = Train0->Junction1 + Train1->Junction1 + Train2->Track0 --loop state
Entry = Junction1
Exit = Junction0
Green = Signal0
no Green'
...
pred test63 {
some disj Train2, Train1, Train0: Train {
no Junction
no Junction' --loop state
no Track
no prox
