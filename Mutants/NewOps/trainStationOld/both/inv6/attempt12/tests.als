...
pos''' = Train0->Track0 + Train1->Track0 + Train2->Junction0 --loop state
Entry = Track0 + Track1
Exit = Junction0
Green = Signal1
Green' = Signal1
...
pos''''' = Train1->Track0 + Train2->Track1 --loop state
Entry = Track2
Exit = Track1
no Green
no Green'
...
pos'' = Train0->Track1 + Train1->Track0 + Train2->Track2
