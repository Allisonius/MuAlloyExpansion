...
pos'' = Train0->Junction1 --loop state
Entry = Junction1
Exit = Junction0
Green = Signal1
no Green'
...
pos' = Train2->Junction0 --loop state
Entry = Junction0
Exit = Track0 + Track1
no Green
no Green' --loop state
