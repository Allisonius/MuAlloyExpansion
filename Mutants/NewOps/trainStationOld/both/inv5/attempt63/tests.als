...
pos'' = Train0->Junction0 --loop state
Entry = Junction1
Exit = Junction0
Green = Signal1
no Green'
...
pred test19 {
some disj Track0: Track {some disj Train1, Train0: Train {
no Junction
no Junction'
no Junction''
no Junction''' --loop state
...
run test32 for 3 but 3 steps
pred test33 {
some disj Track1, Track0, Junction0: Track {some disj Signal0, Signal1: Signal {some disj Train0: Train {
Junction = Junction0
Track = Track0 + Track1 + Junction0
prox = Junction0->Track0 + Junction0->Track1
signal = Track1->Signal1 + Junction0->Signal0
...
pos' = Train1->Track1 + Train2->Track0 --loop state
Entry = Track0 + Track1 + Track2
Exit = Track0 + Track1 + Track2
no Green
no Green' --loop state
...
pos = Train2->Track2
pos' = Train2->Track0
pos'' = Train2->Track2 --loop state
Entry = Track2
Exit = Track1
Green = Signal1 + Signal2
no Green'
Green'' = Signal1 + Signal2 --loop state
inv5[]
}}}
}
...
Train = Train0 + Train1 + Train2
pos = Train0->Junction1 + Train1->Junction0 + Train2->Track0
pos' = Train0->Track0 + Train2->Junction1
no pos''
no pos''' --loop state
Entry = Junction1
Exit = Junction0
...
pred test93 {
some disj Track0: Track {some disj Train2, Train1, Train0: Train {
no Junction
no Junction'
no Junction'' --loop state
Track = Track0
...
no pos'
pos'' = Train0->Junction0 + Train1->Track0 + Train2->Track0 --loop state
Entry = Junction1
Exit = Junction0
Green = Signal0
no Green'
...
pos' = Train0->Track0
pos'' = Train1->Junction1 + Train2->Junction1 --loop state
Entry = Junction1
Exit = Junction0
Green = Signal0
no Green'
...
pos'' = Train1->Junction1 + Train2->Track0 --loop state
Entry = Junction1
Exit = Junction0
Green = Signal1
no Green'
