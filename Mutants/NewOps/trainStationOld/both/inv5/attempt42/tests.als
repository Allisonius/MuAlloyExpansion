...
pos'' = Train1->Track0 + Train2->Junction1 --loop state
Entry = Junction1
Exit = Junction0
Green = Signal0
no Green'
...
Train = Train0 + Train1 + Train2
pos = Train0->Junction0 + Train1->Junction0 + Train2->Track0
pos' = Train0->Junction0 + Train1->Junction0 + Train2->Junction1
pos'' = Train0->Junction0 + Train1->Junction0 + Train2->Junction1 --loop state
Entry = Junction1
Exit = Junction0
no Green
no Green'
...
pos' = Train0->Junction0 + Train1->Junction1
pos'' = Train0->Junction0 + Train1->Junction1 --loop state
Entry = Junction1
Exit = Junction0
no Green
no Green'
