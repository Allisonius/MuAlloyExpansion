...
pos''' = Train0->Track0 + Train1->Track2 --loop state
Entry = Track2
Exit = Track1
no Green
Green' = Signal1
...
pos'' = Train0->Track1 + Train1->Track1 + Train2->Track2 --loop state
Entry = Track2
Exit = Track1
no Green
no Green'
...
pos' = Train1->Junction1 + Train2->Junction0 --loop state
Entry = Junction1
Exit = Junction0
no Green
no Green' --loop state
...
pos'' = Train0->Junction1 + Train1->Junction1 + Train2->Junction0 --loop state
Entry = Junction1
Exit = Junction0
Green = Signal1
no Green'
