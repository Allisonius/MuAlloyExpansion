...
pos'' = Train0->Track0 + Train1->Junction1 + Train2->Track0 --loop state
Entry = Junction1
Exit = Junction0
Green = Signal0
Green' = Signal0 + Signal1
...
pos'' = Train0->Junction1 + Train1->Junction0 --loop state
Entry = Junction1
Exit = Junction0
Green = Signal0 + Signal1 + Signal2
no Green'
...
pos''' = Train0->Track0 + Train1->Track0 + Train2->Track1 --loop state
Entry = Track1
Exit = Track0
Green = Signal0
no Green'
...
pos'' = Train1->Track1 + Train2->Track2
pos''' = Train1->Track1 + Train2->Track1 --loop state
Entry = Track2
Exit = Track1
Green = Signal0
