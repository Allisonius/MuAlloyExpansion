...
Person = Person0 + Person1 + Person2
Tutors = Person1->Person0 + Person1->Person1 + Person1->Person2 + Person2->Person0 + Person2->Person1
...
some disj Person0, Person1, Person2: Person {some disj Class0, Class1, Class2: Class {
Person = Person0 + Person1 + Person2
Tutors = Person0->Person0 + Person0->Person1 + Person0->Person2 + Person1->Person0 + Person1->Person1 + Person2->Person0 + Person2->Person1
...
Person = Person0 + Person1 + Person2
Tutors = Person0->Person1 + Person0->Person2 + Person2->Person2
Teaches = Person0->Class0
no Group
no Group' --loop state
Class = Class0
...
some disj Person0, Person1, Person2: Person {some disj Class0, Class1, Class2: Class {
Person = Person0 + Person1 + Person2
Tutors = Person0->Person0 + Person0->Person1 + Person0->Person2 + Person2->Person0 + Person2->Person1 + Person2->Person2
