...
Group = Group0 + Group1 + Group2
Class = Class0
Groups = Class0->Person0->Group2 + Class0->Person1->Group0 + Class0->Person1->Group1 + Class0->Person1->Group2 + Class0->Person2->Group2
no Teacher
...
some disj Person0, Person1, Person2: Person {some disj Group1, Group2, Group0: Group {some disj Class0, Class1, Class2: Class {
Person = Person0 + Person1 + Person2
Tutors = Person1->Person1 + Person2->Person1 + Person2->Person2
Teaches = Person0->Class1 + Person0->Class2 + Person1->Class0 + Person1->Class2 + Person2->Class0 + Person2->Class2
Group = Group0 + Group1 + Group2
Class = Class0 + Class1 + Class2
Groups = Class0->Person0->Group2 + Class2->Person0->Group2 + Class2->Person1->Group1 + Class2->Person1->Group2 + Class2->Person2->Group0 + Class2->Person2->Group2
Teacher = Person1 + Person2
