...
Course = Course0 + Course1 + Course2
no projects
grades = Course1->Person2->Grade0 + Course2->Person1->Grade1
no Project
no Project' --loop state
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
...
Course = Course0 + Course1 + Course2
no projects
grades = Course1->Person2->Grade1 + Course1->Person2->Grade2 + Course2->Person2->Grade0 + Course2->Person2->Grade1
no Project
no Project' --loop state
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
