...
Course = Course0 + Course1 + Course2
projects = Course2->Project0
grades = Course1->Person0->Grade1 + Course1->Person0->Grade2
Project = Project0
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
ordering/next = Grade0->Grade1 + Grade1->Grade2
...
pred test28 {
some disj Course0, Course2, Course1: Course {some disj Project0, Project1: Project {some disj Grade0, Grade1, Grade2: Grade {
no Person
no teaches
no enrolled
no projects
