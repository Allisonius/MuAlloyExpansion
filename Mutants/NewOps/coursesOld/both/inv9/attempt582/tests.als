...
grades = Course0->Person0->Grade1 + Course0->Person1->Grade0 + Course1->Person2->Grade1 + Course2->Person0->Grade2 + Course2->Person2->Grade0
Project = Project0 + Project1 + Project2
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
ordering/next = Grade0->Grade1 + Grade1->Grade2
...
Course = Course0 + Course1 + Course2
projects = Course0->Project2 + Course1->Project1 + Course2->Project0 + Course2->Project2
grades = Course0->Person1->Grade0 + Course0->Person1->Grade1 + Course0->Person1->Grade2 + Course1->Person0->Grade0 + Course1->Person0->Grade1 + Course1->Person0->Grade2 + Course2->Person0->Grade0 + Course2->Person1->Grade1
Project = Project0 + Project1 + Project2
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
ordering/next = Grade0->Grade1 + Grade1->Grade2
...
Course = Course0 + Course1 + Course2
projects = Course0->Project2 + Course1->Project1 + Course2->Project0 + Course2->Project2
grades = Course0->Person0->Grade1 + Course0->Person1->Grade0 + Course0->Person1->Grade2 + Course1->Person1->Grade0 + Course1->Person1->Grade1 + Course1->Person1->Grade2 + Course2->Person0->Grade0 + Course2->Person0->Grade1
Project = Project0 + Project1 + Project2
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
ordering/next = Grade0->Grade1 + Grade1->Grade2
...
some disj Person0, Person1, Person2: Person {some disj Course0, Course2, Course1: Course {some disj Project0, Project2, Project1: Project {some disj Grade0, Grade1, Grade2: Grade {
Person = Person0 + Person1 + Person2
teaches = Person0->Course2 + Person1->Course2 + Person2->Course0 + Person2->Course2
...
grades = Course0->Person0->Grade2 + Course0->Person1->Grade0 + Course0->Person1->Grade1 + Course0->Person1->Grade2 + Course0->Person2->Grade2 + Course1->Person1->Grade0 + Course1->Person1->Grade1 + Course1->Person1->Grade2 + Course1->Person2->Grade2 + Course2->Person0->Grade2 + Course2->Person1->Grade0
Project = Project0 + Project1 + Project2
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
ordering/next = Grade0->Grade1 + Grade1->Grade2
...
Person = Person0 + Person1 + Person2
teaches = Person0->Course0 + Person2->Course0
enrolled = Person1->Course0 + Person1->Course1 + Person2->Course1
projects = Person2->Project0 + Person2->Project1 + Person2->Project2
Course = Course0 + Course1
projects = Course0->Project1 + Course0->Project2 + Course1->Project0
grades = Course0->Person1->Grade1 + Course1->Person0->Grade2 + Course1->Person1->Grade2
Project = Project0 + Project1 + Project2
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
ordering/next = Grade0->Grade1 + Grade1->Grade2
