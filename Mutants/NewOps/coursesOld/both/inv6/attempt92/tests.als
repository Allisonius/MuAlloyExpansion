...
enrolled = Person0->Course1 + Person0->Course2 + Person1->Course1 + Person2->Course0
...
grades = Course0->Person2->Grade0 + Course0->Person2->Grade1 + Course0->Person2->Grade2 + Course1->Person2->Grade2 + Course2->Person2->Grade1
