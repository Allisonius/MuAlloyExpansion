...
enrolled = Person0->Course0 + Person0->Course2 + Person2->Course1 + Person2->Course2
...
Person = Person0 + Person1 + Person2
teaches = Person2->Course0 + Person2->Course1 + Person2->Course2
enrolled = Person1->Course0 + Person1->Course2 + Person2->Course0
projects = Person0->Project0 + Person0->Project2 + Person1->Project0 + Person1->Project2 + Person2->Project1 + Person2->Project2
Course = Course0 + Course1 + Course2
