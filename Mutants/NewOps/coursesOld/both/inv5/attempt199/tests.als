...
projects = Person0->Project1 + Person1->Project0 + Person1->Project1 + Person2->Project2
Course = Course0 + Course1
...
projects = Person0->Project0 + Person0->Project1 + Person0->Project2 + Person1->Project0 + Person1->Project1 + Person1->Project2 + Person2->Project0
Course = Course0 + Course1
projects = Course0->Project1 + Course0->Project2 + Course1->Project0
grades = Course0->Person2->Grade0 + Course0->Person2->Grade1 + Course0->Person2->Grade2 + Course1->Person2->Grade0 + Course1->Person2->Grade1
Project = Project0 + Project1 + Project2
...
projects = Person0->Project1 + Person1->Project0 + Person1->Project1 + Person2->Project0 + Person2->Project1 + Person2->Project2
Course = Course0 + Course1 + Course2
projects = Course0->Project2 + Course1->Project1 + Course2->Project0 + Course2->Project2
grades = Course0->Person2->Grade0 + Course0->Person2->Grade1 + Course0->Person2->Grade2 + Course1->Person2->Grade0 + Course1->Person2->Grade1 + Course1->Person2->Grade2 + Course2->Person2->Grade0 + Course2->Person2->Grade1
Project = Project0 + Project1 + Project2
