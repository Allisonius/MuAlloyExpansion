...
projects = Person0->Project2 + Person2->Project0 + Person2->Project1 + Person2->Project2
Course = Course0 + Course1 + Course2
...
enrolled = Person1->Course0 + Person2->Course0 + Person2->Course2
no projects
Course = Course0 + Course1 + Course2
projects = Course1->Project1 + Course2->Project0
grades = Course0->Person2->Grade1 + Course2->Person2->Grade0 + Course2->Person2->Grade1
...
teaches = Person2->Course1 + Person2->Course2
enrolled = Person1->Course0 + Person2->Course1 + Person2->Course2
projects = Person1->Project2 + Person2->Project0 + Person2->Project1 + Person2->Project2
Course = Course0 + Course1 + Course2
projects = Course1->Project1 + Course1->Project2 + Course2->Project0
grades = Course1->Person2->Grade0 + Course1->Person2->Grade1 + Course1->Person2->Grade2 + Course2->Person2->Grade0 + Course2->Person2->Grade1
Project = Project0 + Project1 + Project2
