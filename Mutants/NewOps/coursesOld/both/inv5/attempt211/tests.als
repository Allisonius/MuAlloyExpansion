...
pred test2 {
some disj Person0: Person {some disj Course0: Course {some disj Project0, Project1: Project {some disj Grade0, Grade1, Grade2: Grade {
Person = Person0
...
teaches = Person2->Course0
enrolled = Person2->Course0
projects = Person1->Project0 + Person2->Project0 + Person2->Project1 + Person2->Project2
Course = Course0
...
enrolled = Person0->Course2 + Person1->Course0 + Person1->Course2 + Person2->Course0 + Person2->Course1
projects = Person0->Project0 + Person0->Project1 + Person1->Project0 + Person1->Project1 + Person2->Project0 + Person2->Project1
Course = Course0 + Course1 + Course2
