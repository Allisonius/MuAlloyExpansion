...
grades = Course1->Person1->Grade0 + Course1->Person1->Grade1 + Course2->Person2->Grade0 + Course2->Person2->Grade1
...
projects = Person0->Project0 + Person0->Project1 + Person0->Project2 + Person1->Project0 + Person1->Project1 + Person2->Project1
Course = Course0 + Course1 + Course2
