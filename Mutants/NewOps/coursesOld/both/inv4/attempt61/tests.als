...
grades = Course1->Person0->Grade0 + Course1->Person0->Grade1
Project = Project0 + Project1 + Project2
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
ordering/next = Grade0->Grade1 + Grade1->Grade2
...
pred test12 {
some disj Person0: Person {some disj Course0, Course1: Course {some disj Project0: Project {some disj Grade0, Grade1, Grade2: Grade {
Person = Person0
no teaches
no enrolled
projects = Person0->Project0
...
pred test17 {
some disj Person0: Person {some disj Course0, Course1: Course {some disj Grade0, Grade1, Grade2: Grade {
Person = Person0
teaches = Person0->Course1
enrolled = Person0->Course1
no projects
...
grades = Course0->Person0->Grade0 + Course1->Person0->Grade0 + Course1->Person0->Grade1
Project = Project0 + Project1
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
ordering/next = Grade0->Grade1 + Grade1->Grade2
...
Course = Course0 + Course1 + Course2
projects = Course0->Project0 + Course1->Project0 + Course2->Project0
grades = Course0->Person0->Grade0 + Course0->Person0->Grade2 + Course0->Person1->Grade1 + Course1->Person1->Grade2 + Course2->Person0->Grade1 + Course2->Person1->Grade2
Project = Project0
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
ordering/next = Grade0->Grade1 + Grade1->Grade2
