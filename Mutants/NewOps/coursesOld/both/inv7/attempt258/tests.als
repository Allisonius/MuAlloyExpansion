...
enrolled = Person0->Course1 + Person1->Course0 + Person1->Course1 + Person1->Course2 + Person2->Course2
projects = Person2->Project0
Course = Course0 + Course1 + Course2
projects = Course2->Project0
grades = Course0->Person1->Grade0 + Course0->Person1->Grade1 + Course0->Person2->Grade2 + Course1->Person1->Grade1 + Course1->Person1->Grade2 + Course2->Person1->Grade1 + Course2->Person2->Grade0
Project = Project0
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
ordering/next = Grade0->Grade1 + Grade1->Grade2
...
Person = Person0 + Person1 + Person2
no teaches
enrolled = Person0->Course0 + Person0->Course1 + Person1->Course1 + Person2->Course0 + Person2->Course2
projects = Person1->Project0
Course = Course0 + Course1 + Course2
projects = Course2->Project0
no grades
