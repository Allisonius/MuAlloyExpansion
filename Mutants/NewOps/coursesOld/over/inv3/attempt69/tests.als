...
teaches = Person1->Course0 + Person1->Course1 + Person2->Course0
...
Person = Person0 + Person1 + Person2
teaches = Person0->Course0 + Person1->Course2 + Person2->Course1
...
grades = Course0->Person2->Grade0 + Course0->Person2->Grade1 + Course0->Person2->Grade2 + Course1->Person2->Grade0 + Course1->Person2->Grade2
Project = Project0 + Project1 + Project2
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
ordering/next = Grade0->Grade1 + Grade1->Grade2
