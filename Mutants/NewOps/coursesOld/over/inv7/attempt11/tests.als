...
pred test5 {
some disj Grade0, Grade1, Grade2: Grade {
no Person
no teaches
no enrolled
no projects
...
Course = Course0 + Course1 + Course2
no projects
grades = Course1->Person0->Grade0 + Course2->Person0->Grade1
no Project
no Project' --loop state
Grade = Grade0 + Grade1 + Grade2
ordering/first = Grade0
...
pred test21 {
some disj Course0, Course2, Course1: Course {some disj Grade0, Grade1, Grade2: Grade {
no Person
no teaches
no enrolled
no projects
