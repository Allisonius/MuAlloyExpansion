...
some disj File2, File1, File0: File {
File = File0 + File1 + File2
link = File0->File2 + File1->File1 + File2->File1 + File2->File2
no Trash
no Trash' --loop state
Protected = File2
inv9[]
...
some disj File2, File1, File0: File {
File = File0 + File1 + File2
link = File0->File1 + File1->File1 + File1->File2 + File2->File0
Trash = File2
Protected = File1 + File2
inv9[]
}
...
some disj File2, File1, File0: File {
File = File0 + File1 + File2
link = File0->File2 + File1->File0 + File1->File1 + File1->File2 + File2->File1
Trash = File2
no Protected
no Protected' --loop state
inv9[]
...
some disj File2, File1, File0: File {
File = File0 + File1 + File2
link = File0->File2 + File1->File0 + File1->File2 + File2->File1 + File2->File2
no Trash
no Trash' --loop state
no Protected
no Protected' --loop state
...
some disj File2, File1, File0: File {
File = File0 + File1 + File2
link = File0->File0 + File1->File0 + File1->File1 + File2->File0 + File2->File2
Trash = File2
no Protected
no Protected' --loop state
inv9[]
