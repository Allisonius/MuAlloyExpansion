...
some disj File2, File1, File0: File {
File = File0 + File1 + File2
link = File0->File0 + File0->File2 + File1->File1
no Trash
no Trash' --loop state
...
some disj File2, File1, File0: File {
File = File0 + File1 + File2
link = File0->File1 + File2->File1 + File2->File2
Trash = File1
Protected = File2
inv10[]
}
...
some disj File2, File1, File0: File {
File = File0 + File1 + File2
link = File0->File1 + File1->File1 + File2->File1 + File2->File2
Trash = File2
no Protected
no Protected' --loop state
inv10[]
...
some disj File2, File1, File0: File {
File = File0 + File1 + File2
link = File0->File2 + File1->File0 + File1->File2
Trash = File0 + File1
Protected = File2
inv10[]
}
...
some disj File2, File1, File0: File {
File = File0 + File1 + File2
link = File1->File0 + File2->File0 + File2->File2
Trash = File0
Protected = File1 + File2
inv10[]
}
