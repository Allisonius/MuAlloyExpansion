...
Id = Id0 + Id1 + Id2
Work = Work0 + Work1 + Work2
ids = Work0->Id0 + Work0->Id1 + Work0->Id2 + Work1->Id2 + Work2->Id0 + Work2->Id1
...
pred test3{
some disj User0, Institution0, Institution1: Source {some disj Id0, Id1: Id {some disj Work0, Work1: Work {
User = User0
no profile
visible = User0->Work1
Institution = Institution0 + Institution1
...
source = Work0->User0 + Work1->Institution1
inv4[]
}}}
}
...
visible = User0->Work0 + User1->Work1
no Institution
no Institution' --loop state
Source = User0 + User1
Id = Id0 + Id1 + Id2
...
Work = Work0 + Work1 + Work2
ids = Work0->Id0 + Work1->Id0 + Work2->Id0
source = Work0->Institution1 + Work1->User0 + Work2->Institution1
inv4[]
}}}
}
...
Id = Id0 + Id1 + Id2
Work = Work0 + Work1 + Work2
ids = Work0->Id1 + Work0->Id2 + Work1->Id0 + Work2->Id1 + Work2->Id2
source = Work0->User1 + Work1->User1 + Work2->User0
inv4[]
}}}
}
...
pred test29{
some disj User1, User0: Source {some disj Id0: Id {some disj Work0, Work1: Work {
User = User0 + User1
profile = User0->Work1 + User1->Work0
visible = User1->Work0 + User1->Work1
no Institution
no Institution' --loop state
Source = User0 + User1
Id = Id0
...
Work = Work0 + Work1
ids = Work0->Id1 + Work1->Id0 + Work1->Id1
source = Work0->Institution1 + Work1->Institution1
inv4[]
}}}
}
...
pred test52{
some disj User0, Institution0: Source {some disj Id0: Id {some disj Work0, Work1: Work {
User = User0
no profile
visible = User0->Work1
Institution = Institution0
...
Work = Work0 + Work1
ids = Work0->Id0 + Work1->Id0
source = Work0->Institution0 + Work1->User0
inv4[]
}}}
}
...
pred test62{
some disj User1, User0, Institution0: Source {some disj Id0: Id {some disj Work0, Work1: Work {
User = User0 + User1
no profile
visible = User1->Work1
Institution = Institution0
...
Id = Id0 + Id1
Work = Work0 + Work1
ids = Work0->Id0 + Work0->Id1 + Work1->Id0 + Work1->Id1
source = Work0->Institution1 + Work1->Institution1
inv4[]
}}}
}
...
pred test67{
some disj User2, User1, User0: Source {some disj Id0: Id {some disj Work0, Work1: Work {
User = User0 + User1 + User2
no profile
visible = User2->Work1
no Institution
...
pred test90{
some disj Institution2, Institution0, Institution1: Source {some disj Id0: Id {some disj Work0, Work1, Work2: Work {
no User
no profile
no visible
no User' --loop state
...
Work = Work0 + Work1 + Work2
ids = Work0->Id0 + Work1->Id0 + Work2->Id0
source = Work0->Institution2 + Work1->Institution2 + Work2->Institution2
inv4[]
}}}
}
...
pred test102{
some disj User0, Institution0, Institution1: Source {some disj Id0: Id {some disj Work0: Work {
User = User0
profile = User0->Work0
no visible
Institution = Institution0 + Institution1
