...
profile = User1->Work1 + User1->Work2 + User2->Work0 + User2->Work2
visible = User1->Work0 + User1->Work1 + User1->Work2 + User2->Work0 + User2->Work2
no Institution
no Institution' --loop state
...
pred test38{
some disj User1, User0, Institution0: Source {some disj Id0: Id {some disj Work0: Work {
User = User0 + User1
profile = User1->Work0
no visible
Institution = Institution0
