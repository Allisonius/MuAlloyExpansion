...
profile = User1->Work1 + User2->Work0
no visible
no Institution
...
Id = Id0 + Id1 + Id2
Work = Work0 + Work1 + Work2
ids = Work0->Id2 + Work1->Id1 + Work1->Id2 + Work2->Id1 + Work2->Id2
...
Work = Work0 + Work1
ids = Work0->Id0 + Work1->Id0
source = Work0->User2 + Work1->User1
inv4[]
}}}
}
...
Id = Id0 + Id1 + Id2
Work = Work0 + Work1 + Work2
ids = Work0->Id0 + Work0->Id1 + Work0->Id2 + Work1->Id2 + Work2->Id1
source = Work0->Institution0 + Work1->Institution0 + Work2->Institution0
inv4[]
}}}
}
...
source = Work0->User2 + Work1->User0 + Work2->User2
inv4[]
}}}
}
...
Id = Id0 + Id1 + Id2
Work = Work0 + Work1 + Work2
ids = Work0->Id2 + Work1->Id1 + Work1->Id2 + Work2->Id0 + Work2->Id2
source = Work0->User0 + Work1->User0 + Work2->Institution0
inv4[]
}}}
}
...
Work = Work0 + Work1
ids = Work0->Id0 + Work1->Id0
source = Work0->User2 + Work1->User2
inv4[]
}}}
}
...
pred test45{
some disj User2, User1, User0: Source {some disj Id0, Id1: Id {some disj Work0, Work1: Work {
User = User0 + User1 + User2
profile = User1->Work1 + User2->Work0
no visible
no Institution
...
pred test49{
some disj User2, User1, User0: Source {some disj Id0, Id2, Id1: Id {some disj Work0, Work1: Work {
User = User0 + User1 + User2
profile = User1->Work1 + User2->Work0 + User2->Work1
no visible
no Institution
no Institution' --loop state
Source = User0 + User1 + User2
...
some disj User2, User1, User0: Source {some disj Id0, Id1: Id {some disj Work0, Work1: Work {
User = User0 + User1 + User2
profile = User0->Work1 + User1->Work1 + User2->Work0
no visible
no Institution
no Institution' --loop state
Source = User0 + User1 + User2
...
Id = Id0 + Id1 + Id2
Work = Work0 + Work1
ids = Work0->Id1 + Work0->Id2 + Work1->Id0 + Work1->Id1 + Work1->Id2
source = Work0->User1 + Work1->User1
inv4[]
}}}
}
...
Id = Id0 + Id1 + Id2
Work = Work0 + Work1 + Work2
ids = Work0->Id2 + Work1->Id1 + Work1->Id2 + Work2->Id2
...
User = User0 + User1
profile = User0->Work2 + User1->Work1
visible = User0->Work0 + User0->Work2
no Institution
no Institution' --loop state
Source = User0 + User1
Id = Id0
...
pred test94{
some disj Institution0: Source {some disj Id0: Id {
no User
no profile
no visible
no User' --loop state
