...
pred test51{
some disj Institution2, Institution0, Institution1: Source {some disj Id0, Id1: Id {some disj Work0, Work1, Work2: Work {
no User
no profile
no visible
no User' --loop state
...
pred test69{
some disj Institution2, Institution0, Institution1: Source {some disj Id0: Id {some disj Work0, Work1: Work {
no User
no profile
no visible
no User' --loop state
