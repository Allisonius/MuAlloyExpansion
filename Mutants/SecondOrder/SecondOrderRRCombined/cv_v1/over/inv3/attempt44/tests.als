...
User = User0 + User1 + User2
no profile
visible = User0->Work2 + User1->Work2 + User2->Work1
no Institution
no Institution' --loop state
Source = User0 + User1 + User2
Id = Id0
...
User = User0 + User1 + User2
no profile
visible = User0->Work2 + User1->Work1 + User2->Work1 + User2->Work2
no Institution
no Institution' --loop state
Source = User0 + User1 + User2
Id = Id0
...
Id = Id0 + Id1 + Id2
Work = Work0 + Work1
ids = Work0->Id0 + Work0->Id1 + Work0->Id2 + Work1->Id1 + Work1->Id2
source = Work0->User0 + Work1->User0
inv3[]
}}}
}
