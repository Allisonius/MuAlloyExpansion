...
source = Work0->User0 + Work1->User2 + Work2->User2
inv3[]
}}}
}
...
pred test51{
some disj Institution0, Institution1: Source {some disj Id0, Id1: Id {some disj Work0: Work {
no User
no profile
no visible
no User' --loop state
...
pred test53{
some disj Institution0: Source {some disj Id0, Id1: Id {some disj Work0: Work {
no User
no profile
no visible
no User' --loop state
