...
profile = User0->Work2 + User1->Work1 + User2->Work0 + User2->Work2
visible = User0->Work1 + User1->Work0 + User2->Work2
no Institution
no Institution' --loop state
...
User = User0 + User1 + User2
profile = User0->Work1 + User1->Work0 + User2->Work0
...
visible = User0->Work1 + User1->Work2 + User2->Work0
no Institution
no Institution' --loop state
Source = User0 + User1 + User2
Id = Id0
...
User = User0 + User1 + User2
profile = User1->Work1 + User1->Work2 + User2->Work0
