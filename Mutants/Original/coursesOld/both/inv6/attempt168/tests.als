...
projects = Person0->Project0 + Person0->Project2 + Person1->Project0 + Person1->Project2 + Person2->Project0 + Person2->Project1 + Person2->Project2
...
Person = Person0 + Person1 + Person2
teaches = Person2->Course0 + Person2->Course1
enrolled = Person0->Course0 + Person0->Course1 + Person2->Course1
