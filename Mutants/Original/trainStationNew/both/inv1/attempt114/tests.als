...
signals = Track0->Semaphore1 + Track2->Signal0 + Track2->Semaphore0 + Track2->Semaphore1
Semaphore = Semaphore0 + Semaphore1
no Speed
no Speed' --loop state
...
Track = Track0 + Track1 + Track2
succs = Track0->Track0 + Track0->Track1 + Track0->Track2 + Track1->Track0 + Track1->Track1 + Track1->Track2 + Track2->Track0 + Track2->Track2
no signals
no Semaphore
no Semaphore' --loop state
Speed = Speed0 + Speed1
