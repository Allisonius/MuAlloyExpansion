...
succs = Track0->Track0 + Track0->Track1 + Track0->Track2 + Track1->Track0 + Track1->Track1 + Track1->Track2 + Track2->Track0 + Track2->Track1 + Track2->Track2
no signals
...
Track = Track0 + Track1 + Track2
succs = Track1->Track1 + Track1->Track2 + Track2->Track0 + Track2->Track2
signals = Track2->Semaphore2
...
Track = Track0 + Track1 + Track2
succs = Track0->Track1 + Track1->Track1 + Track1->Track2 + Track2->Track0 + Track2->Track2
...
signals = Track0->Speed1 + Track1->Speed0 + Track1->Signal0 + Track2->Speed0 + Track2->Speed1
no Semaphore
...
some disj Track2, Track1, Track0: Track {some disj Speed0, Semaphore0, Semaphore1: Signal {
Track = Track0 + Track1 + Track2
succs = Track1->Track1 + Track1->Track2 + Track2->Track1 + Track2->Track2
signals = Track1->Semaphore0 + Track1->Semaphore1 + Track2->Speed0
Semaphore = Semaphore0 + Semaphore1
Speed = Speed0
Signal = Speed0 + Semaphore0 + Semaphore1
Junction = Track1
...
signals = Track1->Semaphore1 + Track2->Semaphore0
Semaphore = Semaphore0 + Semaphore1
Speed = Speed0
Signal = Speed0 + Semaphore0 + Semaphore1
Junction = Track2
