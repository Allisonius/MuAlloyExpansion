...
signals = Track0->Semaphore0 + Track0->Semaphore2 + Track1->Semaphore0 + Track1->Semaphore1 + Track1->Semaphore2
Semaphore = Semaphore0 + Semaphore1 + Semaphore2
no Speed
no Speed' --loop state
Signal = Semaphore0 + Semaphore1 + Semaphore2
...
Track = Track0 + Track1
succs = Track1->Track0 + Track1->Track1
signals = Track0->Speed0 + Track0->Speed1 + Track0->Semaphore0 + Track1->Speed0 + Track1->Speed1 + Track1->Semaphore0
Semaphore = Semaphore0
Speed = Speed0 + Speed1
Signal = Speed0 + Speed1 + Semaphore0
Junction = Track1
