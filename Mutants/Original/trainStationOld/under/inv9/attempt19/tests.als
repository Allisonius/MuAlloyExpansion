...
pos'' = Train0->Track2 + Train2->Track0 --loop state
Entry = Track1 + Track2
Exit = Track0 + Track2
Green = Signal0
no Green'
...
pos''' = Train0->Track2 + Train1->Track2 --loop state
Entry = Track2
Exit = Track1
no Green
Green' = Signal2
...
pos''' = Train0->Track2 + Train1->Track0 + Train2->Track2 --loop state
Entry = Track1 + Track2
Exit = Track0 + Track2
Green = Signal1
Green' = Signal1
...
pos'' = Train0->Junction0
pos''' = Train0->Track0 + Train1->Junction1 + Train2->Junction1 --loop state
Entry = Junction1
Exit = Junction0
no Green
no Green'
