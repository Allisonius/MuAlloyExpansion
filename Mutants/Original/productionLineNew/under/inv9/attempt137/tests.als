...
Product = Material0 + Component0 + Component1
parts = Material0->Component0 + Material0->Component1 + Component1->Component1
begin = Workstation2
end = Workstation1
...
Workstation = Workstation0 + Workstation1 + Workstation2
no workers
succ = Workstation0->Workstation0 + Workstation0->Workstation1 + Workstation1->Workstation1 + Workstation1->Workstation2 + Workstation2->Workstation0 + Workstation2->Workstation2
Human = Human0 + Human1
Robot = Robot0
Worker = Robot0 + Human0 + Human1
Material = Material0
