...
no workers
succ = Workstation0->Workstation1 + Workstation0->Workstation2 + Workstation1->Workstation0 + Workstation1->Workstation1 + Workstation1->Workstation2 + Workstation2->Workstation0 + Workstation2->Workstation1 + Workstation2->Workstation2
Human = Human0
Robot = Robot0
Worker = Worker0 + Robot0 + Human0
