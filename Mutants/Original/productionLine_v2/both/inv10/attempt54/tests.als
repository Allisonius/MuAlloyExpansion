...
no Material' --loop state
Component = Component0 + Component1 + Component2
workstation = Component0->Workstation1 + Component1->Workstation0 + Component1->Workstation1 + Component1->Workstation2 + Component2->Workstation2
Product = Component0 + Component1 + Component2
...
succ = Workstation0->Workstation0 + Workstation0->Workstation2 + Workstation1->Workstation2 + Workstation2->Workstation1 + Workstation2->Workstation2
Human = Human0
Robot = Robot0
Worker = Worker0 + Robot0 + Human0
no Material
