...
Workstation = Workstation0 + Workstation1 + Workstation2
no workers
succ = Workstation0->Workstation1 + Workstation0->Workstation2 + Workstation1->Workstation0 + Workstation1->Workstation1
no Human
no Human' --loop state
Robot = Robot0
...
no Material' --loop state
Component = Component0 + Component1 + Component2
workstation = Component0->Workstation1 + Component0->Workstation2 + Component1->Workstation1 + Component2->Workstation0
Product = Component0 + Component1 + Component2
