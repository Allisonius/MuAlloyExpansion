...
link = File0->File2 + File2->File0
link' = File2->File2
link'' = File1->File1 + File2->File1
File''' = File1 + File2 --loop state
link''' = File1->File1 + File2->File1 --loop state
Trash = File1 + File2
Trash' = File0 + File1 + File2
Trash'' = File1 + File2
Trash''' = File1 + File2 --loop state
...
no link'
File'' = File0 + File1 + File2 --loop state
link'' = File0->File2 + File1->File1 --loop state
Trash = File0 + File1
Trash' = File0 + File1
Trash'' = File0 + File1 --loop state
Protected = File2
...
link'' = File0->File0 + File2->File2 --loop state
Trash = File1
Trash' = File0 + File2
Trash'' = File0 + File2 --loop state
Protected = File2
...
File = File0 + File1 + File2
File' = File0 + File1 + File2
link = File1->File0 + File2->File0
no link'
File'' = File0 + File1 + File2 --loop state
link'' = File1->File0 + File2->File0 --loop state
Trash = File1
Trash' = File1 + File2
Trash'' = File1 --loop state
Protected = File2
