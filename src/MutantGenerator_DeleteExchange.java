...
public class MutantGenerator_DeleteExchange {
  ...
  public static void mutate(MutantGeneratorOpt opt) {
    ...
    CompModule module = AlloyUtil.compileAlloyModule(opt.getModelPath());
	    ...
	    logger.info("Higher Order Mutant Number: " + mm.getHigherOrderNum());
	    results += "Higher Order Mutant Number: " + mm.getHigherOrderNum() + "\n";
