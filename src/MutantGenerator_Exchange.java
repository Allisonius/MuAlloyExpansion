...
public class MutantGenerator_Exchange {
  ...
  public static void mutate(MutantGeneratorOpt opt) {
    ...
    CompModule module = AlloyUtil.compileAlloyModule(opt.getModelPath());
	 ...
	 ModelUnit mu = new ModelUnit(null, module,opt.getModelPath());
	    // Mutate the model.
	    //edit
	    ModelMutatorExchange mm = new ModelMutatorExchange(opt);
	    mu.accept(mm, null);
  ...
  private static MutantGeneratorOpt parseCommandLineArgs(String[] args) {
    ...
    try {
      ...
      return new MutantGeneratorOpt(modelPath.toString(), mutantDir.toString(), scope, testPath, false);
