...
import mualloy.visitor.ModelMutatorNewOps;
...
public class MutantGenerator_NewOps {
  ...
  public static void mutate(MutantGeneratorOpt opt) {
    ...
    CompModule module = AlloyUtil.compileAlloyModule(opt.getModelPath());
	 ...
	 ModelUnit mu = new ModelUnit(null, module,opt.getModelPath());
	    // Mutate the model.
	 //edit
	    ModelMutatorNewOps mm = new ModelMutatorNewOps(opt);
	    mu.accept(mm, null);
	    ...
	    logger.info("HigherOrder Mutant Number: " + mm.getHigherOrderNum());
	    results += "HigherOrder Mutant Number: " + mm.getHigherOrderNum() + "\n";
	    ...
	    String file = opt.getMutantDirPath() + "/" + "gen.res";
	    try {
